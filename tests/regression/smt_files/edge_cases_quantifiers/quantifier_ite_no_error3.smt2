...
(declare-fun i (P F) v)
(declare-const f F)
(assert (forall ((e P) (u F)) (! (= (i e (s u)) (li (ite ((_ is lib!betree.PivotBranch_v.Node./Leaf) (% e)) (o (l (% e))) (o (l (% e)))))) :pattern ((i e (s u))))))
(assert (or false (forall ((e P)) (! (= (li e) (i e (s f))) :pattern ((li e))))))
(declare-const n lib!betree.PivotBranch_v.Node.)
(declare-const p lib!betree.PivotBranch_v.Node.)
(assert (or (not ((_ is lib!betree.PivotBranch_v.Node./Leaf) n)) (not (v $ T (Po (li (P n))) (o (l (% (P p))))))))
(check-sat)
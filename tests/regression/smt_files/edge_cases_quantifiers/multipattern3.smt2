...
;(assert (forall ((x lib!betree.LinkedBetree_v.BetreeNode.)) (! true :pattern ((Poly%lib!betree.LinkedBetree_v.BetreeNode. x)))))
...
;(assert (forall ((T&. Dcr) (T& Type) (self! Poly)) (! true :pattern ((req%lib!betree.LinkedBetree_v.impl&%5.root. T&. T& self!)))))
...
;(assert (forall ((self! Poly) (child_idx! Poly)) (! true :pattern ((req%lib!betree.LinkedBetree_v.impl&%0.occupied_child_index. self! child_idx!)))))
...
(assert (not (or (=> (and (lib!betree.LinkedBetree_v.impl&%5.wf.? T&. T& self!) (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!)) false))))
(check-sat)

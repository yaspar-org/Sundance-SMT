...
(assert (and true (not (a (%% (%%l $ Y (v $ Y $ TYP (vst (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (P (%l (ly (li (o d))))))) $ Y $ TYP (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) $ Y $ TYP (Poly%v (b (Poly (oly (lib!delegation_map_t.AbstractDelegationMap./AbstractDelegationMap (%Pol (y p)))))))) skolem-variable-0) TYP))))


        (assert (= (%% (%%l $ Y (v $ Y $ TYP (vst (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (P (%l (ly (li (o d))))))) $ Y $ TYP (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) $ Y $ TYP (Poly%v (b (Poly (oly (lib!delegation_map_t.AbstractDelegationMap./AbstractDelegationMap (%Pol (y p)))))))) skolem-variable-0) (ite (s $ Y (v $ Y $ TYP (vst (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (P (%l (ly (li (o d))))))) skolem-variable-0) (vstd $ Y $ Y skolem-variable-0 skolem-variable-0) (vs $ Y $ TYP skolem-variable-0 skolem-variable-0))))
        ;(assert (not (ib! $ Y (ol l) (ol (ib $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (ol (pool l)))))
        (assert (a (vs $ Y $ TYP skolem-variable-0 skolem-variable-0) TYP))
        (assert (and (or (not (% (%% (%P (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool (pool l))))))) (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool (pool l))))))))) (s $ Y (td $ Y $ (TY O) (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool (pool l))))))) skolem-variable-0)) (or (not (s $ Y (td $ Y $ (TY O) (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool (pool l))))))) skolem-variable-0)) (% (%% (%P (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool (pool l))))))) (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool (pool l)))))))))))
(check-sat)

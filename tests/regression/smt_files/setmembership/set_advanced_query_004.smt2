...
(get-info :all-statistics)
 ...
 (declare-const n! set_advanced!Node.)
 (declare-const m! set_advanced!Node.)
 (declare-const graph! vstd!set.Set<tuple%2<set_advanced!Node./set_advanced!Node.>.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (set_advanced!is_member.? $ TYPE%set_advanced!Node. (Poly%set_advanced!Node. m!)
      (Poly%vstd!set.Set<set_advanced!Node.>. (set_advanced!neighbors.? (Poly%set_advanced!Node.
         n!
        ) (Poly%vstd!set.Set<tuple%2<set_advanced!Node./set_advanced!Node.>.>. graph!)
      ))
     ) (or
      (vstd!set.Set.contains.? (DST $) (TYPE%tuple%2. $ TYPE%set_advanced!Node. $ TYPE%set_advanced!Node.)
       (Poly%vstd!set.Set<tuple%2<set_advanced!Node./set_advanced!Node.>.>. graph!) (Poly%tuple%2.
        (tuple%2./tuple%2 (Poly%set_advanced!Node. n!) (Poly%set_advanced!Node. m!))
      ))
      (vstd!set.Set.contains.? (DST $) (TYPE%tuple%2. $ TYPE%set_advanced!Node. $ TYPE%set_advanced!Node.)
       (Poly%vstd!set.Set<tuple%2<set_advanced!Node./set_advanced!Node.>.>. graph!) (Poly%tuple%2.
        (tuple%2./tuple%2 (Poly%set_advanced!Node. m!) (Poly%set_advanced!Node. n!))
 )))))))
 (get-info :version)

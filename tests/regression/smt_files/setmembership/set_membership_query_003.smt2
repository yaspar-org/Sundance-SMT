...
(assert
 (distinct fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep.
  fuel%set_membership!is_member. fuel%set_membership!set_union. fuel%set_membership!set_intersection.
  fuel%set_membership!set_difference. fuel%vstd!array.group_array_axioms. fuel%vstd!function.group_function_axioms.
...
(assert
 (fuel_bool_default fuel%set_membership!is_member.)
)
(assert
 (=>
  (fuel_bool fuel%set_membership!is_member.)
  (forall ((T&. Dcr) (T& Type) (x! Poly) (set! Poly)) (!
    (= (set_membership!is_member.? T&. T& x! set!) (vstd!set.Set.contains.? T&. T& set!
      x!
    ))
    :pattern ((set_membership!is_member.? T&. T& x! set!))
    :qid internal_set_membership!is_member.?_definition
    :skolemid skolem_internal_set_membership!is_member.?_definition
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid internal_set_membership!set_union.?_definition
    :skolemid skolem_internal_set_membership!set_union.?_definition
))))
(assert
 (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly)) (!
   (=>
   ...
   :pattern ((set_membership!set_union.? T&. T& s1! s2!))
   :qid internal_set_membership!set_union.?_pre_post_definition
   :skolemid skolem_internal_set_membership!set_union.?_pre_post_definition
)))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid internal_set_membership!set_intersection.?_definition
    :skolemid skolem_internal_set_membership!set_intersection.?_definition
))))
(assert
 (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly)) (!
   (=>
   ...
   :pattern ((set_membership!set_intersection.? T&. T& s1! s2!))
   :qid internal_set_membership!set_intersection.?_pre_post_definition
   :skolemid skolem_internal_set_membership!set_intersection.?_pre_post_definition
)))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid internal_set_membership!set_difference.?_definition
    :skolemid skolem_internal_set_membership!set_difference.?_definition
))))
(assert
 (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly)) (!
   (=>
   ...
   :pattern ((set_membership!set_difference.? T&. T& s1! s2!))
   :qid internal_set_membership!set_difference.?_pre_post_definition
   :skolemid skolem_internal_set_membership!set_difference.?_pre_post_definition
)))
...
(assert
 (forall ((T&. Dcr) (T& Type) (x! Poly) (s1! Poly) (s2! Poly)) (!
   ...
   :qid internal_ens__set_membership!union_membership_lemma._definition
   :skolemid skolem_internal_ens__set_membership!union_membership_lemma._definition
)))
...
;; Function-Specs set_membership::intersection_distributes_over_union
(declare-fun ens%set_membership!intersection_distributes_over_union. (Dcr Type Poly
  Poly Poly
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly) (s3! Poly)) (!
   (= (ens%set_membership!intersection_distributes_over_union. T&. T& s1! s2! s3!) (=
     (set_membership!set_intersection.? T&. T& s1! (set_membership!set_union.? T&. T& s2!
       s3!
      )
   ...
   :pattern ((ens%set_membership!intersection_distributes_over_union. T&. T& s1! s2! s3!))
   :qid internal_ens__set_membership!intersection_distributes_over_union._definition
   :skolemid skolem_internal_ens__set_membership!intersection_distributes_over_union._definition
)))

;; Function-Def set_membership::intersection_distributes_over_union
;; set_membership.rs:35:7: 35:84 (#0)
(get-info :all-statistics)

;; Function-Specs set_membership::difference_as_intersection
(declare-fun ens%set_membership!difference_as_intersection. (Dcr Type Poly Poly) Bool)
(declare-fun %%lambda%%3 (Dcr Type Poly) %%Function%%)
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (x$ Poly)) (!
   (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2) x$) (B (not (vstd!set.Set.contains.?
       %%hole%%0 %%hole%%1 %%hole%%2 x$
   ))))
   :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2) x$))
)))
(assert
 (forall ((T&. Dcr) (T& Type) (s1! Poly) (s2! Poly)) (!
   (= (ens%set_membership!difference_as_intersection. T&. T& s1! s2!) (= (set_membership!set_difference.?
      T&. T& s1! s2!
     ) (set_membership!set_intersection.? T&. T& s1! (vstd!set.impl&%0.new.? T&. T& (Poly%fun%1.
        (mk_fun (%%lambda%%3 T&. T& s2!))
   )))))
   :pattern ((ens%set_membership!difference_as_intersection. T&. T& s1! s2!))
   :qid internal_ens__set_membership!difference_as_intersection._definition
   :skolemid skolem_internal_ens__set_membership!difference_as_intersection._definition
)))

;; Function-Def set_membership::difference_as_intersection
;; set_membership.rs:48:7: 48:63 (#0)
(get-info :all-statistics)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (ext_eq false (TYPE%vstd!set.Set. T&. T&) (set_membership!set_difference.? T&. T& s1!
      s2!
     ) (set_membership!set_intersection.? T&. T& s1! (vstd!set.impl&%0.new.? T&. T& (Poly%fun%1.
        (mk_fun (%%lambda%%3 T&. T& s2!))
 )))))))

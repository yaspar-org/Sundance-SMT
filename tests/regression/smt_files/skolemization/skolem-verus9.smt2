...
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Dcr) (%%hole%%5 Type) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Dcr) (%%hole%%9 Type) (%%hole%%10 Dcr) (%%hole%%11 Type) (%%hole%%12 Poly) (%%hole%%13 core!option.Option.) (s$ Poly)) (! (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13) s$) (B (= (%Poly%core!option.Option. (lib!kv.durable.durableimpl_v.DurableKvStore.recover_to_kv_state.? %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 s$ %%hole%%12)) %%hole%%13))) :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13) s$)))))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= perm! (lib!kv.kvspec_t.TrustedKvPermission./TrustedKvPermission (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%3 D&. D& PM&. PM& K&. K& I&. I& L&. L& E&. E& (I kv_id!) (core!option.Option./Some (Poly%lib!kv.kvspec_t.AbstractKvStoreState. state!)))))) (%Poly%core!marker.PhantomData. (Poly%core!marker.PhantomData. (lib!kv.kvimpl_t.spec_phantom_data.? $ (TYPE%tuple%6. PM&. PM& K&. K& I&. I& L&. L& D&. D& E&. E&)))))) (=> %%location_label%%0 (forall ((s$ Poly)) (! (=> (has_type s$ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))) (= (%B (lib!pmem.wrpm_t.CheckPermission.check_permission.? $ (TYPE%lib!kv.kvspec_t.TrustedKvPermission. PM&. PM& K&. K& I&. I& L&. L& D&. D& E&. E&) $ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%lib!kv.kvspec_t.TrustedKvPermission. perm!) s$)) (= (%Poly%core!option.Option. (lib!kv.durable.durableimpl_v.DurableKvStore.recover_to_kv_state.? D&. D& PM&. PM& K&. K& I&. I& L&. L& E&. E& s$ (I kv_id!))) (core!option.Option./Some (Poly%lib!kv.kvspec_t.AbstractKvStoreState. state!))))) :pattern ((lib!pmem.wrpm_t.CheckPermission.check_permission.? $ (TYPE%lib!kv.kvspec_t.TrustedKvPermission. PM&. PM& K&. K& I&. I& L&. L& D&. D& E&. E&) $ (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 0))) (Poly%lib!kv.kvspec_t.TrustedKvPermission. perm!) s$))))))))
(assert (= (fuel_bool fuel%vstd!seq.impl&%0.spec_index.) (fuel_bool_default fuel%vstd!seq.impl&%0.spec_index.)))
(assert (= (fuel_bool fuel%vstd!set_lib.impl&%0.is_empty.) (fuel_bool_default fuel%vstd!set_lib.impl&%0.is_empty.)))
(assert (= (fuel_bool fuel%vstd!map_lib.impl&%0.is_empty.) (fuel_bool_default fuel%vstd!map_lib.impl&%0.is_empty.)))
(assert (= (fuel_bool fuel%vstd!map_lib.impl&%0.contains_key.) (fuel_bool_default fuel%vstd!map_lib.impl&%0.contains_key.)))
(assert (= (fuel_bool fuel%vstd!map.impl&%0.spec_index.) (fuel_bool_default fuel%vstd!map.impl&%0.spec_index.)))
(assert (= (fuel_bool fuel%lib!kv.durable.durablespec_t.impl&%2.spec_index.) (fuel_bool_default fuel%lib!kv.durable.durablespec_t.impl&%2.spec_index.)))
(assert (= (fuel_bool fuel%vstd!std_specs.option.impl&%0.is_Some.) (fuel_bool_default fuel%vstd!std_specs.option.impl&%0.is_Some.)))
(assert (= (fuel_bool fuel%vstd!std_specs.option.impl&%0.get_Some_0.) (fuel_bool_default fuel%vstd!std_specs.option.impl&%0.get_Some_0.)))
(assert (= (fuel_bool fuel%vstd!std_specs.option.spec_unwrap.) (fuel_bool_default fuel%vstd!std_specs.option.spec_unwrap.)))
(assert (= (fuel_bool fuel%lib!kv.durable.durablespec_t.impl&%1.item.) (fuel_bool_default fuel%lib!kv.durable.durablespec_t.impl&%1.item.)))
(assert (= (fuel_bool fuel%lib!kv.durable.durablespec_t.impl&%1.list.) (fuel_bool_default fuel%lib!kv.durable.durablespec_t.impl&%1.list.)))
(assert (= (fuel_bool fuel%lib!kv.volatile.volatilespec_t.impl&%1.spec_index.) (fuel_bool_default fuel%lib!kv.volatile.volatilespec_t.impl&%1.spec_index.)))
(assert (= (fuel_bool fuel%lib!kv.volatile.volatilespec_t.impl&%1.contains_key.) (fuel_bool_default fuel%lib!kv.volatile.volatilespec_t.impl&%1.contains_key.)))
(assert (= (fuel_bool fuel%vstd!map.impl&%0.new.) (fuel_bool_default fuel%vstd!map.impl&%0.new.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_index_decreases_finite.) (fuel_bool_default fuel%vstd!map.axiom_map_index_decreases_finite.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_index_decreases_infinite.) (fuel_bool_default fuel%vstd!map.axiom_map_index_decreases_infinite.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_insert_domain.) (fuel_bool_default fuel%vstd!map.axiom_map_insert_domain.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_insert_same.) (fuel_bool_default fuel%vstd!map.axiom_map_insert_same.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_insert_different.) (fuel_bool_default fuel%vstd!map.axiom_map_insert_different.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_remove_domain.) (fuel_bool_default fuel%vstd!map.axiom_map_remove_domain.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_remove_different.) (fuel_bool_default fuel%vstd!map.axiom_map_remove_different.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_ext_equal.) (fuel_bool_default fuel%vstd!map.axiom_map_ext_equal.)))
(assert (= (fuel_bool fuel%vstd!map.axiom_map_ext_equal_deep.) (fuel_bool_default fuel%vstd!map.axiom_map_ext_equal_deep.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_index_decreases.) (fuel_bool_default fuel%vstd!seq.axiom_seq_index_decreases.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_subrange_decreases.) (fuel_bool_default fuel%vstd!seq.axiom_seq_subrange_decreases.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_empty.) (fuel_bool_default fuel%vstd!seq.axiom_seq_empty.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_push_len.) (fuel_bool_default fuel%vstd!seq.axiom_seq_push_len.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_push_index_same.) (fuel_bool_default fuel%vstd!seq.axiom_seq_push_index_same.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_push_index_different.) (fuel_bool_default fuel%vstd!seq.axiom_seq_push_index_different.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_update_len.) (fuel_bool_default fuel%vstd!seq.axiom_seq_update_len.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_update_same.) (fuel_bool_default fuel%vstd!seq.axiom_seq_update_same.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_update_different.) (fuel_bool_default fuel%vstd!seq.axiom_seq_update_different.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_ext_equal.) (fuel_bool_default fuel%vstd!seq.axiom_seq_ext_equal.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_ext_equal_deep.) (fuel_bool_default fuel%vstd!seq.axiom_seq_ext_equal_deep.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_subrange_len.) (fuel_bool_default fuel%vstd!seq.axiom_seq_subrange_len.)))
(assert (= (fuel_bool fuel%vstd!seq.axiom_seq_subrange_index.) (fuel_bool_default fuel%vstd!seq.axiom_seq_subrange_index.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_new.) (fuel_bool_default fuel%vstd!set.axiom_set_new.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_insert_same.) (fuel_bool_default fuel%vstd!set.axiom_set_insert_same.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_insert_different.) (fuel_bool_default fuel%vstd!set.axiom_set_insert_different.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_remove_same.) (fuel_bool_default fuel%vstd!set.axiom_set_remove_same.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_remove_insert.) (fuel_bool_default fuel%vstd!set.axiom_set_remove_insert.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_remove_different.) (fuel_bool_default fuel%vstd!set.axiom_set_remove_different.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_ext_equal.) (fuel_bool_default fuel%vstd!set.axiom_set_ext_equal.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_ext_equal_deep.) (fuel_bool_default fuel%vstd!set.axiom_set_ext_equal_deep.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_mk_map_domain.) (fuel_bool_default fuel%vstd!set.axiom_mk_map_domain.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_mk_map_index.) (fuel_bool_default fuel%vstd!set.axiom_mk_map_index.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_insert_finite.) (fuel_bool_default fuel%vstd!set.axiom_set_insert_finite.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_remove_finite.) (fuel_bool_default fuel%vstd!set.axiom_set_remove_finite.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_insert_len.) (fuel_bool_default fuel%vstd!set.axiom_set_insert_len.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_remove_len.) (fuel_bool_default fuel%vstd!set.axiom_set_remove_len.)))
(assert (= (fuel_bool fuel%vstd!set.axiom_set_contains_len.) (fuel_bool_default fuel%vstd!set.axiom_set_contains_len.)))
(assert (= (fuel_bool fuel%vstd!set_lib.axiom_is_empty.) (fuel_bool_default fuel%vstd!set_lib.axiom_is_empty.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.construct_view_contents.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.construct_view_contents.)))
...
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.spec_index.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.spec_index.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.empty.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.empty.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.contains_key.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.contains_key.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.create.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.create.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.read_item_and_list.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.read_item_and_list.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.read_list_entry_at_index.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.read_list_entry_at_index.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.update_item.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.update_item.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.delete.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.delete.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.append_to_list.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.append_to_list.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.append_to_list_and_update_item.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.append_to_list_and_update_item.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.update_list_entry_at_index.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.update_list_entry_at_index.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.update_entry_at_index_and_item.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.update_entry_at_index_and_item.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.trim_list.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.trim_list.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.trim_list_and_update_item.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.trim_list_and_update_item.)))
(assert (= (fuel_bool fuel%lib!kv.kvspec_t.impl&%2.get_keys.) (fuel_bool_default fuel%lib!kv.kvspec_t.impl&%2.get_keys.)))
(assert (= (uInv 128 kv_id!) (and (<= 0 kv_id!) (< kv_id! (uHi 128)))))
(assert (= (mk_fun (%%lambda%%3 D&. D& PM&. PM& K&. K& I&. I& L&. L& E&. E& (I kv_id!) (core!option.Option./Some (Poly%lib!kv.kvspec_t.AbstractKvStoreState. state!)))) (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%3 D&. D& PM&. PM& K&. K& I&. I& L&. L& E&. E& (I kv_id!) (core!option.Option./Some (Poly%lib!kv.kvspec_t.AbstractKvStoreState. state!))))))))
(assert (=> (tr_bound%lib!kv.durable.durableimpl_v.DurableKvStore. D&. D& PM&. PM& K&. K& I&. I& L&. L& E&. E&) (and (tr_bound%lib!pmem.pmemspec_t.PersistentMemoryRegions. PM&. PM&) (tr_bound%core!hash.Hash. K&. K&) (tr_bound%core!cmp.Eq. K&. K&) (tr_bound%core!clone.Clone. K&. K&) (tr_bound%lib!pmem.pmcopy_t.PmCopy. K&. K&) (tr_bound%core!fmt.Debug. K&. K&) (tr_bound%lib!pmem.pmcopy_t.PmCopy. I&. I&) (tr_bound%lib!kv.kvimpl_t.Item. I&. I& K&. K&) (tr_bound%core!fmt.Debug. I&. I&) (tr_bound%lib!pmem.pmcopy_t.PmCopy. L&. L&) (tr_bound%core!fmt.Debug. L&. L&) (tr_bound%core!fmt.Debug. E&. E&))))
(check-sat)

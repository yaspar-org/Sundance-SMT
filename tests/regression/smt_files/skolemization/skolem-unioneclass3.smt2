...
(assert (forall ((k P)) (! (not (b! $ Y (ol l) k (ol l))) :pattern ((b! $ Y (ol l) k (ol l))))))
(assert (= (lib!keys_t.KeyRange./KeyRange l l) (%Po (Pol (lib!keys_t.KeyRange./KeyRange l l)))))
(assert (= (st (P la) (P (%l (ly (li (o d)))))) t))
(assert (= (td $ Y $ (T O) (P la)) (v $ Y $ TY t)))
(assert (= la (%P (P la))))
(assert (not (forall ((T P)) (! (a (%% (%%l $ Y (v $ Y $ TY (st (P la) (P (%l (ly (li (o d))))))) $ Y $ TY (P la) $ Y $ TY (Poly (b (Po (oly (libd (%Pol (y p)))))))) T) TY) :pattern ((%% (%%l $ Y (P la) $ Y $ Y (P la) $ Y $ Y (Poly (b (Po (oly (libd (%Pol (y p)))))))) T))))))
(assert (= (B (lib (Pol (lib!keys_t.KeyRange./KeyRange l l)) (P la))) (%% la (P la))))
(assert (= (% (B (lib (Pol (lib!keys_t.KeyRange./KeyRange l l)) (P la)))) (b! $ Y (ol i) (ol (ib $ Y (Pol (lib!keys_t.KeyRange./KeyRange l l)))) (ol i))))
(assert (= i (lib!keys_t.KeyRange./KeyRange/?hi (%Po (Pol (lib!keys_t.KeyRange./KeyRange l l))))))
(declare-const !!skolem_variable_0 P)
;(assert (and true (not (a (%% (%%l $ Y (v $ Y $ TY (st (P la) (P (%l (ly (li (o d))))))) $ Y $ TY (P la) $ Y $ TY (Poly (b (Po (oly (libd (%Pol (y p)))))))) !!skolem_variable_0) TY))))
;(assert (= (%% (%%l $ Y (v $ Y $ TY (st (P la) (P (%l (ly (li (o d))))))) $ Y $ TY (P la) $ Y $ TY (Poly (b (Po (oly (libd (%Pol (y p)))))))) !!skolem_variable_0) (ite (s $ Y (v $ Y $ TY (st (P la) (P (%l (ly (li (o d))))))) !!skolem_variable_0) (vst $ Y $ Y !!skolem_variable_0 !!skolem_variable_0) (vs $ Y $ TY !!skolem_variable_0 !!skolem_variable_0))))
;(assert (not (b! $ Y (ol l) (ol (ib $ Y (Pol (lib!keys_t.KeyRange./KeyRange l l)))) (ol l))))
(declare-const !!skolem_variable_1 P)
;(assert (a (vs $ Y $ TY !!skolem_variable_0 !!skolem_variable_0) TY))

...
(declare-sort vs 0)
(declare-datatypes ((b 0) (b! 0)) (((ib! (lib! vs) (t vs) (s2 Int))) ((!e (b2 Int) (b!e Int)))))
(declare-fun l (b) vs)
(declare-fun b! (b!) Int)
(declare-fun b (b!) Int)
...
;(assert (forall ((& D) (A T) (s1 P) (s2 P)) (! (not (h s2 (T & YP))) :pattern ((e (T & A) s1 s2)))))
...
(declare-const s b!)
(declare-const se b!)
(assert (and (= (b! (Pol (ol s))) (b! (Pol (ol s)))) (not (e (T $ YP) (o (l (%Po (v $ E (ol s))))) (o (l (%Po (v $ E (ol se))))))) (or (i (ol se)))))


        (assert (= (l (%Po (v $ E (ol s)))) (lib! (%Po (v $ E (ol s))))))
        (assert (not (h (o (l (%Po (v $ E (ol se))))) (T $ YP))))
        ;(assert (= (v $ E (ol s)) (Po (ib! (%P (o (lib (I 0) (I (b! (Pol (ol s)))) (I (b (Pol (ol s))))))) (%P (o (lib (I 0) (I (b! (Pol (ol s)))) (I (b (Pol (ol s))))))) (% (I (b! (Pol (ol s)))))))))
        ;(assert (= (li (Pol (ol se))) (ib (I 0))))
        (assert (= (o (l (%Po (v $ E (ol se))))) (o (%P (o (l (%Po (v $ E (ol se)))))))))
        ...
        (assert (= (l (%Po (v $ E (ol se)))) (lib! (%Po (v $ E (ol se))))))
        ;(assert (= (lib (I 0) (I (b! (Pol (ol s)))) (I (b (Pol (ol s))))) (%P (vs $ YP $ (Y $ YP $ YP) (P (%% (ib (I (b! (Pol (ol s))))) (ib (I (b! (Pol (ol s))))) (ib (I (b! (Pol (ol s)))))))))))
        ;(assert (= (v $ E (ol se)) (Po (ib! (%P (o (lib (I 0) (I (b! (Pol (ol se)))) (I (b (Pol (ol se))))))) (%P (o (lib (I 0) (I (b! (Pol (ol se)))) (I (b (Pol (ol se))))))) (% (I (b! (Pol (ol se)))))))))
        ;(assert (or (h (Po (ib! (t (%Po (v $ E (ol s)))) (t (%Po (v $ E (ol s)))) (s2 (%Po (v $ E (ol s)))))) YP)))

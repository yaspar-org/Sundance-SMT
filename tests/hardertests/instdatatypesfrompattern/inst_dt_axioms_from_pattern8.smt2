...
(assert (= (lib!keys_t.KeyRange./KeyRange (pool l) (pool l)) (%Po (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))))
(assert (= (vst (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (P (%l (ly (li (o d)))))) (t $ Y $ TYP $ (TY TYP) (P (%l (ly (li (o d))))) (td $ Y $ (TY O) (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l)))))))))
(assert (= (td $ Y $ (TY O) (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool (pool l))))))) (v $ Y $ TYP (t $ Y $ TYP $ (TY TYP) (P (%l (ly (li (o d))))) (td $ Y $ (TY O) (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))))))))
(assert (= (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool (pool l))))) (%P (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))))))
(assert (= l (pool l)))
(assert (not (forall ((T P)) (! (a (%% (%%l $ Y (v $ Y $ TYP (vst (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (P (%l (ly (li (o d))))))) $ Y $ TYP (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) $ Y $ TYP (Poly%v (b (Poly (oly (lib!delegation_map_t.AbstractDelegationMap./AbstractDelegationMap (%Pol (y p)))))))) T) TYP) :pattern ((%% (%%l $ Y (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) $ Y $ Y (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) $ Y $ Y (Poly%v (b (Poly (oly (lib!delegation_map_t.AbstractDelegationMap./AbstractDelegationMap (%Pol (y p)))))))) T))))))
...
;(assert (= (i (%Po (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (lib!keys_t.KeyRange./KeyRange/?hi (%Po (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l)))))))
(declare-const !!skolem_variable_0 P)
(assert (not (a (%% (%%l $ Y (v $ Y $ TYP (vst (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (P (%l (ly (li (o d))))))) $ Y $ TYP (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) $ Y $ TYP (Poly%v (b (Poly (oly (lib!delegation_map_t.AbstractDelegationMap./AbstractDelegationMap (%Pol (y p)))))))) !!skolem_variable_0) TYP)))
(assert (= (%% (%%l $ Y (v $ Y $ TYP (vst (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (P (%l (ly (li (o d))))))) $ Y $ TYP (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) $ Y $ TYP (Poly%v (b (Poly (oly (lib!delegation_map_t.AbstractDelegationMap./AbstractDelegationMap (%Pol (y p)))))))) !!skolem_variable_0) (ite (s $ Y (v $ Y $ TYP (vst (P (la $ Y (Pol (lib!keys_t.KeyRange./KeyRange (pool l) (pool l))))) (P (%l (ly (li (o d))))))) !!skolem_variable_0) (vstd $ Y $ Y !!skolem_variable_0 !!skolem_variable_0) (vs $ Y $ TYP !!skolem_variable_0 !!skolem_variable_0))))
(declare-const !!skolem_variable_1 P)
(assert (a (vs $ Y $ TYP !!skolem_variable_0 !!skolem_variable_0) TYP))

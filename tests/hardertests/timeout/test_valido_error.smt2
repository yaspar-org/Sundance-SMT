...
(declare-const prev@ vstd!set.Set<int.>.)
(declare-const ret@ vstd!set.Set<int.>.)
...
(assert (not (=> (= decrease%init0 n!) (=> (= ret@ (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) (or (and (=> (= n! 0) (and (=> (has_type v@ INT) (=> (= tmp%1 (not (and (< first! (%I v@)) (< (%I v@) first!)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v@))))))) (=> (forall ((v$ Poly)) (! (=> (has_type v$ INT) (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v$))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v$)) )) (=> (= tmp%2 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) (vstd!set.impl&%0.empty.? $ INT))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 %%switch_label%%2)))))) (=> (not (= n! 0)) %%switch_label%%2)) (and (not %%switch_label%%2) (or (and (=> (> n! 0) (=> (= tmp%3 (nClip (Sub n! 1))) (and (=> %%location_label%%3 (check_decrease_int (let ((first!$0 first!) (n!$1 tmp%3)) n!$1) decrease%init0 false)) (=> (ens%verismo!tspec.range_set.lemma_to_set. first! tmp%3 prev@) (and (and (=> (has_type v$1@ INT) (=> (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v$1@) (=> (= tmp%4 (and (<= first! (%I v$1@)) (< (%I v$1@) (Add first! n!)))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (or (and (=> (and (<= first! (%I v$1@)) (< (%I v$1@) (Sub (Add first! n!) 1))) (=> (= tmp%5 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I (nClip (Sub n! 1))))) v$1@)) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 %%switch_label%%1)))) (=> (not (and (<= first! (%I v$1@)) (< (%I v$1@) (Sub (Add first! n!) 1)))) (=> (= tmp%6 (= (%I v$1@) (Sub (Add first! n!) 1))) (and (=> %%location_label%%6 tmp%6) (=> tmp%6 (=> (= tmp%7 (= (%I v$1@) (Add first! (Sub n! 1)))) (and (=> %%location_label%%7 tmp%7) (=> tmp%7 (=> (= tmp%8 (= (%I v$1@) (Add first! (Sub n! 1)))) (and (=> %%location_label%%8 tmp%8) (=> tmp%8 (=> (= tmp%9 (= (%I v$1@) (Add first! (Sub n! 1)))) (and (=> %%location_label%%9 tmp%9) (=> tmp%9 %%switch_label%%1)))))))))))))) (and (not %%switch_label%%1) (=> %%location_label%%10 (or (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I (nClip (Sub n! 1))))) v$1@) (= (%I v$1@) (Add first! (Sub n! 1)))))))))))) (=> (forall ((v$ Poly)) (! (=> (has_type v$ INT) (=> (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v$) (or (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I (nClip (Sub n! 1))))) v$) (= (%I v$) (Add first! (Sub n! 1)))))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v$)) )) (and (=> (has_type v$2@ INT) (=> (or (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I (nClip (Sub n! 1))))) v$2@) (= (%I v$2@) (Add first! (Sub n! 1)))) (=> %%location_label%%11 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v$2@)))) (=> (forall ((v$ Poly)) (! (=> (has_type v$ INT) (=> (or (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I (nClip (Sub n! 1))))) v$) (= (%I v$) (Add first! (Sub n! 1)))) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v$))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) v$)) )) (=> %%location_label%%12 (ext_eq true (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) (vstd!set.impl&%0.insert.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I (nClip (Sub n! 1))))) (I (Add first! (Sub n! 1)))))))))) (=> (ext_eq true (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I n!))) (vstd!set.impl&%0.insert.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I first!) (I (nClip (Sub n! 1))))) (I (Add first! (Sub n! 1))))) %%switch_label%%0)))))) (=> (not (> n! 0)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= ret! ret@) (and (=> %%location_label%%13 (= (vstd!set.impl&%0.len.? $ INT (Poly%vstd!set.Set<int.>. ret!)) n!)) (and (=> %%location_label%%14 (vstd!set.impl&%0.finite.? $ INT (Poly%vstd!set.Set<int.>. ret!))) (=> %%location_label%%15 (= ret! (verismo!tspec.range_set.range_to_set.? (I first!) (I n!)))))))))))))))
(check-sat)
(exit)

...
(declare-const ret! lib!array_vec.ArrayVec.)
(declare-const tmp%1 lib!array.Array.)
(declare-const ret@ lib!array_vec.ArrayVec.)
(assert fuel_defaults)
(assert (uInv SZ (const_int N&)))
(assert (let ((tmp%%$ (const_int N&))) (and (<= 0 tmp%%$) (<= tmp%%$ (- (uHi SZ) 1)))))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(assert (not (=> (ens%lib!array.impl&%0.new. T&. T& N&. N& tmp%1) (=> (= ret@ (lib!array_vec.ArrayVec./ArrayVec (%Poly%lib!array.Array. (Poly%lib!array.Array. tmp%1)) (%I (I 0)))) (=> (= ret! ret@) (and (=> %%location_label%%0 (lib!array_vec.impl&%0.wf.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. ret!))) (and (=> %%location_label%%1 (= (lib!array_vec.impl&%0.spec_len.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. ret!)) 0)) (=> %%location_label%%2 (= (lib!array_vec.impl&%0.spec_capacity.? T&. T& N&. N& (Poly%lib!array_vec.ArrayVec. ret!)) (const_int N&))))))))))
(check-sat)
(exit)

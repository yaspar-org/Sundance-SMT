...
(declare-fun ens%lib!pagetable.entry.page_entry_to_map_entry. (lib!pagetable.entry.PageEntry. lib!pagetable.entry.MapEntry.) Bool)
(assert (forall ((p! lib!pagetable.entry.PageEntry.) (ret! lib!pagetable.entry.MapEntry.)) (! (= (ens%lib!pagetable.entry.page_entry_to_map_entry. p! ret!) (and (has_type (Poly%lib!pagetable.entry.MapEntry. ret!) TYPE%lib!pagetable.entry.MapEntry.) (ext_eq false TYPE%lib!pagetable.entry.MapEntry. (Poly%lib!pagetable.entry.MapEntry. ret!) (Poly%lib!pagetable.entry.MapEntry. (lib!pagetable.entry.spec_page_entry_to_map_entry.? (Poly%lib!pagetable.entry.PageEntry. p!)))))) :pattern ((ens%lib!pagetable.entry.page_entry_to_map_entry. p! ret!)) )))
(declare-fun ens%lib!pagetable.entry.map_entry_to_page_entry. (lib!pagetable.entry.MapEntry. Bool lib!pagetable.entry.PageEntry.) Bool)
(assert (forall ((m! lib!pagetable.entry.MapEntry.) (ps! Bool) (ret! lib!pagetable.entry.PageEntry.)) (! (= (ens%lib!pagetable.entry.map_entry_to_page_entry. m! ps! ret!) (and (has_type (Poly%lib!pagetable.entry.PageEntry. ret!) TYPE%lib!pagetable.entry.PageEntry.) (= ret! (lib!pagetable.entry.spec_map_entry_to_page_entry.? (Poly%lib!pagetable.entry.MapEntry. m!) (B ps!))))) :pattern ((ens%lib!pagetable.entry.map_entry_to_page_entry. m! ps! ret!)) )))
(declare-const ret! lib!pagetable.entry.PageEntry.)
(declare-const m! lib!pagetable.entry.MapEntry.)
(declare-const ps! Bool)
(assert fuel_defaults)
(assert (has_type (Poly%lib!pagetable.entry.MapEntry. m!) TYPE%lib!pagetable.entry.MapEntry.))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (lib!pagetable.entry.PageEntry./PageEntry (%I (I (lib!pagetable.entry.MapEntry./MapEntry/addr (%Poly%lib!pagetable.entry.MapEntry. (Poly%lib!pagetable.entry.MapEntry. m!))))) (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. (lib!pagetable.entry.PageEntryPerm./PageEntryPerm (%B (B true)) (%B (B ps!)) (%B (B (lib!pagetable.entry.MapEntry./MapEntry/write (%Poly%lib!pagetable.entry.MapEntry. (Poly%lib!pagetable.entry.MapEntry. m!))))) (%B (B (lib!pagetable.entry.MapEntry./MapEntry/execute_disable (%Poly%lib!pagetable.entry.MapEntry. (Poly%lib!pagetable.entry.MapEntry. m!))))) (%B (B true))))))) (=> %%location_label%%0 (= ret! (lib!pagetable.entry.spec_map_entry_to_page_entry.? (Poly%lib!pagetable.entry.MapEntry. m!) (B ps!)))))))
(check-sat)
(exit)

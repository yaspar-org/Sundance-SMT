...
(declare-const tmp%3 vstd!set.Set<usize.>.)
(declare-const tmp%4 Bool)
(declare-const all_value_set@ vstd!set.Set<usize.>.)
...
(assert (= (vstd!set.impl&%0.contains.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. (lib!array_set.impl&%0.view.? N&. N& (Poly%lib!array_set.ArraySet. self!@0))) (I v!)) false))
(assert (and (<= 0 v!) (< v! (const_int N&))))
(declare-fun %%lambda%%2 (Int Int) %%Function%%)
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (v$ Poly)) (! (= (%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1) v$) (B (and (<= %%hole%%0 (%I v$)) (< (%I v$) %%hole%%1)))) :pattern ((%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1) v$)))))
...
(assert (not (and (=> %%location_label%%0 (req%lib!array.impl&%1.set. $ BOOL N&. N& (lib!array_set.ArraySet./ArraySet/data (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@0))) v! (B true))) (=> (and (= (lib!array_set.ArraySet./ArraySet/len self!@0) (lib!array_set.ArraySet./ArraySet/len self!@1)) (= (lib!array_set.ArraySet./ArraySet/set self!@0) (lib!array_set.ArraySet./ArraySet/set self!@1))) (=> (has_type (Poly%lib!array_set.ArraySet. self!@1) (TYPE%lib!array_set.ArraySet. N&. N&)) (=> (ens%lib!array.impl&%1.set. $ BOOL N&. N& (lib!array_set.ArraySet./ArraySet/data (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@0))) (lib!array_set.ArraySet./ArraySet/data (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@1))) v! (B true)) (=> (= tmp%1 (vstd!set.impl&%0.insert.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. (lib!array_set.ArraySet./ArraySet/set (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@1)))) (I v!))) (=> (= (lib!array_set.ArraySet./ArraySet/set (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@2))) (%Poly%vstd!set.Set<usize.>. tmp%1)) (=> (and (= (lib!array_set.ArraySet./ArraySet/data self!@1) (lib!array_set.ArraySet./ArraySet/data self!@2)) (= (lib!array_set.ArraySet./ArraySet/len self!@1) (lib!array_set.ArraySet./ArraySet/len self!@2))) (=> (= all_value_set@ (%Poly%vstd!set.Set<usize.>. (vstd!set.impl&%0.new.? $ (UINT SZ) $ (TYPE%fun%1. $ (UINT SZ) $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%2 0 (const_int N&))))))) (=> (vstd!set.impl&%0.finite.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. all_value_set@)) (=> (= (vstd!set.impl&%0.len.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. all_value_set@)) (const_int N&)) (=> (= tmp%2 (forall ((v$ Poly)) (! (=> (has_type v$ (UINT SZ)) (=> (vstd!set.impl&%0.contains.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. (lib!array_set.ArraySet./ArraySet/set (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@2)))) v$) (vstd!set.impl&%0.contains.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. all_value_set@) v$))) :pattern ((vstd!set.impl&%0.contains.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. all_value_set@) v$)) ))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (lib!array_set.ArraySet./ArraySet/set (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@2)))) (and (=> %%location_label%%2 (req%vstd!set_lib.lemma_len_subset. $ (UINT SZ) (Poly%vstd!set.Set<usize.>. tmp%3) (Poly%vstd!set.Set<usize.>. all_value_set@))) (=> (ens%vstd!set_lib.lemma_len_subset. $ (UINT SZ) (Poly%vstd!set.Set<usize.>. tmp%3) (Poly%vstd!set.Set<usize.>. all_value_set@)) (=> (= tmp%4 (<= (vstd!set.impl&%0.len.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. (lib!array_set.ArraySet./ArraySet/set (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@2))))) (const_int N&))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (and (=> %%location_label%%4 (uInv SZ (Add (lib!array_set.ArraySet./ArraySet/len (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@2))) 1))) (=> (= tmp%5 (uClip SZ (Add (lib!array_set.ArraySet./ArraySet/len (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@2))) 1))) (=> (= (lib!array_set.ArraySet./ArraySet/len (%Poly%lib!array_set.ArraySet. (Poly%lib!array_set.ArraySet. self!@3))) tmp%5) (=> (and (= (lib!array_set.ArraySet./ArraySet/data self!@2) (lib!array_set.ArraySet./ArraySet/data self!@3)) (= (lib!array_set.ArraySet./ArraySet/set self!@2) (lib!array_set.ArraySet./ArraySet/set self!@3))) (and (=> %%location_label%%5 (lib!array_set.impl&%0.wf.? N&. N& (Poly%lib!array_set.ArraySet. self!@3))) (=> %%location_label%%6 (= (lib!array_set.impl&%0.view.? N&. N& (Poly%lib!array_set.ArraySet. self!@3)) (%Poly%vstd!set.Set<usize.>. (vstd!set.impl&%0.insert.? $ (UINT SZ) (Poly%vstd!set.Set<usize.>. (lib!array_set.impl&%0.view.? N&. N& (Poly%lib!array_set.ArraySet. self!@0))) (I v!)))))))))))))))))))))))))))))))
(check-sat)
(exit)

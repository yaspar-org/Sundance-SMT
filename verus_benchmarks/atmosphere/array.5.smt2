...
(assert (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (pre%self! lib!array.Array.) (self! lib!array.Array.)) (! (= (ens%lib!array.impl&%4.init2none. T&. T& N&. N& pre%self! self!) (and (has_type (Poly%lib!array.Array. self!) (TYPE%lib!array.Array. $ (TYPE%core!option.Option. T&. T&) N&. N&)) (forall ((index$ Poly)) (! (=> (has_type index$ INT) (=> (and (<= 0 (%I index$)) (< (%I index$) (const_int N&))) ((_ is core!option.Option./None) (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. T&. T&) (lib!array.Array./Array/seq (%Poly%lib!array.Array. (Poly%lib!array.Array. self!))) index$))))) :pattern (((_ is core!option.Option./None) (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. T&. T&) (lib!array.Array./Array/seq (%Poly%lib!array.Array. (Poly%lib!array.Array. self!))) index$)))) )) (lib!array.impl&%0.wf.? $ (TYPE%core!option.Option. T&. T&) N&. N& (Poly%lib!array.Array. self!)))) :pattern ((ens%lib!array.impl&%4.init2none. T&. T& N&. N& pre%self! self!)) )))
(declare-const T&. Dcr)

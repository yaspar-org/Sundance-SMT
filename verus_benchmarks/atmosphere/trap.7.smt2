...
(declare-const ret! lib!trap.TrapFrameOption.)
(declare-const no%param Int)
(declare-const tmp%1 lib!trap.Registers.)
(assert fuel_defaults)
(declare-const %%location_label%%0 Bool)
(assert (not (=> (ens%lib!trap.impl&%4.zeroed. 0 tmp%1) (=> (= ret! (lib!trap.TrapFrameOption./TrapFrameOption (%Poly%lib!trap.Registers. (Poly%lib!trap.Registers. tmp%1)) (%B (B false)))) (=> %%location_label%%0 (lib!trap.impl&%0.is_None.? (Poly%lib!trap.TrapFrameOption. ret!)))))))
(check-sat)
(exit)

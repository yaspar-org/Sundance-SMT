...
(declare-fun req%lib!array_vec.test. (Dcr Type lib!array_vec.ArrayVec.) Bool)
(declare-const %%global_location_label%%29 Bool)
(declare-const %%global_location_label%%30 Bool)
(declare-const %%global_location_label%%31 Bool)
(declare-const %%global_location_label%%32 Bool)
(assert (forall ((N&. Dcr) (N& Type) (pre%ar! lib!array_vec.ArrayVec.)) (! (= (req%lib!array_vec.test. N&. N& pre%ar!) (and (=> %%global_location_label%%29 (lib!array_vec.impl&%0.wf.? $ (UINT 64) N&. N& (Poly%lib!array_vec.ArrayVec. pre%ar!))) (=> %%global_location_label%%30 (= (lib!array_vec.impl&%0.spec_len.? $ (UINT 64) N&. N& (Poly%lib!array_vec.ArrayVec. pre%ar!)) 1)) (=> %%global_location_label%%31 (= (%I (vstd!seq.Seq.index.? $ (UINT 64) (lib!array_vec.impl&%0.view.? $ (UINT 64) N&. N& (Poly%lib!array_vec.ArrayVec. pre%ar!)) (I 0))) 0)) (=> %%global_location_label%%32 (= (const_int N&) 2)))) :pattern ((req%lib!array_vec.test. N&. N& pre%ar!)) )))
(declare-fun ens%lib!array_vec.test. (Dcr Type lib!array_vec.ArrayVec. lib!array_vec.ArrayVec.) Bool)
(assert (forall ((N&. Dcr) (N& Type) (pre%ar! lib!array_vec.ArrayVec.) (ar! lib!array_vec.ArrayVec.)) (! (= (ens%lib!array_vec.test. N&. N& pre%ar! ar!) (has_type (Poly%lib!array_vec.ArrayVec. ar!) (TYPE%lib!array_vec.ArrayVec. $ (UINT 64) N&. N&))) :pattern ((ens%lib!array_vec.test. N&. N& pre%ar! ar!)) )))
(declare-const N&. Dcr)
(declare-const N& Type)
(declare-const ar!@0 lib!array_vec.ArrayVec.)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Bool)
(declare-const tmp%3 Bool)
(declare-const v_0@ Int)
(assert fuel_defaults)
(assert (has_type (Poly%lib!array_vec.ArrayVec. ar!@0) (TYPE%lib!array_vec.ArrayVec. $ (UINT 64) N&. N&)))
(assert (uInv SZ (const_int N&)))
(assert (lib!array_vec.impl&%0.wf.? $ (UINT 64) N&. N& (Poly%lib!array_vec.ArrayVec. ar!@0)))
(assert (= (lib!array_vec.impl&%0.spec_len.? $ (UINT 64) N&. N& (Poly%lib!array_vec.ArrayVec. ar!@0)) 1))
(assert (= (%I (vstd!seq.Seq.index.? $ (UINT 64) (lib!array_vec.impl&%0.view.? $ (UINT 64) N&. N& (Poly%lib!array_vec.ArrayVec. ar!@0)) (I 0))) 0))
(assert (= (const_int N&) 2))
(declare-const ar!@1 lib!array_vec.ArrayVec.)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!array_vec.impl&%0.pop. $ (UINT 64) N&. N& ar!@0)) (=> (has_type (Poly%lib!array_vec.ArrayVec. ar!@1) (TYPE%lib!array_vec.ArrayVec. $ (UINT 64) N&. N&)) (=> (ens%lib!array_vec.impl&%0.pop. $ (UINT 64) N&. N& ar!@0 ar!@1 tmp%1) (=> (= v_0@ (%I tmp%1)) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 64)) (lib!array_vec.impl&%0.view.? $ (UINT 64) N&. N& (Poly%lib!array_vec.ArrayVec. ar!@1)) (vstd!seq.Seq.empty.? $ (UINT 64)))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (= v_0@ 0)) (=> %%location_label%%2 tmp%3)))))))))))
(check-sat)
(exit)

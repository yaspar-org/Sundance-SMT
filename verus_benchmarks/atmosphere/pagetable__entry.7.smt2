...
(declare-const ret! lib!pagetable.entry.MapEntry.)
(declare-const p! lib!pagetable.entry.PageEntry.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!pagetable.entry.PageEntry. p!) TYPE%lib!pagetable.entry.PageEntry.))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (lib!pagetable.entry.MapEntry./MapEntry (%I (I (lib!pagetable.entry.PageEntry./PageEntry/addr (%Poly%lib!pagetable.entry.PageEntry. (Poly%lib!pagetable.entry.PageEntry. p!))))) (%B (B (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/write (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. (lib!pagetable.entry.PageEntry./PageEntry/perm (%Poly%lib!pagetable.entry.PageEntry. (Poly%lib!pagetable.entry.PageEntry. p!)))))))) (%B (B (lib!pagetable.entry.PageEntryPerm./PageEntryPerm/execute_disable (%Poly%lib!pagetable.entry.PageEntryPerm. (Poly%lib!pagetable.entry.PageEntryPerm. (lib!pagetable.entry.PageEntry./PageEntry/perm (%Poly%lib!pagetable.entry.PageEntry. (Poly%lib!pagetable.entry.PageEntry. p!)))))))))) (=> %%location_label%%0 (ext_eq false TYPE%lib!pagetable.entry.MapEntry. (Poly%lib!pagetable.entry.MapEntry. ret!) (Poly%lib!pagetable.entry.MapEntry. (lib!pagetable.entry.spec_page_entry_to_map_entry.? (Poly%lib!pagetable.entry.PageEntry. p!))))))))
(check-sat)
(exit)

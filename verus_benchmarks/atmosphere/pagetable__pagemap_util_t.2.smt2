...
(assert (=> (fuel_bool fuel%vstd!raw_ptr.impl&%7.is_init.) (forall ((T&. Dcr) (T& Type) (self! Poly)) (! (= (vstd!raw_ptr.impl&%7.is_init.? T&. T& self!) ((_ is vstd!raw_ptr.MemContents./Init) (%Poly%vstd!raw_ptr.MemContents. self!))) :pattern ((vstd!raw_ptr.impl&%7.is_init.? T&. T& self!)) ))))
(assert (fuel_bool_default fuel%vstd!simple_pptr.impl&%1.is_init.))
(assert (=> (fuel_bool fuel%vstd!simple_pptr.impl&%1.is_init.) (forall ((V&. Dcr) (V& Type) (self! Poly)) (! (= (vstd!simple_pptr.impl&%1.is_init.? V&. V& self!) ((_ is vstd!raw_ptr.MemContents./Init) (vstd!simple_pptr.impl&%1.mem_contents.? V&. V& self!))) :pattern ((vstd!simple_pptr.impl&%1.is_init.? V&. V& self!)) ))))
...
(assert (forall ((V&. Dcr) (V& Type) (self! Poly)) (! (= (req%vstd!simple_pptr.impl&%1.value. V&. V& self!) (=> %%global_location_label%%6 ((_ is vstd!raw_ptr.MemContents./Init) (vstd!simple_pptr.impl&%1.mem_contents.? V&. V& self!)))) :pattern ((req%vstd!simple_pptr.impl&%1.value. V&. V& self!)) )))
...
(assert ((_ is vstd!raw_ptr.MemContents./Init) (vstd!simple_pptr.impl&%1.mem_contents.? $ TYPE%lib!pagetable.pagemap.PageMap. (Poly%vstd!simple_pptr.PointsTo<lib!pagetable.pagemap.PageMap.>. page_map_perm!@0))))

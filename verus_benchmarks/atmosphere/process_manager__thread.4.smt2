...
(assert (not (=> (= ret! (ite ((_ is lib!process_manager.thread.IPCPayLoad./Pci) self!) (let ((bus$ (lib!process_manager.thread.IPCPayLoad./Pci/bus (%Poly%lib!process_manager.thread.IPCPayLoad. (Poly%lib!process_manager.thread.IPCPayLoad. self!))))) (let ((dev$ (lib!process_manager.thread.IPCPayLoad./Pci/dev (%Poly%lib!process_manager.thread.IPCPayLoad. (Poly%lib!process_manager.thread.IPCPayLoad. self!))))) (let ((fun$ (lib!process_manager.thread.IPCPayLoad./Pci/fun (%Poly%lib!process_manager.thread.IPCPayLoad. (Poly%lib!process_manager.thread.IPCPayLoad. self!))))) (core!option.Option./Some (Poly%tuple%3. (tuple%3./tuple%3 (I bus$) (I dev$) (I fun$))))))) core!option.Option./None)) (=> %%location_label%%0 (= ret! (lib!process_manager.thread.impl&%3.spec_get_payload_as_pci.? (Poly%lib!process_manager.thread.IPCPayLoad. self!)))))))
(check-sat)
(exit)

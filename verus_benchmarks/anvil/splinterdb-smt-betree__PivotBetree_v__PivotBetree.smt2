...
(assert (forall ((elem! Poly)) (! (= (req%lib!spec.KeyType_t.to_key. elem!) (=> %%global_location_label%%10 ((_ is lib!spec.KeyType_t.Element./Elem) (%Poly%lib!spec.KeyType_t.Element. elem!)))) :pattern ((req%lib!spec.KeyType_t.to_key. elem!)) )))
...
(assert (forall ((self! Poly)) (! (= (req%lib!betree.PivotBetree_v.impl&%1.wf_children. self!) (and (=> %%global_location_label%%18 ((_ is lib!betree.PivotBetree_v.BetreeNode./Node) (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (=> %%global_location_label%%19 ((_ is lib!betree.PivotBetree_v.BetreeNode./Node) (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))))) :pattern ((req%lib!betree.PivotBetree_v.impl&%1.wf_children. self!)) )))

...
(declare-const alloc! lib!exec.MiniAllocator_v.PageAllocator.)
(declare-const au! Int)
(assert fuel_defaults)
(assert (uInv 32 au!))
(assert (< au! (lib!disk.GenericDisk_v.au_count.? (I 0))))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= alloc! (lib!exec.MiniAllocator_v.PageAllocator./PageAllocator (%I (I 0)) (%I (I 0)) (%I (I au!)))) (=> %%location_label%%0 (lib!exec.MiniAllocator_v.impl&%1.wf.? (Poly%lib!exec.MiniAllocator_v.PageAllocator. alloc!))))))
(check-sat)
(exit)

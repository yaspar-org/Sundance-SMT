...
(assert (not (or (and (=> ((_ is lib!betree.PivotBranch_v.Node./Leaf) (%Poly%lib!betree.PivotBranch_v.Node. self!)) (=> (= tmp%10 (let ((keys$ (lib!betree.PivotBranch_v.Node./Leaf/keys (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (let ((msgs$ (lib!betree.PivotBranch_v.Node./Leaf/msgs (%Poly%lib!betree.PivotBranch_v.Node. self!)))) (and (and (> (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys$)) 0) (= (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys$)) (vstd!seq.Seq.len.? $ TYPE%lib!spec.Messages_t.Message. (Poly%vstd!seq.Seq<lib!spec.Messages_t.Message.>. msgs$)))) (lib!spec.KeyType_t.impl&%1.is_strictly_sorted.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. keys$)))))) %%switch_label%%0)) (=> (not ((_ is lib!betree.PivotBranch_v.Node./Leaf) (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= pivots@ (lib!betree.PivotBranch_v.Node./Index/pivots (%Poly%lib!betree.PivotBranch_v.Node. self!))) (=> (= children@ (lib!betree.PivotBranch_v.Node./Index/children (%Poly%lib!betree.PivotBranch_v.Node. self!))) (or (and (=> (and (= (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. pivots@)) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)) 1)) (lib!spec.KeyType_t.impl&%1.is_strictly_sorted.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. pivots@))) (=> (has_type i@ INT) (or (and (=> (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) i@)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) i@)) (=> (= tmp%2 (lib!betree.PivotBranch_v.impl&%3.wf.? tmp%1)) %%switch_label%%6)))) (=> (not (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))))) (=> (= tmp%2 true) %%switch_label%%6))) (and (not %%switch_label%%6) (=> (= tmp%3 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)))) (lib!betree.PivotBranch_v.impl&%3.wf.? (vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) i$)))) :pattern ((vstd!seq.Seq.index.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@) i$)) ))) %%switch_label%%5))))) (=> (not (and (= (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Key. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. pivots@)) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)) 1)) (lib!spec.KeyType_t.impl&%1.is_strictly_sorted.? (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Key.>. pivots@)))) (=> (= tmp%3 false) %%switch_label%%5))) (and (not %%switch_label%%5) (or (and (=> tmp%3 (=> (has_type i$1@ INT) (or (and (=> (and (<= 0 (%I i$1@)) (< (%I i$1@) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)) 1))) (and (=> %%location_label%%1 (req%lib!betree.PivotBranch_v.impl&%3.all_keys_below_bound. self! i$1@)) (=> (= tmp%4 (lib!betree.PivotBranch_v.impl&%3.all_keys_below_bound.? self! i$1@)) (=> (= tmp%5 tmp%4) %%switch_label%%4)))) (=> (not (and (<= 0 (%I i$1@)) (< (%I i$1@) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)) 1)))) (=> (= tmp%5 true) %%switch_label%%4))) (and (not %%switch_label%%4) (=> (= tmp%6 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (Sub (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)) 1))) (lib!betree.PivotBranch_v.impl&%3.all_keys_below_bound.? self! i$))) :pattern ((lib!betree.PivotBranch_v.impl&%3.all_keys_below_bound.? self! i$)) ))) %%switch_label%%3))))) (=> (not tmp%3) (=> (= tmp%6 false) %%switch_label%%3))) (and (not %%switch_label%%3) (or (and (=> tmp%6 (=> (has_type i$2@ INT) (or (and (=> (and (< 0 (%I i$2@)) (< (%I i$2@) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)))) (and (=> %%location_label%%2 (req%lib!betree.PivotBranch_v.impl&%3.all_keys_above_bound. self! i$2@)) (=> (= tmp%7 (lib!betree.PivotBranch_v.impl&%3.all_keys_above_bound.? self! i$2@)) (=> (= tmp%8 tmp%7) %%switch_label%%2)))) (=> (not (and (< 0 (%I i$2@)) (< (%I i$2@) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@))))) (=> (= tmp%8 true) %%switch_label%%2))) (and (not %%switch_label%%2) (=> (= tmp%9 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (< 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ TYPE%lib!betree.PivotBranch_v.Node. (Poly%vstd!seq.Seq<lib!betree.PivotBranch_v.Node.>. children@)))) (lib!betree.PivotBranch_v.impl&%3.all_keys_above_bound.? self! i$))) :pattern ((lib!betree.PivotBranch_v.impl&%3.all_keys_above_bound.? self! i$)) ))) %%switch_label%%1))))) (=> (not tmp%6) (=> (= tmp%9 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%10 tmp%9) %%switch_label%%0))))))))))) (not %%switch_label%%0))))
(check-sat)
(exit)

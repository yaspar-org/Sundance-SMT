...
(assert (not (=> (= decrease%init0 (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!))) (or (and (=> (< 0 (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!))) (=> (= last_lsn@ (nClip (Sub (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!))) 1))) (=> (= tmp%1 (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!) (I last_lsn@))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 self!) (puts!$1 tmp%1)) (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!$1))) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!betree.Memtable_v.impl&%0.apply_puts_end. T&. T& self! tmp%1)) (=> (ens%lib!betree.Memtable_v.impl&%0.apply_puts_end. T&. T& self! tmp%1) %%switch_label%%0)))))) (=> (not (< 0 (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (= (lib!betree.Memtable_v.Memtable./Memtable/seq_end (%Poly%lib!betree.Memtable_v.Memtable. (Poly%lib!betree.Memtable_v.Memtable. (lib!betree.Memtable_v.impl&%0.apply_puts.? T&. T& (Poly%lib!betree.Memtable_v.Memtable. self!) (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!))))) (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!))))))))))
(check-sat)
(exit)

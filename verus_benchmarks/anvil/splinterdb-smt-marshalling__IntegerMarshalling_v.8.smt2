...
(assert (not (=> (ens%lib!marshalling.StaticallySized_v.StaticallySized.uniform_size_ensures. T&. T&) (and (=> %%location_label%%0 (< 0 (%I (lib!marshalling.UniformSized_v.UniformSized.uniform_size.? $ (TYPE%lib!marshalling.IntegerMarshalling_v.IntFormat. T&. T&) self!)))) (=> %%location_label%%1 (< 0 (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? T&. T&))))))))
(check-sat)
(exit)

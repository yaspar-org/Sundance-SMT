...
(assert (not (=> (and (<= 0 (%I start!)) (<= (%I start!) (lib!betree.BufferSeq_v.impl&%0.len.? self!))) (=> (<= (%I start!) (lib!betree.BufferSeq_v.impl&%0.len.? self!)) (or (and (=> (= (%I start!) (lib!betree.BufferSeq_v.impl&%0.len.? self!)) (=> (= tmp%5 (lib!spec.Messages_t.Message./Update (%Poly%lib!spec.Messages_t.Delta. (Poly%lib!spec.Messages_t.Delta. (lib!spec.Messages_t.nop_delta.? (I 0)))))) %%switch_label%%0)) (=> (not (= (%I start!) (lib!betree.BufferSeq_v.impl&%0.len.? self!))) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!betree.Buffer_v.SimpleBuffer. tmp%2 start!)) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. (Poly%vstd!seq.Seq<lib!betree.Buffer_v.SimpleBuffer.>. (lib!betree.BufferSeq_v.BufferSeq./BufferSeq/buffers (%Poly%lib!betree.BufferSeq_v.BufferSeq. self!))) start!)) (=> (= tmp%4 (I (Add (%I start!) 1))) (and (=> %%location_label%%1 (req%lib!betree.BufferSeq_v.impl&%0.query_from. self! key! tmp%4)) (=> (= tmp%3 (lib!betree.BufferSeq_v.impl&%0.query_from.? self! key! (I (Add (%I start!) 1)))) (=> (= tmp%5 (lib!spec.Messages_t.impl&%1.merge.? (lib!betree.Buffer_v.Buffer.query.? $ TYPE%lib!betree.Buffer_v.SimpleBuffer. tmp%1 key!) (Poly%lib!spec.Messages_t.Message. tmp%3))) %%switch_label%%0))))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)

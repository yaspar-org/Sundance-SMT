...
(assert (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) s!)) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 8)))))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (and (=> %%location_label%%0 (req%vstd!slice.slice_index_get. $ (UINT 8) s! 0)) (=> (ens%vstd!slice.slice_index_get. $ (UINT 8) s! 0 tmp%1) (=> (= %return! tmp%1) (=> %%location_label%%1 (= %return! (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_from_le_bytes.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) s!)))))))))
(check-sat)
(exit)

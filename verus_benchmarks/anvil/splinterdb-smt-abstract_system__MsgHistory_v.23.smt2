...
(assert (not (=> (= decrease%init0 (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (or (and (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) (=> (= last_lsn@ (nClip (Sub (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!))) 1))) (=> (= tmp%1 (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (I last_lsn@))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 tmp%1) (orig!$1 orig!)) (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!$0))) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_length_lemma. tmp%1 orig!)) (=> (ens%lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map_length_lemma. tmp%1 orig!) %%switch_label%%0)))))) (=> (not (not (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (= (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. (lib!abstract_system.MsgHistory_v.impl&%0.apply_to_stamped_map.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!) (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))))) (nClip (Add (lib!abstract_system.StampedMap_v.Stamped./Stamped/seq_end (%Poly%lib!abstract_system.StampedMap_v.Stamped. (Poly%lib!abstract_system.StampedMap_v.Stamped. orig!))) (lib!abstract_system.MsgHistory_v.impl&%0.len.? (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. self!)))))))))))
(check-sat)
(exit)

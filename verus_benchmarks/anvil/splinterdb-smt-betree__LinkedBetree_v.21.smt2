...
(assert (forall ((elem! Poly)) (! (= (req%lib!spec.KeyType_t.to_key. elem!) (=> %%global_location_label%%11 ((_ is lib!spec.KeyType_t.Element./Elem) (%Poly%lib!spec.KeyType_t.Element. elem!)))) :pattern ((req%lib!spec.KeyType_t.to_key. elem!)) )))
...
(assert (not (=> (lib!betree.LinkedBetree_v.impl&%5.has_root.? T&. T& self!) (=> (= tmp%2 (Poly%lib!betree.LinkedBetree_v.DiskView. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/dv (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))) (=> (= tmp%3 (Poly%core!option.Option. (lib!betree.LinkedBetree_v.LinkedBetree./LinkedBetree/root (%Poly%lib!betree.LinkedBetree_v.LinkedBetree. self!)))) (=> %%location_label%%0 (req%lib!betree.LinkedBetree_v.impl&%1.get. tmp%2 tmp%3)))))))
(check-sat)
(exit)

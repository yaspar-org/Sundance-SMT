...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.has_root.? self!) (=> (= tmp%2 (Poly%lib!betree.LinkedBranch_v.DiskView. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/disk_view (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!)))) (=> (= tmp%3 (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!)))) (=> %%location_label%%0 (req%lib!betree.LinkedBranch_v.impl&%4.get. tmp%2 tmp%3)))))))
(check-sat)
(exit)

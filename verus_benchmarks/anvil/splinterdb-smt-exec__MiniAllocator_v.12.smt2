...
(assert ((_ is core!option.Option./Some) (lib!exec.MiniAllocator_v.MiniAllocator./MiniAllocator/allocs (%Poly%lib!exec.MiniAllocator_v.MiniAllocator. (Poly%lib!exec.MiniAllocator_v.MiniAllocator. self!@0)))))

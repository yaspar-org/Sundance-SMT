...
(assert (not (=> (lib!betree.PivotBetree_v.impl&%1.wf.? self!) (=> (lib!betree.Domain_v.impl&%1.wf.? domain!) (=> ((_ is lib!betree.Domain_v.Domain./Domain) (%Poly%lib!betree.Domain_v.Domain. domain!)) (or (and (=> ((_ is lib!betree.PivotBetree_v.BetreeNode./Nil) (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) (and (=> %%location_label%%0 (req%lib!betree.PivotBetree_v.impl&%1.empty_root. domain!)) (=> (= tmp%1 (lib!betree.PivotBetree_v.impl&%1.empty_root.? domain!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not ((_ is lib!betree.PivotBetree_v.BetreeNode./Nil) (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!))) (=> (= tmp%2 (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)

...
(assert (not (=> (lib!betree.LinkedBranch_v.impl&%5.wf.? self!) (or (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking!) (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!)))) (=> (= tmp%2 (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!)))) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking! tmp%2)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking! (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))))) (=> (= tmp%3 (nClip (Add (%I tmp%1) 1))) %%switch_label%%0))))) (=> (not (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ NAT ranking!) (Poly%lib!spec.AsyncDisk_t.Address. (lib!betree.LinkedBranch_v.LinkedBranch./LinkedBranch/root (%Poly%lib!betree.LinkedBranch_v.LinkedBranch. self!))))) (=> (= tmp%3 0) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)

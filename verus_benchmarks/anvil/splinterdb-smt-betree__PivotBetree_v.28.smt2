...
(assert (forall ((self! Poly) (new_buffer! Poly)) (! (= (req%lib!betree.PivotBetree_v.impl&%1.merge_buffer. self! new_buffer!) (=> %%global_location_label%%36 ((_ is lib!betree.PivotBetree_v.BetreeNode./Node) (%Poly%lib!betree.PivotBetree_v.BetreeNode. self!)))) :pattern ((req%lib!betree.PivotBetree_v.impl&%1.merge_buffer. self! new_buffer!)) )))

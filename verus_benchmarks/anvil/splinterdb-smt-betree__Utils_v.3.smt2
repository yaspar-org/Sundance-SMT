...
(assert (has_type a! A&))
(assert (vstd!set.impl&%0.contains.? A&. A& (lib!betree.Utils_v.union_seq_of_sets.? A&. A& sets!) a!))
...
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!)) (=> (= tmp%1 (> (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!) 0)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!set.Set. A&. A&) (lib!betree.Utils_v.union_seq_of_sets.? A&. A& sets!) (vstd!set.impl&%0.union.? A&. A& (lib!betree.Utils_v.union_seq_of_sets.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? $ (TYPE%vstd!set.Set. A&. A&) sets!)) (vstd!seq.Seq.last.? $ (TYPE%vstd!set.Set. A&. A&) sets!)))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (or (and (=> (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.last.? $ (TYPE%vstd!set.Set. A&. A&) sets!) a!) %%switch_label%%0) (=> (not (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.last.? $ (TYPE%vstd!set.Set. A&. A&) sets!) a!)) (=> (= tmp%3 (vstd!seq_lib.impl&%0.drop_last.? $ (TYPE%vstd!set.Set. A&. A&) sets!)) (and (=> %%location_label%%2 (check_decrease_int (let ((sets!$0 tmp%3) (a!$1 a!)) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!$0)) decrease%init0 false)) (and (=> %%location_label%%3 (req%lib!betree.Utils_v.lemma_union_seq_of_sets_contains. A&. A& tmp%3 a!)) (=> (ens%lib!betree.Utils_v.lemma_union_seq_of_sets_contains. A&. A& tmp%3 a!) %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> %%location_label%%4 (exists ((i$ Poly)) (! (and (has_type i$ INT) (and (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. A&. A&) sets!))) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$) a!))) :pattern ((vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set. A&. A&) sets! i$)) ))))))))))))))
(check-sat)
(exit)

...
(assert (not (=> (and (<= 0 (%I idx!)) (< (%I idx!) (lib!betree.BufferOffsets_v.impl&%0.len.? self!))) (=> (= tmp%2 (Poly%vstd!seq.Seq<nat.>. (lib!betree.BufferOffsets_v.BufferOffsets./BufferOffsets/offsets (%Poly%lib!betree.BufferOffsets_v.BufferOffsets. self!)))) (=> %%location_label%%0 (req%vstd!seq.Seq.update. $ NAT tmp%2 idx! value!))))))
(check-sat)
(exit)

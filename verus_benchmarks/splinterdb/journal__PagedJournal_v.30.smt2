...
(assert (not (=> (= decrease%init0 depth!) (or (and (=> (< 0 depth!) (=> (= tmp%1 (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.cropped_prior.? (Poly%lib!journal.PagedJournal_v.JournalRecord. self!) (I boundary_lsn!))))))) (=> (= tmp%2 (nClip (Sub depth! 1))) (=> (= tmp%3 (nClip (Sub more! 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 tmp%1) (boundary_lsn!$1 boundary_lsn!) (depth!$2 tmp%2) (more!$3 tmp%3)) depth!$2) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!journal.PagedJournal_v.impl&%0.can_crop_monotonic. tmp%1 boundary_lsn! tmp%2 tmp%3)) (=> (ens%lib!journal.PagedJournal_v.impl&%0.can_crop_monotonic. tmp%1 boundary_lsn! tmp%2 tmp%3) %%switch_label%%0))))))) (=> (not (< 0 depth!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (lib!journal.PagedJournal_v.impl&%0.can_crop_head_records.? (Poly%lib!journal.PagedJournal_v.JournalRecord. self!) (I boundary_lsn!) (I depth!))))))))
(check-sat)
(exit)

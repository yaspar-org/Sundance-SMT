...
(assert (fuel_bool_default fuel%lib!betree.PivotTable_v.impl&%0.pivot_range_keyset.))
(declare-fun %%lambda%%1 (Poly Poly Int) %%Function%%)
(assert (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Int) (k$ Poly)) (! (= (%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1 %%hole%%2) k$) (B (and (lib!betree.PivotTable_v.impl&%0.bounded_key.? %%hole%%0 k$) (= (lib!betree.PivotTable_v.impl&%0.route.? %%hole%%1 k$) %%hole%%2)))) :pattern ((%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1 %%hole%%2) k$)))))
(assert (=> (fuel_bool fuel%lib!betree.PivotTable_v.impl&%0.pivot_range_keyset.) (forall ((self! Poly) (i! Poly)) (! (= (lib!betree.PivotTable_v.impl&%0.pivot_range_keyset.? self! i!) (%Poly%vstd!set.Set<lib!spec.KeyType_t.Key.>. (vstd!set.impl&%0.new.? $ TYPE%lib!spec.KeyType_t.Key. $ (TYPE%fun%1. $ TYPE%lib!spec.KeyType_t.Key. $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%1 self! self! (%I i!))))))) :pattern ((lib!betree.PivotTable_v.impl&%0.pivot_range_keyset.? self! i!)) ))))
...
(declare-const element! lib!spec.KeyType_t.Element.)
(declare-const i@ Poly)
(declare-const j@ Poly)
(declare-const tmp%1 Bool)
(declare-const tmp%2 Bool)
(declare-const result@ vstd!seq.Seq<lib!spec.KeyType_t.Element.>.)
(assert fuel_defaults)
(assert (has_type (Poly%lib!spec.KeyType_t.Element. element!) TYPE%lib!spec.KeyType_t.Element.))
(assert (lib!betree.PivotTable_v.impl&%0.wf.? (Poly%lib!betree.PivotTable_v.PivotTable. self!)))
(assert (lib!betree.PivotTable_v.impl&%0.can_insert.? (Poly%lib!betree.PivotTable_v.PivotTable. self!) (I idx!) (Poly%lib!spec.KeyType_t.Element. element!)))
...
(assert (not (=> (= result@ (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotTable_v.impl&%0.insert.? (Poly%lib!betree.PivotTable_v.PivotTable. self!) (I idx!) (Poly%lib!spec.KeyType_t.Element. element!)))))) (=> (ens%lib!spec.KeyType_t.impl&%2.lte_transitive_forall. 0) (and (=> (has_type i@ INT) (=> (has_type j@ INT) (=> (and (and (<= 0 (%I i@)) (< (%I i@) (%I j@))) (< (%I j@) (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@)))) (or (and (=> (and (= (%I i@) idx!) (> (%I j@) (Add (%I i@) 1))) (=> (= tmp%1 (lib!spec.KeyType_t.impl&%2.lt.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) (I (Add (%I i@) 1))) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) j@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (and (= (%I i@) idx!) (> (%I j@) (Add (%I i@) 1)))) (or (and (=> (and (< (%I i@) (Sub idx! 1)) (= (%I j@) idx!)) (=> (= tmp%2 (lib!spec.KeyType_t.impl&%2.lt.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) i@) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) (I (Sub (%I j@) 1))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%1)))) (=> (not (and (< (%I i@) (Sub idx! 1)) (= (%I j@) idx!))) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%2 (lib!spec.KeyType_t.impl&%2.lt.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) i@) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) j@)))))))) (=> (forall ((i$ Poly) (j$ Poly)) (! (=> (and (has_type i$ INT) (has_type j$ INT)) (=> (and (and (<= 0 (%I i$)) (< (%I i$) (%I j$))) (< (%I j$) (vstd!seq.Seq.len.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@)))) (lib!spec.KeyType_t.impl&%2.lt.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) i$) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) j$)))) :pattern ((lib!spec.KeyType_t.impl&%2.lt.? (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) i$) (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. result@) j$))) )) (=> %%location_label%%3 (lib!betree.PivotTable_v.impl&%0.wf.? (Poly%lib!betree.PivotTable_v.PivotTable. (lib!betree.PivotTable_v.impl&%0.insert.? (Poly%lib!betree.PivotTable_v.PivotTable. self!) (I idx!) (Poly%lib!spec.KeyType_t.Element. element!)))))))))))
(check-sat)
(exit)

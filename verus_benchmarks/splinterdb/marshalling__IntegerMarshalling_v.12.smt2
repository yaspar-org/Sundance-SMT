...
(assert (has_type x! (UINT 8)))
(declare-fun %%array%%0 (Poly) %%Function%%)
(assert (forall ((%%hole%%0 Poly)) (! (let ((%%x%% (%%array%%0 %%hole%%0))) (= (%%apply%%1 %%x%% 0) %%hole%%0)) :pattern ((%%array%%0 %%hole%%0)) )))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(assert (not (=> (= tmp%2 (%Poly%array%. (array_new $ (UINT 8) 1 (%%array%%0 x!)))) (=> (ens%alloc!boxed.impl&%0.new. $ (ARRAY $ (UINT 8) $ (CONST_INT 1)) (Poly%array%. tmp%2) tmp%1) (=> (ens%vstd!array.array_as_slice. $ (UINT 8) $ (CONST_INT 1) (%Poly%array%. tmp%1) tmp%3) (=> (ens%alloc!slice.impl&%0.into_vec. $ (UINT 8) $ ALLOCATOR_GLOBAL tmp%3 tmp%4) (=> (= s@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%4)) (=> (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. s@)) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x!))) (and (=> %%location_label%%0 tmp%5) (=> tmp%5 (=> (= %return! (Poly%alloc!vec.Vec<u8./allocator_global%.>. s@)) (and (=> %%location_label%%1 (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) %return!) (lib!marshalling.IntegerMarshalling_v.IntFormattable.spec_to_le_bytes.? $ (UINT 8) x!))) (=> %%location_label%%2 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) %return!)) (%I (lib!marshalling.StaticallySized_v.StaticallySized.uniform_size.? $ (UINT 8)))))))))))))))))
(check-sat)
(exit)

...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.entries_wf.? self!) (=> (lib!journal.LinkedJournal_v.impl&%1.nondangling_pointers.? self!) (=> (has_type addr@ TYPE%lib!spec.AsyncDisk_t.Address.) (or (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) addr@) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.this_block_can_concat. self! addr@)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.this_block_can_concat.? self! addr@)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (vstd!set.impl&%0.contains.? $ TYPE%lib!spec.AsyncDisk_t.Address. (vstd!map.impl&%0.dom.? $ TYPE%lib!spec.AsyncDisk_t.Address. $ TYPE%lib!journal.LinkedJournal_v.JournalRecord. (Poly%vstd!map.Map<lib!spec.AsyncDisk_t.Address./lib!journal.LinkedJournal_v.JournalRecord.>. (lib!journal.LinkedJournal_v.DiskView./DiskView/entries (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)))) addr@)) (=> (= tmp%2 true) %%switch_label%%0))) (not %%switch_label%%0)))))))
(check-sat)
(exit)

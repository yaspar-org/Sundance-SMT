...
(assert (not (=> (lib!journal.LinkedJournal_v.impl&%1.decodable.? self! root!) (=> (lib!journal.LinkedJournal_v.impl&%1.block_in_bounds.? self! root!) (or (and (=> (< 0 (%I depth!)) (or (and (=> ((_ is core!option.Option./Some) (%Poly%core!option.Option. root!)) (and (=> %%location_label%%0 (req%lib!journal.LinkedJournal_v.impl&%1.next. self! root!)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!)) (=> (= tmp%3 (I (nClip (Sub (%I depth!) 1)))) (and (=> %%location_label%%1 (req%lib!journal.LinkedJournal_v.impl&%1.can_crop. self! (Poly%core!option.Option. tmp%1) tmp%3)) (=> (= tmp%2 (lib!journal.LinkedJournal_v.impl&%1.can_crop.? self! (Poly%core!option.Option. tmp%1) (I (nClip (Sub (%I depth!) 1))))) (=> (= tmp%4 tmp%2) %%switch_label%%1))))))) (=> (not ((_ is core!option.Option./Some) (%Poly%core!option.Option. root!))) (=> (= tmp%4 false) %%switch_label%%1))) (and (not %%switch_label%%1) (=> (= tmp%5 tmp%4) %%switch_label%%0)))) (=> (not (< 0 (%I depth!))) (=> (= tmp%5 true) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)

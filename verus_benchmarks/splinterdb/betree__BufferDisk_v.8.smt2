...
(assert (not (=> (<= 0 (%I from_idx!)) (=> (lib!betree.OffsetMap_v.impl&%0.is_total.? offset_map!) (and (=> %%location_label%%0 (req%lib!betree.BufferDisk_v.impl&%1.key_in_buffer. T&. T& self! buffers! from_idx! k! idx!)) (=> (= tmp%1 (lib!betree.BufferDisk_v.impl&%1.key_in_buffer.? T&. T& self! buffers! from_idx! k! idx!)) (or (and (=> tmp%1 (=> (= tmp%3 (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./nat.>. (lib!betree.OffsetMap_v.OffsetMap./OffsetMap/offsets (%Poly%lib!betree.OffsetMap_v.OffsetMap. offset_map!)))) (and (=> %%location_label%%1 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Key. $ NAT tmp%3 k!)) (=> (= tmp%2 (vstd!map.impl&%0.index.? $ TYPE%lib!spec.KeyType_t.Key. $ NAT (Poly%vstd!map.Map<lib!spec.KeyType_t.Key./nat.>. (lib!betree.OffsetMap_v.OffsetMap./OffsetMap/offsets (%Poly%lib!betree.OffsetMap_v.OffsetMap. offset_map!))) k!)) (=> (= tmp%4 (<= (%I tmp%2) (%I idx!))) %%switch_label%%0))))) (=> (not tmp%1) (=> (= tmp%4 false) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)

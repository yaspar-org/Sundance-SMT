...
(assert (<= 0 old_lsn!))
(assert (<= 0 new_lsn!))
(assert (=> ((_ is core!option.Option./Some) ojr!) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ojr!))) (I old_lsn!))))
(assert (=> ((_ is core!option.Option./Some) ojr!) (< new_lsn! (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. (lib!journal.PagedJournal_v.JournalRecord./JournalRecord/message_seq (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ojr!)))))))))))
(assert (<= old_lsn! new_lsn!))
(declare-const %%switch_label%%0 Bool)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (or (and (=> ((_ is core!option.Option./Some) ojr!) (=> (= tmp%1 (%Poly%lib!journal.PagedJournal_v.JournalRecord. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ojr!))))) (and (=> %%location_label%%0 (req%lib!journal.PagedJournal_v.impl&%0.new_boundary_valid. tmp%1 old_lsn! new_lsn!)) (=> (ens%lib!journal.PagedJournal_v.impl&%0.new_boundary_valid. tmp%1 old_lsn! new_lsn!) %%switch_label%%0)))) (=> (not ((_ is core!option.Option./Some) ojr!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%1 (=> ((_ is core!option.Option./Some) ojr!) (lib!journal.PagedJournal_v.impl&%0.valid.? (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ojr!))) (I new_lsn!))))))))
(check-sat)
(exit)

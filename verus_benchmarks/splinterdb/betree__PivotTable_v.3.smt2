...
(assert (not (=> (lib!betree.PivotTable_v.impl&%0.wf.? self!) (=> (= tmp%2 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (and (=> %%location_label%%0 (req%vstd!seq.impl&%0.spec_index. $ TYPE%lib!spec.KeyType_t.Element. tmp%2 (I 0))) (=> (= tmp%1 (vstd!seq.Seq.index.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!))) (I 0))) (or (and (=> (lib!spec.KeyType_t.impl&%2.lte.? tmp%1 (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? key!))) (=> (= tmp%4 (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!)))) (and (=> %%location_label%%1 (req%vstd!seq.Seq.last. $ TYPE%lib!spec.KeyType_t.Element. tmp%4)) (=> (= tmp%3 (vstd!seq.Seq.last.? $ TYPE%lib!spec.KeyType_t.Element. (Poly%vstd!seq.Seq<lib!spec.KeyType_t.Element.>. (lib!betree.PivotTable_v.PivotTable./PivotTable/pivots (%Poly%lib!betree.PivotTable_v.PivotTable. self!))))) (=> (= tmp%5 (lib!spec.KeyType_t.impl&%2.lt.? (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? key!)) tmp%3)) %%switch_label%%0))))) (=> (not (lib!spec.KeyType_t.impl&%2.lte.? tmp%1 (Poly%lib!spec.KeyType_t.Element. (lib!spec.KeyType_t.to_element.? key!)))) (=> (= tmp%5 false) %%switch_label%%0))) (not %%switch_label%%0))))))))
(check-sat)
(exit)

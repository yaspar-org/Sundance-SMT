...
(assert (has_type a! (TYPE%vstd!seq.Seq. A&. A&)))
(assert (has_type b! (TYPE%vstd!seq.Seq. A&. A&)))
...
(assert (not (and (=> (has_type x@ A&) (=> (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& a!) (vstd!seq_lib.impl&%0.to_set.? A&. A& b!)) x@) (=> (= tmp%1 (or (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& a!) x@) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& b!) x@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (or (and (=> (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& a!) x@) (=> (= tmp%2 (vstd!seq_lib.impl&%0.contains.? A&. A& a! x@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= i@ (vstd!seq_lib.impl&%0.index_of.? A&. A& a! x@)) (=> (= tmp%3 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!) (I i@)) x@)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%0)))))))) (=> (not (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& a!) x@)) (=> (= tmp%4 (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& b!) x@)) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (vstd!seq_lib.impl&%0.contains.? A&. A& b! x@)) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= i$1@ (vstd!seq_lib.impl&%0.index_of.? A&. A& b! x@)) (=> (= tmp%6 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!) (I (Add (vstd!seq.Seq.len.? A&. A& a!) i$1@))) x@)) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 %%switch_label%%0)))))))))))) (and (not %%switch_label%%0) (=> (= tmp%7 (vstd!seq_lib.impl&%0.contains.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!) x@)) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> %%location_label%%7 (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!)) x@)))))))))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ A&) (=> (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& a!) (vstd!seq_lib.impl&%0.to_set.? A&. A& b!)) x$) (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!)) x$))) :pattern ((vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!)) x$)) )) (=> (= tmp%8 (ext_eq false (TYPE%vstd!set.Set. A&. A&) (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!)) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& a!) (vstd!seq_lib.impl&%0.to_set.? A&. A& b!)))) (and (=> %%location_label%%8 tmp%8) (=> tmp%8 (=> %%location_label%%9 (= (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& a! b!)) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& a!) (vstd!seq_lib.impl&%0.to_set.? A&. A& b!)))))))))))
(check-sat)
(exit)

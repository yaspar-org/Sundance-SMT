...
(assert (not (=> (= decrease%init0 (%I depth!)) (or (and (=> (= (%I depth!) 0) (=> (= tmp%4 root!) %%switch_label%%0)) (=> (not (= (%I depth!) 0)) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!))) (=> (= tmp%3 (I (nClip (Sub (%I depth!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((self!$0 (%Poly%lib!journal.LinkedJournal_v.DiskView. self!)) (root!$1 (%Poly%core!option.Option. tmp%2)) (depth!$2 (%I tmp%3))) depth!$2) decrease%init0 false)) (=> (has_type (Poly%core!option.Option. tmp%1) (TYPE%core!option.Option. $ TYPE%lib!spec.AsyncDisk_t.Address.)) (=> (= tmp%1 (lib!journal.LinkedJournal_v.impl&%1.pointer_after_crop.? self! (Poly%core!option.Option. (lib!journal.LinkedJournal_v.impl&%1.next.? self! root!)) (I (nClip (Sub (%I depth!) 1))))) (=> (= tmp%4 (Poly%core!option.Option. tmp%1)) %%switch_label%%0)))))))) (not %%switch_label%%0)))))
(check-sat)
(exit)

...
(assert (forall ((T&. Dcr) (T& Type) (option! Poly)) (! (= (req%vstd!std_specs.option.spec_unwrap. T&. T& option!) (=> %%global_location_label%%3 ((_ is core!option.Option./Some) (%Poly%core!option.Option. option!)))) :pattern ((req%vstd!std_specs.option.spec_unwrap. T&. T& option!)) )))
...
(assert (forall ((T&. Dcr) (T& Type) (option! core!option.Option.)) (! (= (req%core!option.impl&%0.unwrap. T&. T& option!) (=> %%global_location_label%%4 ((_ is core!option.Option./Some) option!))) :pattern ((req%core!option.impl&%0.unwrap. T&. T& option!)) )))
...
(assert (%B (lib!marshalling.Marshalling_v.Marshal.parsable.? Self%&. Self%& self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!marshalling.Marshalling_v.Marshal.try_parse. Self%&. Self%& self! slice! data!)) (=> (ens%lib!marshalling.Marshalling_v.Marshal.try_parse. Self%&. Self%& self! slice! data! tmp%1) (and (=> %%location_label%%1 (req%core!option.impl&%0.unwrap. (proj%%lib!marshalling.Marshalling_v.Marshal./U Self%&. Self%&) (proj%lib!marshalling.Marshalling_v.Marshal./U Self%&. Self%&) (%Poly%core!option.Option. tmp%1))) (=> (ens%core!option.impl&%0.unwrap. (proj%%lib!marshalling.Marshalling_v.Marshal./U Self%&. Self%&) (proj%lib!marshalling.Marshalling_v.Marshal./U Self%&. Self%&) (%Poly%core!option.Option. tmp%1) tmp%2) (=> (= value! tmp%2) (=> %%location_label%%2 (= (lib!marshalling.Marshalling_v.Deepview.deepv.? (proj%%lib!marshalling.Marshalling_v.Marshal./U Self%&. Self%&) (proj%lib!marshalling.Marshalling_v.Marshal./U Self%&. Self%&) (proj%%lib!marshalling.Marshalling_v.Marshal./DV Self%&. Self%&) (proj%lib!marshalling.Marshalling_v.Marshal./DV Self%&. Self%&) value!) (lib!marshalling.Marshalling_v.Marshal.parse.? Self%&. Self%& self! (lib!marshalling.Slice_v.impl&%0.i.? $ (UINT 8) (vstd!view.View.view.? $ TYPE%lib!marshalling.Slice_v.Slice. slice!) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))))))))))
(check-sat)
(exit)

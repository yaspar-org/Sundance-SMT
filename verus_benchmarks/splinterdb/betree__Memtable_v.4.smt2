...
(declare-const tmp%2 lib!betree.Memtable_v.Memtable.)
...
(assert (not (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? puts!) (=> (lib!abstract_system.MsgHistory_v.impl&%0.can_follow.? puts! (I (lib!betree.Memtable_v.Memtable./Memtable/seq_end (%Poly%lib!betree.Memtable_v.Memtable. self!)))) (=> (lib!abstract_system.MsgHistory_v.impl&%0.wf.? puts!) (or (and (=> (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? puts!) (=> (= tmp%5 self!) %%switch_label%%0)) (=> (not (lib!abstract_system.MsgHistory_v.impl&%0.is_empty.? puts!)) (=> (= last_lsn@ (nClip (Sub (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/seq_end (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!)) 1))) (and (=> %%location_label%%0 (req%lib!abstract_system.MsgHistory_v.impl&%0.discard_recent. puts! (I last_lsn@))) (=> (= tmp%1 (lib!abstract_system.MsgHistory_v.impl&%0.discard_recent.? puts! (I last_lsn@))) (and (=> %%location_label%%1 (req%lib!betree.Memtable_v.impl&%0.apply_puts. T&. T& self! (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. tmp%1))) (=> (= tmp%2 (lib!betree.Memtable_v.impl&%0.apply_puts.? T&. T& self! (Poly%lib!abstract_system.MsgHistory_v.MsgHistory. tmp%1))) (=> (= tmp%4 (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!)))) (and (=> %%location_label%%2 (req%vstd!map.impl&%0.spec_index. $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. tmp%4 (I last_lsn@))) (=> (= tmp%3 (vstd!map.impl&%0.index.? $ NAT $ TYPE%lib!abstract_system.MsgHistory_v.KeyedMessage. (Poly%vstd!map.Map<nat./lib!abstract_system.MsgHistory_v.KeyedMessage.>. (lib!abstract_system.MsgHistory_v.MsgHistory./MsgHistory/msgs (%Poly%lib!abstract_system.MsgHistory_v.MsgHistory. puts!))) (I last_lsn@))) (=> (= tmp%5 (Poly%lib!betree.Memtable_v.Memtable. (lib!betree.Memtable_v.impl&%0.apply_put.? T&. T& (Poly%lib!betree.Memtable_v.Memtable. tmp%2) tmp%3))) %%switch_label%%0))))))))))) (not %%switch_label%%0)))))))
(check-sat)
(exit)

...
(assert (not (=> (= decrease%init0 (%I depth!)) (=> (= decrease%init1 0) (or (and (=> (lib!journal.PagedJournal_v.impl&%0.valid.? self! boundary_lsn!) (or (and (=> (= (%I depth!) 0) (=> (= tmp%4 true) %%switch_label%%1)) (=> (not (= (%I depth!) 0)) (=> (= tmp%2 (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.cropped_prior.? self! boundary_lsn!))) (=> (= tmp%3 (I (nClip (Sub (%I depth!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((ojr!$0 (%Poly%core!option.Option. tmp%2)) (boundary_lsn!$1 (%I boundary_lsn!)) (depth!$2 (%I tmp%3))) depth!$2) decrease%init0 (check_decrease_int (let ((ojr!$0 (%Poly%core!option.Option. tmp%2)) (boundary_lsn!$1 (%I boundary_lsn!)) (depth!$2 (%I tmp%3))) 1) decrease%init1 false))) (=> (= tmp%1 (lib!journal.PagedJournal_v.impl&%0.opt_rec_can_crop_head_records.? (Poly%core!option.Option. (lib!journal.PagedJournal_v.impl&%0.cropped_prior.? self! boundary_lsn!)) boundary_lsn! (I (nClip (Sub (%I depth!) 1))))) (=> (= tmp%4 tmp%1) %%switch_label%%1))))))) (and (not %%switch_label%%1) (=> (= tmp%5 tmp%4) %%switch_label%%0)))) (=> (not (lib!journal.PagedJournal_v.impl&%0.valid.? self! boundary_lsn!)) (=> (= tmp%5 false) %%switch_label%%0))) (not %%switch_label%%0))))))
(check-sat)
(exit)

...
(assert (has_type t! (TYPE%vstd!seq.Seq. A&. A&)))
(declare-fun %%choose%%4 (Type Int Int Dcr Type Poly Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((si$1 Poly)) (! (and (has_type si$1 %%hole%%0) (and (and (<= %%hole%%1 (%I si$1)) (< (%I si$1) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 si$1) %%hole%%6))) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 si$1)) )) (exists ((si$1 Poly)) (! (and (and (has_type si$1 %%hole%%0) (and (and (<= %%hole%%1 (%I si$1)) (< (%I si$1) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 si$1) %%hole%%6))) (= (%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) si$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 si$1))))) :pattern ((%%choose%%4 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
...
(assert (not (=> (= left@ (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& s! t!))) (=> (= right@ (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) (vstd!seq_lib.impl&%0.to_set.? A&. A& t!))) (and (=> (has_type x@ A&) (=> (vstd!set.impl&%0.contains.? A&. A& right@ x@) (=> (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. A&. A&) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) (vstd!seq_lib.impl&%0.to_set.? A&. A& t!)) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) (vstd!seq_lib.impl&%0.to_set.? A&. A& t!)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (or (and (=> (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) x@) (=> (= si@ (%I (as_type (%%choose%%4 INT 0 (vstd!seq.Seq.len.? A&. A& s!) A&. A& s! x@ A&. A& s!) INT))) (=> (= tmp%2 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s! t!) (I si@)) x@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%0))))) (=> (not (vstd!set.impl&%0.contains.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) x@)) (=> (= ti@ (%I (as_type (%%choose%%4 INT 0 (vstd!seq.Seq.len.? A&. A& t!) A&. A& t! x@ A&. A& t!) INT))) (=> (= tmp%3 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s! t!) (I (Add (vstd!seq.Seq.len.? A&. A& s!) ti@))) x@)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%0)))))) (and (not %%switch_label%%0) (=> %%location_label%%3 (vstd!set.impl&%0.contains.? A&. A& left@ x@))))))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ A&) (=> (vstd!set.impl&%0.contains.? A&. A& right@ x$) (vstd!set.impl&%0.contains.? A&. A& left@ x$))) :pattern ((vstd!set.impl&%0.contains.? A&. A& right@ x$)) :pattern ((vstd!set.impl&%0.contains.? A&. A& left@ x$)) )) (=> (= s1@ left@) (=> (= s2@ right@) (and (and (=> (has_type elem@ A&) (=> %%location_label%%4 (and (=> (vstd!set.impl&%0.contains.? A&. A& s1@ elem@) (vstd!set.impl&%0.contains.? A&. A& s2@ elem@)) (=> (vstd!set.impl&%0.contains.? A&. A& s2@ elem@) (vstd!set.impl&%0.contains.? A&. A& s1@ elem@))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ A&) (and (=> (vstd!set.impl&%0.contains.? A&. A& s1@ elem$) (vstd!set.impl&%0.contains.? A&. A& s2@ elem$)) (=> (vstd!set.impl&%0.contains.? A&. A& s2@ elem$) (vstd!set.impl&%0.contains.? A&. A& s1@ elem$)))) :pattern ((vstd!set.impl&%0.contains.? A&. A& s1@ elem$)) :pattern ((vstd!set.impl&%0.contains.? A&. A& s2@ elem$)) )) (=> (= tmp%4 (ext_eq false (TYPE%vstd!set.Set. A&. A&) s1@ s2@)) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (=> %%location_label%%6 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> %%location_label%%7 (= (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.add.? A&. A& s! t!)) (vstd!set.impl&%0.union.? A&. A& (vstd!seq_lib.impl&%0.to_set.? A&. A& s!) (vstd!seq_lib.impl&%0.to_set.? A&. A& t!))))))))))))))
(check-sat)
(exit)

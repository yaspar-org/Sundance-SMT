...
(assert (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite. fuel%vstd!map.axiom_map_index_decreases_infinite. fuel%vstd!map.axiom_map_empty. fuel%vstd!map.axiom_map_insert_domain. fuel%vstd!map.axiom_map_insert_same. fuel%vstd!map.axiom_map_insert_different. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!map_lib.impl&%0.contains_key. fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_new_len. fuel%vstd!seq.axiom_seq_new_index. fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq_lib.impl&%0.map_values. fuel%vstd!seq_lib.impl&%0.contains. fuel%vstd!seq_lib.impl&%0.to_set. fuel%vstd!seq_lib.seq_to_set_is_finite. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view. fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%24.view. fuel%lib!endpoint_hashmap_t.impl&%0.spec_index. fuel%lib!endpoint_hashmap_t.impl&%0.get_spec. fuel%lib!endpoint_hashmap_t.impl&%0.put_spec. fuel%lib!endpoint_hashmap_t.impl&%0.swap_spec. fuel%lib!io_t.impl&%4.view. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms. fuel%vstd!multiset.group_multiset_axioms. fuel%vstd!raw_ptr.group_raw_ptr_axioms. fuel%vstd!seq.group_seq_axioms. fuel%vstd!seq_lib.group_seq_lib_default. fuel%vstd!set.group_set_axioms. fuel%vstd!set_lib.group_set_lib_axioms. fuel%vstd!slice.group_slice_axioms. fuel%vstd!string.group_string_axioms. fuel%vstd!std_specs.bits.group_bits_axioms. fuel%vstd!std_specs.control_flow.group_control_flow_axioms. fuel%vstd!std_specs.range.group_range_axioms. fuel%vstd!std_specs.vec.group_vec_axioms. fuel%vstd!group_vstd_default.))
...
(assert (forall ((V&. Dcr) (V& Type) (self! Poly) (key! Poly)) (! (= (req%lib!endpoint_hashmap_t.impl&%0.spec_index. V&. V& self! key!) (=> %%global_location_label%%4 (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. V&. V& (lib!endpoint_hashmap_t.impl&%0.view.? V&. V& self!)) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? key!))))) :pattern ((req%lib!endpoint_hashmap_t.impl&%0.spec_index. V&. V& self! key!)) )))
...
(declare-const key! lib!io_t.EndPoint.)
(declare-const value! Poly)
(assert fuel_defaults)
(assert (has_type self!@0 (TYPE%lib!endpoint_hashmap_t.HashMap. V&. V&)))
(assert (has_type value! V&))
(declare-const self!@1 Poly)
(declare-const %%location_label%%0 Bool)
(assert (not (=> (has_type self!@1 (TYPE%lib!endpoint_hashmap_t.HashMap. V&. V&)) (=> (ens%lib!endpoint_hashmap_t.impl&%0.insert. V&. V& self!@0 self!@1 key! value!) (=> %%location_label%%0 (lib!endpoint_hashmap_t.impl&%0.put_spec.? V&. V& (lib!endpoint_hashmap_t.impl&%0.view.? V&. V& self!@0) (lib!endpoint_hashmap_t.impl&%0.view.? V&. V& self!@1) (Poly%lib!abstract_end_point_t.AbstractEndPoint. (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. key!))) value!))))))
(check-sat)
(exit)

...
(declare-fun req%lib!io_t.impl&%7.reset. (lib!io_t.NetClient.) Bool)
(declare-const %%global_location_label%%5 Bool)
(assert (forall ((pre%self! lib!io_t.NetClient.)) (! (= (req%lib!io_t.impl&%7.reset. pre%self!) (=> %%global_location_label%%5 (lib!io_t.from_trusted_code.? (I 0)))) :pattern ((req%lib!io_t.impl&%7.reset. pre%self!)) )))
(declare-fun ens%lib!io_t.impl&%7.reset. (lib!io_t.NetClient. lib!io_t.NetClient.) Bool)
(assert (forall ((pre%self! lib!io_t.NetClient.) (self! lib!io_t.NetClient.)) (! (= (ens%lib!io_t.impl&%7.reset. pre%self! self!) (and ((_ is lib!io_t.State./Receiving) (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. self!))) (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. self!)) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. pre%self!))))) :pattern ((ens%lib!io_t.impl&%7.reset. pre%self! self!)) )))
(declare-const self!@0 lib!io_t.NetClient.)
(declare-const tmp%1 lib!io_t.State.)
(assert fuel_defaults)
(assert (lib!io_t.from_trusted_code.? (I 0)))
(declare-const self!@1 lib!io_t.NetClient.)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%1 lib!io_t.State./Receiving) (=> (= (lib!io_t.NetClient./NetClient/state (%Poly%lib!io_t.NetClient. (Poly%lib!io_t.NetClient. self!@1))) tmp%1) (=> (and (= (lib!io_t.NetClient./NetClient/history self!@0) (lib!io_t.NetClient./NetClient/history self!@1)) (= (lib!io_t.NetClient./NetClient/end_point self!@0) (lib!io_t.NetClient./NetClient/end_point self!@1)) (= (lib!io_t.NetClient./NetClient/c_pointers self!@0) (lib!io_t.NetClient./NetClient/c_pointers self!@1)) (= (lib!io_t.NetClient./NetClient/profiler self!@0) (lib!io_t.NetClient./NetClient/profiler self!@1))) (and (=> %%location_label%%0 ((_ is lib!io_t.State./Receiving) (lib!io_t.impl&%7.state.? (Poly%lib!io_t.NetClient. self!@1)))) (=> %%location_label%%1 (= (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. self!@1)) (lib!io_t.impl&%7.my_end_point.? (Poly%lib!io_t.NetClient. self!@0))))))))))
(check-sat)
(exit)

...
(declare-const s1! vstd!set.Set<nat.>.)
(declare-const s2! vstd!set.Set<nat.>.)
...
(declare-const tmp%6 vstd!set.Set<nat.>.)
(declare-const elt$1@ Int)
(declare-const s1_smaller@ vstd!set.Set<nat.>.)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (<= 0 missing!))
(assert (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. s1!)))
(assert (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. s2!)))
(assert (= (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. s1!)) (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. s2!))))
(assert (forall ((elt$ Poly)) (! (=> (has_type elt$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s2!) elt$) (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s1!) elt$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s2!) elt$)) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s1!) elt$)) )))
(assert (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s1!) (I missing!)))
(assert (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s2!) (I missing!))))
...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. s1!))) (or (and (=> (= (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. s1!)) 1) (=> (= elt@ (%I (vstd!set.impl&%0.choose.? $ NAT (Poly%vstd!set.Set<nat.>. s2!)))) (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s2!) (I elt@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s1!) (I elt@))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (and (=> %%location_label%%2 (req%lib!pigeonhole.singleton_set_unique_elt. $ NAT (Poly%vstd!set.Set<nat.>. s1!) (I elt@) (I missing!))) (=> (ens%lib!pigeonhole.singleton_set_unique_elt. $ NAT (Poly%vstd!set.Set<nat.>. s1!) (I elt@) (I missing!)) (=> (= tmp%3 (= elt@ missing!)) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> %%location_label%%4 false)))))))))))))) (=> (not (= (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. s1!)) 1)) (=> (= elt$1@ (%I (vstd!set.impl&%0.choose.? $ NAT (Poly%vstd!set.Set<nat.>. s2!)))) (=> (= tmp%4 (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s2!) (I elt$1@))) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (=> (= tmp%5 (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. s1!) (I elt$1@))) (and (=> %%location_label%%6 tmp%5) (=> tmp%5 (=> (= s1_smaller@ (%Poly%vstd!set.Set<nat.>. (vstd!set.impl&%0.remove.? $ NAT (Poly%vstd!set.Set<nat.>. s1!) (I elt$1@)))) (=> (= tmp%6 (%Poly%vstd!set.Set<nat.>. (vstd!set.impl&%0.remove.? $ NAT (Poly%vstd!set.Set<nat.>. s2!) (I elt$1@)))) (and (=> %%location_label%%7 (check_decrease_int (let ((s1!$0 s1_smaller@) (s2!$1 tmp%6) (missing!$2 missing!)) (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. s1!$0))) decrease%init0 false)) (and (=> %%location_label%%8 (req%lib!pigeonhole.set_mismatch. s1_smaller@ tmp%6 missing!)) (=> (ens%lib!pigeonhole.set_mismatch. s1_smaller@ tmp%6 missing!) %%switch_label%%0)))))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%9 false))))))
(check-sat)
(exit)

...
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%7.queued_ops.) (forall ((self! Poly)) (! (= (lib!spec.unbounded_log.impl&%7.queued_ops.? self!) (ite ((_ is lib!spec.unbounded_log.CombinerState./Ready) (%Poly%lib!spec.unbounded_log.CombinerState. self!)) (%Poly%vstd!seq.Seq<nat.>. (vstd!seq.Seq.empty.? $ NAT)) (ite ((_ is lib!spec.unbounded_log.CombinerState./Placed) (%Poly%lib!spec.unbounded_log.CombinerState. self!)) (let ((queued_ops$ (lib!spec.unbounded_log.CombinerState./Placed/queued_ops (%Poly%lib!spec.unbounded_log.CombinerState. self!)))) queued_ops$) (ite ((_ is lib!spec.unbounded_log.CombinerState./LoadedLocalVersion) (%Poly%lib!spec.unbounded_log.CombinerState. self!)) (let ((queued_ops$ (lib!spec.unbounded_log.CombinerState./LoadedLocalVersion/queued_ops (%Poly%lib!spec.unbounded_log.CombinerState. self!)))) queued_ops$) (ite ((_ is lib!spec.unbounded_log.CombinerState./Loop) (%Poly%lib!spec.unbounded_log.CombinerState. self!)) (let ((queued_ops$ (lib!spec.unbounded_log.CombinerState./Loop/queued_ops (%Poly%lib!spec.unbounded_log.CombinerState. self!)))) queued_ops$) (let ((queued_ops$ (lib!spec.unbounded_log.CombinerState./UpdatedVersion/queued_ops (%Poly%lib!spec.unbounded_log.CombinerState. self!)))) queued_ops$)))))) :pattern ((lib!spec.unbounded_log.impl&%7.queued_ops.? self!)) ))))
...
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%5.is_Ready.) (forall ((self! Poly)) (! (= (lib!spec.unbounded_log.impl&%5.is_Ready.? self!) ((_ is lib!spec.unbounded_log.CombinerState./Ready) (%Poly%lib!spec.unbounded_log.CombinerState. self!))) :pattern ((lib!spec.unbounded_log.impl&%5.is_Ready.? self!)) ))))
(assert (fuel_bool_default fuel%lib!spec.unbounded_log.impl&%5.is_Placed.))
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%5.is_Placed.) (forall ((self! Poly)) (! (= (lib!spec.unbounded_log.impl&%5.is_Placed.? self!) ((_ is lib!spec.unbounded_log.CombinerState./Placed) (%Poly%lib!spec.unbounded_log.CombinerState. self!))) :pattern ((lib!spec.unbounded_log.impl&%5.is_Placed.? self!)) ))))
...
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%0.is_VersionUpperBound.) (forall ((DT&. Dcr) (DT& Type) (self! Poly)) (! (= (lib!spec.unbounded_log.impl&%0.is_VersionUpperBound.? DT&. DT& self!) ((_ is lib!spec.unbounded_log.ReadonlyState./VersionUpperBound) (%Poly%lib!spec.unbounded_log.ReadonlyState. self!))) :pattern ((lib!spec.unbounded_log.impl&%0.is_VersionUpperBound.? DT&. DT& self!)) ))))
...
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%0.is_ReadyToRead.) (forall ((DT&. Dcr) (DT& Type) (self! Poly)) (! (= (lib!spec.unbounded_log.impl&%0.is_ReadyToRead.? DT&. DT& self!) ((_ is lib!spec.unbounded_log.ReadonlyState./ReadyToRead) (%Poly%lib!spec.unbounded_log.ReadonlyState. self!))) :pattern ((lib!spec.unbounded_log.impl&%0.is_ReadyToRead.? DT&. DT& self!)) ))))
...
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%2.op.) (forall ((DT&. Dcr) (DT& Type) (self! Poly)) (! (= (lib!spec.unbounded_log.impl&%2.op.? DT&. DT& self!) (ite ((_ is lib!spec.unbounded_log.ReadonlyState./Init) (%Poly%lib!spec.unbounded_log.ReadonlyState. self!)) (let ((op$ (lib!spec.unbounded_log.ReadonlyState./Init/op (%Poly%lib!spec.unbounded_log.ReadonlyState. self!)))) op$) (ite ((_ is lib!spec.unbounded_log.ReadonlyState./VersionUpperBound) (%Poly%lib!spec.unbounded_log.ReadonlyState. self!)) (let ((op$ (lib!spec.unbounded_log.ReadonlyState./VersionUpperBound/op (%Poly%lib!spec.unbounded_log.ReadonlyState. self!)))) op$) (ite ((_ is lib!spec.unbounded_log.ReadonlyState./ReadyToRead) (%Poly%lib!spec.unbounded_log.ReadonlyState. self!)) (let ((op$ (lib!spec.unbounded_log.ReadonlyState./ReadyToRead/op (%Poly%lib!spec.unbounded_log.ReadonlyState. self!)))) op$) (let ((op$ (lib!spec.unbounded_log.ReadonlyState./Done/op (%Poly%lib!spec.unbounded_log.ReadonlyState. self!)))) op$))))) :pattern ((lib!spec.unbounded_log.impl&%2.op.? DT&. DT& self!)) ))))
...
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%5.is_LoadedLocalVersion.) (forall ((self! Poly)) (! (= (lib!spec.unbounded_log.impl&%5.is_LoadedLocalVersion.? self!) ((_ is lib!spec.unbounded_log.CombinerState./LoadedLocalVersion) (%Poly%lib!spec.unbounded_log.CombinerState. self!))) :pattern ((lib!spec.unbounded_log.impl&%5.is_LoadedLocalVersion.? self!)) ))))
...
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%5.is_Loop.) (forall ((self! Poly)) (! (= (lib!spec.unbounded_log.impl&%5.is_Loop.? self!) ((_ is lib!spec.unbounded_log.CombinerState./Loop) (%Poly%lib!spec.unbounded_log.CombinerState. self!))) :pattern ((lib!spec.unbounded_log.impl&%5.is_Loop.? self!)) ))))
...
(assert (=> (fuel_bool fuel%lib!spec.unbounded_log.impl&%5.is_UpdatedVersion.) (forall ((self! Poly)) (! (= (lib!spec.unbounded_log.impl&%5.is_UpdatedVersion.? self!) ((_ is lib!spec.unbounded_log.CombinerState./UpdatedVersion) (%Poly%lib!spec.unbounded_log.CombinerState. self!))) :pattern ((lib!spec.unbounded_log.impl&%5.is_UpdatedVersion.? self!)) ))))
...
(assert (lib!spec.unbounded_log.LogRangeNoNodeId.? DT&. DT& log! (I logIndexLower!) (I logIndexUpper!) (I node_id!)))
...
(assert (not (=> (= decrease%init0 (Sub logIndexUpper! logIndexLower!)) (or (and (=> (= logIndexLower! (nClip (Add logIndexUpper! 1))) %%switch_label%%0) (=> (not (= logIndexLower! (nClip (Add logIndexUpper! 1)))) (or (and (=> (= logIndexLower! logIndexUpper!) (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log!) (I logIndexLower!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (lib!spec.unbounded_log.LogRangeNoNodeId.? DT&. DT& new_log! (I (nClip (Add logIndexLower! 1))) (I (nClip (Add logIndexUpper! 1))) (I node_id!))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%1)))))))))) (=> (not (= logIndexLower! logIndexUpper!)) (=> (= tmp%4 (= (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)) (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) log! (I logIndexLower!)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (or (and (=> (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!) (=> (= tmp%5 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%4 (check_decrease_int (let ((log!$0 log!) (new_log!$1 new_log!) (logIndexLower!$2 tmp%5) (logIndexUpper!$3 logIndexUpper!) (node_id!$4 node_id!) (log_entry!$5 log_entry!)) (Sub logIndexUpper!$3 logIndexLower!$2)) decrease%init0 false)) (and (=> %%location_label%%5 (req%lib!spec.unbounded_log.LogRangeNoNodeId_append_other. DT&. DT& log! new_log! tmp%5 logIndexUpper! node_id! log_entry!)) (=> (ens%lib!spec.unbounded_log.LogRangeNoNodeId_append_other. DT&. DT& log! new_log! tmp%5 logIndexUpper! node_id! log_entry!) (=> (= tmp%6 (lib!spec.unbounded_log.LogRangeNoNodeId.? DT&. DT& new_log! (I logIndexLower!) (I (nClip (Add logIndexUpper! 1))) (I node_id!))) (and (=> %%location_label%%6 tmp%6) (=> tmp%6 %%switch_label%%2)))))))) (=> (not (= (lib!spec.types.LogEntry./LogEntry/node_id (%Poly%lib!spec.types.LogEntry. (vstd!map.impl&%0.index.? $ NAT $ (TYPE%lib!spec.types.LogEntry. DT&. DT&) new_log! (I logIndexLower!)))) node_id!)) (=> (= tmp%7 (nClip (Add logIndexLower! 1))) (and (=> %%location_label%%7 (check_decrease_int (let ((log!$0 log!) (new_log!$1 new_log!) (logIndexLower!$2 tmp%7) (logIndexUpper!$3 logIndexUpper!) (node_id!$4 node_id!) (log_entry!$5 log_entry!)) (Sub logIndexUpper!$3 logIndexLower!$2)) decrease%init0 false)) (and (=> %%location_label%%8 (req%lib!spec.unbounded_log.LogRangeNoNodeId_append_other. DT&. DT& log! new_log! tmp%7 logIndexUpper! node_id! log_entry!)) (=> (ens%lib!spec.unbounded_log.LogRangeNoNodeId_append_other. DT&. DT& log! new_log! tmp%7 logIndexUpper! node_id! log_entry!) %%switch_label%%2)))))) (and (not %%switch_label%%2) %%switch_label%%1))))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%9 (lib!spec.unbounded_log.LogRangeNoNodeId.? DT&. DT& new_log! (I logIndexLower!) (I (nClip (Add logIndexUpper! 1))) (I node_id!))))))))
(check-sat)
(exit)

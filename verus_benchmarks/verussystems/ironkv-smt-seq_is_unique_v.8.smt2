...
(assert (not (or (and (=> ((_ is core!option.Option./Some) ov!) (=> (= e1@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ov!))))) (=> (ens%lib!args_t.clone_vec_u8. e1@ tmp%1) (=> (= tmp%2 (core!option.Option./Some (Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1))) %%switch_label%%0)))) (=> (not ((_ is core!option.Option./Some) ov!)) (=> (= tmp%2 core!option.Option./None) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (= res! tmp%2) (=> %%location_label%%0 (ite ((_ is core!option.Option./Some) ov!) (let ((e1$ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ov!)))))) (and ((_ is core!option.Option./Some) res!) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. e1$)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. res!))))))) ((_ is core!option.Option./None) res!))))))))
(check-sat)
(exit)

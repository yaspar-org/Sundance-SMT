...
(assert (not (=> (= tmp%2 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!)))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. tmp%2)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ TYPE%lib!keys_t.SHTKey. tmp%2 tmp%1) (and (=> %%location_label%%1 (uInv SZ (Add 0 (%I tmp%1)))) (=> (= tmp%4 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!)))) (and (=> %%location_label%%2 (req%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%4)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%4 tmp%3) (and (=> %%location_label%%3 (uInv SZ (Add (uClip SZ (Add 0 (%I tmp%1))) (%I tmp%3)))) (=> (= %return! (I (uClip SZ (Add (uClip SZ (Add 0 (%I tmp%1))) (%I tmp%3))))) (=> %%location_label%%4 (= (%I %return!) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!hashmap_t.CKeyKV. self!)))))))))))))))
(check-sat)
(exit)

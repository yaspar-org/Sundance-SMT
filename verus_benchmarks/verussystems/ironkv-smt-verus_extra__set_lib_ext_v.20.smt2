...
(assert (not (and (=> (has_type x@ A&) (=> (= tmp%1 (= (vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) x@) (I 0)) x@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (ext_eq false (TYPE%vstd!set.Set. A&. A&) (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) x@)) (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x@))))))) (=> (forall ((x$ Poly)) (! (=> (has_type x$ A&) (ext_eq false (TYPE%vstd!set.Set. A&. A&) (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) x$)) (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x$))) :pattern ((vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) x$))) )) (=> %%location_label%%2 (forall ((x$ Poly)) (! (=> (has_type x$ A&) (= (vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) x$)) (vstd!set.impl&%0.insert.? A&. A& (vstd!set.impl&%0.empty.? A&. A&) x$))) :pattern ((vstd!seq_lib.impl&%0.to_set.? A&. A& (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) x$))) )))))))
(check-sat)
(exit)

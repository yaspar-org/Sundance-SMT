...
(assert (not (=> (= res@0 true) (=> (= i@0 0) (=> (ens%alloc!vec.impl&%1.len. T&. T& $ ALLOCATOR_GLOBAL self! tmp%1) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT SZ) (I tmp%1))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT SZ) (I tmp%1) tmp%2) (=> (= total_len@0 (%I tmp%2)) (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (and (=> %%location_label%%1 tmp%3) (=> tmp%3 (and (=> %%location_label%%2 (and (<= 0 i@0) (<= i@0 (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL self!)))) (and (=> %%location_label%%3 (=> res@0 (= total_len@0 (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@0)) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))))))))) (and (=> %%location_label%%4 (=> res@0 (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@0)) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) )))) (and (=> %%location_label%%5 (=> res@0 (<= total_len@0 (- (uHi SZ) 1)))) (and (=> %%location_label%%6 (=> (not res@0) (not (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!))))) (=> (uInv SZ i@1) (=> (uInv SZ total_len@1) (=> (and (<= 0 i@1) (<= i@1 (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL self!))) (=> (=> res@1 (= total_len@1 (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))))) (=> (=> res@1 (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (I i@1)) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) ))) (=> (=> res@1 (<= total_len@1 (- (uHi SZ) 1))) (=> (=> (not res@1) (not (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (or (and (=> res@1 (=> (ens%alloc!vec.impl&%1.len. T&. T& $ ALLOCATOR_GLOBAL self! tmp%4) (=> (= tmp%5 (< i@1 tmp%4)) %%switch_label%%0))) (=> (not res@1) (=> (= tmp%5 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> (not tmp%5) (=> (= %return! (B res@1)) (=> %%location_label%%7 (= %return! (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!))))))))))))))))))))))))))))))
(check-sat)
(exit)

...
(declare-const suml@ %%Function%%)
(declare-const tmp%%$2@ tuple%2.)
(declare-const x$2@ Poly)
(declare-const end1@ Int)
(declare-const old_end@ Int)
(declare-const old_res@ Poly)
(declare-const tmp%11 vstd!seq.Seq<u8.>.)
(declare-const tmp%%@ tuple%2.)
(declare-const len@ Int)
(declare-const mid@ Int)
(declare-const len$1@ Int)
(declare-const res@0 Poly)
...
(assert (has_type tmp%1 (TYPE%core!option.Option. $ (TYPE%tuple%2. $ (UINT SZ) $ (UINT SZ)))))
(assert (has_type (Poly%core!option.Option. tmp%%$1@) (TYPE%core!option.Option. $ (TYPE%tuple%2. $ (UINT SZ) $ (UINT SZ)))))
(assert (has_type (Poly%tuple%2. tmp%%@) (TYPE%tuple%2. $ (UINT SZ) $ (UINT SZ))))
(assert (uInv SZ len@))
(assert (uInv SZ mid@))
(assert (uInv SZ len$1@))
(assert (has_type res@0 (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL)))
(assert (uInv SZ i@0))
(assert (uInv SZ end@0))
(assert (has_type (Poly%fun%2. accf@) (TYPE%fun%2. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)))))
(declare-fun %%lambda%%11 (Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (x$3 Poly)) (! (= (%%apply%%0 (%%lambda%%11 %%hole%%0 %%hole%%1) x$3) (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$3)) :pattern ((%%apply%%0 (%%lambda%%11 %%hole%%0 %%hole%%1) x$3)))))
(declare-fun %%lambda%%12 (Dcr Type Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (x$7 Poly)) (! (= (%%apply%%0 (%%lambda%%12 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) x$7) (I (vstd!seq.Seq.len.? %%hole%%2 %%hole%%3 (lib!marshal_v.Marshalable.ghost_serialize.? %%hole%%0 %%hole%%1 x$7)))) :pattern ((%%apply%%0 (%%lambda%%12 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) x$7)))))
(declare-const res@1 Poly)
...
(assert (not (=> (and (<= 0 i@0) (<= i@0 len$1@)) (=> (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0)) (=> (and (and (<= (%I start!) mid@) (<= mid@ end@0)) (<= end@0 (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))) (=> (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) (I mid@) (I end@0)) (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0) (Poly%vstd!seq.Seq<u8.>. emp@) (Poly%fun%2. accf@))) (=> (= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0)) i@0) (=> (= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I len$1@))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (Sub end@0 (%I start!))) (=> (= accf@ (mk_fun (%%lambda%%1 T&. T& $ (UINT 8)))) (=> (< i@0 len$1@) (=> (ens%lib!marshal_v.Marshalable.deserialize. T&. T& data! (I end@0) tmp%3) (=> (= tmp%%$3@ (%Poly%core!option.Option. tmp%3)) (or (and (=> ((_ is core!option.Option./None) tmp%%$3@) (=> (= %return! (Poly%core!option.Option. core!option.Option./None)) (=> %%location_label%%0 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!)))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) x$$0)) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) x$$0))))))))) (=> (not ((_ is core!option.Option./None) tmp%%$3@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= tmp%%$2@ (let ((x$ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%$3@)))))) x$)) (=> (= x$2@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$2@)))) (=> (= end1@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$2@))))) (=> (= old_end@ end@0) (=> (= old_res@ (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0)) (=> (has_type res@1 (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL)) (=> (ens%alloc!vec.impl&%1.push. T&. T& $ ALLOCATOR_GLOBAL res@0 res@1 x$2@) (=> (= end@1 end1@) (and (=> %%location_label%%1 (uInv SZ (Add i@0 1))) (=> (= i@1 (uClip SZ (Add i@0 1))) (and (=> (= f@ (mk_fun (%%lambda%%11 T&. T&))) (=> (= tmp%4 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))) (and (=> %%location_label%%2 (req%lib!verus_extra.seq_lib_v.lemma_seq_add_subrange. $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. tmp%4) mid@ old_end@ end@1)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_add_subrange. $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. tmp%4) mid@ old_end@ end@1) (=> (= tmp%5 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)) (and (=> %%location_label%%3 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_right. T&. T& $ (UINT 8) tmp%5 (Poly%vstd!seq.Seq<u8.>. emp@) f@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_right. T&. T& $ (UINT 8) tmp%5 (Poly%vstd!seq.Seq<u8.>. emp@) f@) (and (=> (= tmp%6 (mk_fun (%%lambda%%6 f@ $ (UINT 8)))) (and (=> %%location_label%%4 (req%vstd!function.fun_ext_2. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) accf@ tmp%6)) (=> (ens%vstd!function.fun_ext_2. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) accf@ tmp%6) (=> %%location_label%%5 (= accf@ (mk_fun (%%lambda%%6 f@ $ (UINT 8)))))))) (=> (= accf@ (mk_fun (%%lambda%%6 f@ $ (UINT 8)))) (=> (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) old_res@ (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (I 0) (I (Sub (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)) 1))))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> %%location_label%%7 (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) (I mid@) (I end@1)) (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (Poly%vstd!seq.Seq<u8.>. emp@) (Poly%fun%2. accf@)))))))))))))))) (=> (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) (I mid@) (I end@1)) (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (Poly%vstd!seq.Seq<u8.>. emp@) (Poly%fun%2. accf@))) (and (=> (= l@ (mk_fun (%%lambda%%12 T&. T& $ (UINT 8)))) (=> (= suml@ (mk_fun (%%lambda%%2 l@))) (=> (= tmp%8 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)) (and (=> %%location_label%%8 (req%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& tmp%8 0 l@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_sum_right. T&. T& tmp%8 0 l@) (=> (= tmp%9 (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (and (=> %%location_label%%9 (req%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%9 suml@)) (=> (ens%vstd!function.fun_ext_2. $ INT T&. T& $ INT tmp%9 suml@) (=> (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) old_res@ (vstd!seq.Seq.subrange.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (I 0) (I (Sub (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)) 1))))) (and (=> %%location_label%%10 tmp%10) (=> tmp%10 (=> %%location_label%%11 (= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I len$1@))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (Sub end@1 (%I start!))))))))))))))) (=> (= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I len$1@))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (Sub end@1 (%I start!))) (and (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> %%location_label%%12 (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I len$1@))) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1))))))))) (=> (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I len$1@))) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1))))))) (and (=> %%location_label%%13 (and (<= 0 i@1) (<= i@1 len$1@))) (and (=> %%location_label%%14 (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1))) (and (=> %%location_label%%15 (and (and (<= (%I start!) mid@) (<= mid@ end@1)) (<= end@1 (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))) (and (=> %%location_label%%16 (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) (I mid@) (I end@1)) (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (Poly%vstd!seq.Seq<u8.>. emp@) (Poly%fun%2. accf@)))) (and (=> %%location_label%%17 (= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)) i@1)) (and (=> %%location_label%%18 (= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I len$1@))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (Sub end@1 (%I start!)))) (=> %%location_label%%19 (= accf@ (mk_fun (%%lambda%%1 T&. T& $ (UINT 8)))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)

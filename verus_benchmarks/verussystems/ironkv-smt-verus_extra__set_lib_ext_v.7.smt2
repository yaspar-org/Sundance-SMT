...
(assert (not (and (=> (has_type s1@ (TYPE%vstd!set.Set. A&. A&)) (=> (has_type s2@ (TYPE%vstd!set.Set. A&. A&)) (=> (has_type f@ (TYPE%fun%1. A&. A& B&. B&)) (=> (ens%lib!verus_extra.set_lib_ext_v.set_map_union. A&. A& B&. B& s1@ s2@ (%Poly%fun%1. f@)) (=> %%location_label%%0 (= (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.union.? A&. A& s1@ s2@) f@) (vstd!set.impl&%0.union.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s1@ f@) (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s2@ f@)))))))) (=> (forall ((s1$ Poly) (s2$ Poly) (f$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!set.Set. A&. A&)) (has_type s2$ (TYPE%vstd!set.Set. A&. A&)) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (= (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.union.? A&. A& s1$ s2$) f$) (vstd!set.impl&%0.union.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s1$ f$) (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s2$ f$)))) :pattern ((vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.union.? A&. A& s1$ s2$) f$)) )) (=> %%location_label%%1 (forall ((s1$ Poly) (s2$ Poly) (f$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!set.Set. A&. A&)) (has_type s2$ (TYPE%vstd!set.Set. A&. A&)) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (= (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.union.? A&. A& s1$ s2$) f$) (vstd!set.impl&%0.union.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s1$ f$) (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s2$ f$)))) :pattern ((vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.union.? A&. A& s1$ s2$) f$)) )))))))
(check-sat)
(exit)

...
(assert (has_type dom! NAT))
(assert (has_type val! V&))
(declare-const %%switch_label%%0 Bool)
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (%I dom!)) (=> (>= (%I dom!) 0) (or (and (=> (= (%I dom!) 0) (=> (= tmp%3 (vstd!map.impl&%0.insert.? $ NAT V&. V& (vstd!map.impl&%0.empty.? $ NAT V&. V&) dom! val!)) %%switch_label%%0)) (=> (not (= (%I dom!) 0)) (=> (= tmp%2 (I (nClip (Sub (%I dom!) 1)))) (and (=> %%location_label%%0 (check_decrease_int (let ((dom!$0 tmp%2) (val!$1 val!)) (%I dom!$0)) decrease%init0 false)) (=> (has_type tmp%1 (TYPE%vstd!map.Map. $ NAT V&. V&)) (=> (= tmp%1 (lib!spec.utils.map_new_rec.? V&. V& (I (nClip (Sub (%I dom!) 1))) val!)) (=> (= tmp%3 (vstd!map.impl&%0.insert.? $ NAT V&. V& tmp%1 dom! val!)) %%switch_label%%0))))))) (not %%switch_label%%0))))))
(check-sat)
(exit)

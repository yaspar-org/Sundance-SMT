...
(assert (not (=> (has_type v!@1 (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL)) (=> (and (<= start! end!) (<= end! (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)))) (=> (= (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@1)) (Sub (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)) deleted@0)) (=> (and (<= 0 deleted@0) (<= deleted@0 (Sub end! start!))) (=> (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@1) (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I 0) (I start!)) (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I (Add start! deleted@0)) (I (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)))))) (and (=> %%location_label%%0 (uInv SZ (Sub end! start!))) (=> (< deleted@0 (uClip SZ (Sub end! start!))) (and (=> %%location_label%%1 (req%alloc!vec.impl&%1.remove. A&. A& $ ALLOCATOR_GLOBAL v!@1 start!)) (=> (has_type v!@2 (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL)) (=> (ens%alloc!vec.impl&%1.remove. A&. A& $ ALLOCATOR_GLOBAL v!@1 v!@2 start! tmp%3) (and (=> %%location_label%%2 (uInv SZ (Add deleted@0 1))) (=> (= deleted@1 (uClip SZ (Add deleted@0 1))) (=> (= s1$1@ (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@2)) (=> (= s2$1@ (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I 0) (I start!)) (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I (Add start! deleted@1)) (I (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)))))) (and (=> (= tmp%4 (= (vstd!seq.Seq.len.? A&. A& s1$1@) (vstd!seq.Seq.len.? A&. A& s2$1@))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (and (=> (has_type idx$1@ INT) (=> (and (<= 0 (%I idx$1@)) (< (%I idx$1@) (vstd!seq.Seq.len.? A&. A& s1$1@))) (=> %%location_label%%4 (= (vstd!seq.Seq.index.? A&. A& s1$1@ idx$1@) (vstd!seq.Seq.index.? A&. A& s2$1@ idx$1@))))) (=> (forall ((idx$ Poly)) (! (=> (has_type idx$ INT) (=> (and (<= 0 (%I idx$)) (< (%I idx$) (vstd!seq.Seq.len.? A&. A& s1$1@))) (= (vstd!seq.Seq.index.? A&. A& s1$1@ idx$) (vstd!seq.Seq.index.? A&. A& s2$1@ idx$)))) :pattern ((vstd!seq.Seq.index.? A&. A& s1$1@ idx$)) :pattern ((vstd!seq.Seq.index.? A&. A& s2$1@ idx$)) )) (=> (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1$1@ s2$1@)) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 (=> %%location_label%%6 (= s1$1@ s2$1@)))))))))) (=> (= s1$1@ s2$1@) (and (=> %%location_label%%7 (and (<= start! end!) (<= end! (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0))))) (and (=> %%location_label%%8 (= (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@2)) (Sub (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0)) deleted@1))) (and (=> %%location_label%%9 (and (<= 0 deleted@1) (<= deleted@1 (Sub end! start!)))) (=> %%location_label%%10 (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@2) (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I 0) (I start!)) (vstd!seq.Seq.subrange.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0) (I (Add start! deleted@1)) (I (vstd!seq.Seq.len.? A&. A& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. A&. A& $ ALLOCATOR_GLOBAL) v!@0))))))))))))))))))))))))))))
(check-sat)
(exit)

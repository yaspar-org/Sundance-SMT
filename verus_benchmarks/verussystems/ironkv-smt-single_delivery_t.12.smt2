...
(assert (not (or (and (=> (lib!single_delivery_t.impl&%1.should_ack_single_message.? MT&. MT& pre! pkt!) (and (=> %%location_label%%0 (req%lib!single_delivery_t.impl&%1.send_ack. MT&. MT& pre! pkt! ack! acks!)) (=> (= tmp%1 (lib!single_delivery_t.impl&%1.send_ack.? MT&. MT& pre! pkt! ack! acks!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (lib!single_delivery_t.impl&%1.should_ack_single_message.? MT&. MT& pre! pkt!)) (=> (= tmp%2 (vstd!set_lib.impl&%0.is_empty.? $ TYPE%lib!network_t.Packet. acks!)) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)

...
(assert (not (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (ens%alloc!vec.impl&%1.len. $ (UINT 8) $ ALLOCATOR_GLOBAL data! tmp%1) (or (and (=> (< tmp%1 8) (=> (= %return! (Poly%core!option.Option. core!option.Option./None)) (=> %%location_label%%0 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT 64) (I x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT 64) (I x$$0)))))))))) (=> (not (< tmp%1 8)) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (ens%alloc!vec.impl&%1.len. $ (UINT 8) $ ALLOCATOR_GLOBAL data! tmp%2) (and (=> %%location_label%%1 (uInv SZ (Sub tmp%2 8))) (or (and (=> (> (%I start!) (uClip SZ (Sub tmp%2 8))) (=> (= %return! (Poly%core!option.Option. core!option.Option./None)) (=> %%location_label%%2 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT 64) (I x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT 64) (I x$$0)))))))))) (=> (not (> (%I start!) (uClip SZ (Sub tmp%2 8)))) %%switch_label%%0)) (and (not %%switch_label%%0) (and (=> %%location_label%%3 (uInv SZ (Add (%I start!) 8))) (=> (= end@ (uClip SZ (Add (%I start!) 8))) (=> (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL data! tmp%3) (and (=> %%location_label%%4 (req%vstd!slice.slice_subrange. $ (UINT 8) tmp%3 (%I start!) end@)) (=> (ens%vstd!slice.slice_subrange. $ (UINT 8) tmp%3 (%I start!) end@ tmp%4) (and (=> %%location_label%%5 (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%4))) (=> (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%4) v@) (=> (= %return! (Poly%core!option.Option. (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (I v@) (I end@)))))) (=> %%location_label%%6 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT 64) (I x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT 64) (I x$$0))))))))))))))))))))))))))
(check-sat)
(exit)

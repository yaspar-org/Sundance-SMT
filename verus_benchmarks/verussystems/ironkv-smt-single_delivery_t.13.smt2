...
(assert (forall ((MT&. Dcr) (MT& Type) (un_acked! Poly) (seqno_acked! Poly) (fuel% Fuel)) (! (=> (and (has_type un_acked! (TYPE%vstd!seq.Seq. $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&))) (has_type seqno_acked! NAT)) (= (lib!single_delivery_t.rec%truncate_un_ack_list.? MT&. MT& un_acked! seqno_acked! (succ fuel%)) (ite (and (and (> (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!) 0) ((_ is lib!single_message_t.SingleMessage./Message) (%Poly%lib!single_message_t.SingleMessage. (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0))))) (<= (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (vstd!seq.Seq.index.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 0)))) (%I seqno_acked!))) (lib!single_delivery_t.rec%truncate_un_ack_list.? MT&. MT& (vstd!seq.Seq.subrange.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked! (I 1) (I (vstd!seq.Seq.len.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&) un_acked!))) seqno_acked! fuel%) un_acked!))) :pattern ((lib!single_delivery_t.rec%truncate_un_ack_list.? MT&. MT& un_acked! seqno_acked! (succ fuel%))) )))
...
(assert (forall ((MT&. Dcr) (MT& Type) (pre! Poly) (post! Poly) (pkt! Poly) (acks! Poly)) (! (= (req%lib!single_delivery_t.impl&%1.receive_ack. MT&. MT& pre! post! pkt! acks!) (=> %%global_location_label%%6 ((_ is lib!single_message_t.SingleMessage./Ack) (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))))) :pattern ((req%lib!single_delivery_t.impl&%1.receive_ack. MT&. MT& pre! post! pkt! acks!)) )))
...
(assert (not (=> (= tmp%%@ (lib!network_t.Packet./Packet/msg (%Poly%lib!network_t.Packet. pkt!))) (or (and (=> ((_ is lib!single_message_t.SingleMessage./Ack) tmp%%@) (and (=> %%location_label%%0 (req%lib!single_delivery_t.impl&%1.receive_ack. MT&. MT& pre! post! pkt! acks!)) (=> (= tmp%1 (lib!single_delivery_t.impl&%1.receive_ack.? MT&. MT& pre! post! pkt! acks!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not ((_ is lib!single_message_t.SingleMessage./Ack) tmp%%@)) (=> (= tmp%2 (ite ((_ is lib!single_message_t.SingleMessage./Message) tmp%%@) (let ((seqno$ (lib!single_message_t.SingleMessage./Message/seqno (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. tmp%%@))))) (let ((m$ (%Poly%lib!message_t.Message. (lib!single_message_t.SingleMessage./Message/m (%Poly%lib!single_message_t.SingleMessage. (Poly%lib!single_message_t.SingleMessage. tmp%%@)))))) (and (lib!single_delivery_t.impl&%1.receive_real_packet.? MT&. MT& pre! post! pkt!) (lib!single_delivery_t.impl&%1.maybe_ack_packet.? MT&. MT& post! pkt! ack! acks!)))) (and (= post! pre!) (= acks! (vstd!set.impl&%0.empty.? $ TYPE%lib!network_t.Packet.))))) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)

...
(declare-fun ens%lib!flags.impl&%0.set_has_aligned. (lib!types.PageInner. lib!types.PageInner. Bool) Bool)
(assert (forall ((pre%self! lib!types.PageInner.) (self! lib!types.PageInner.) (b! Bool)) (! (= (ens%lib!flags.impl&%0.set_has_aligned. pre%self! self! b!) (and (has_type (Poly%lib!types.PageInner. self!) TYPE%lib!types.PageInner.) (= self! (lib!types.PageInner./PageInner (%I (I (lib!types.PageInner./PageInner/flags0 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. pre%self!))))) (%I (I (lib!types.PageInner./PageInner/capacity (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. pre%self!))))) (%I (I (lib!types.PageInner./PageInner/reserved (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. pre%self!))))) (%I (I (lib!types.PageInner./PageInner/flags1 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!))))) (%I (I (lib!types.PageInner./PageInner/flags2 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. pre%self!))))) (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. (lib!types.PageInner./PageInner/free (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. pre%self!))))) (%I (I (lib!types.PageInner./PageInner/used (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. pre%self!))))) (%I (I (lib!types.PageInner./PageInner/xblock_size (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. pre%self!))))) (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. (lib!types.PageInner./PageInner/local_free (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. pre%self!))))))) (= (lib!flags.impl&%0.has_aligned.? (Poly%lib!types.PageInner. self!)) b!) (= (lib!flags.impl&%0.in_full.? (Poly%lib!types.PageInner. self!)) (lib!flags.impl&%0.in_full.? (Poly%lib!types.PageInner. pre%self!))))) :pattern ((ens%lib!flags.impl&%0.set_has_aligned. pre%self! self! b!)) )))
...
(assert (not (=> (= y@ (ite b! 1 0)) (=> (= x@ (lib!types.PageInner./PageInner/flags1 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0)))) (and (=> %%location_label%%0 true) (=> (=> (or (= y@ 1) (= y@ 0)) (= (uClip 8 (bitand (I (uClip 8 (bitor (I (uClip 8 (bitand (I x@) (I (uClip 8 (bitnot (I 2))))))) (I (uClip 8 (bitshl (I y@) (I 1))))))) (I 1))) (uClip 8 (bitand (I x@) (I 1))))) (and (=> %%location_label%%1 true) (=> (=> (or (= y@ 1) (= y@ 0)) (= (= (uClip 8 (bitand (I (uClip 8 (bitor (I (uClip 8 (bitand (I x@) (I (uClip 8 (bitnot (I 2))))))) (I (uClip 8 (bitshl (I y@) (I 1))))))) (I 2))) 0) (= y@ 0))) (and (=> %%location_label%%2 (and (<= 0 1) (< 1 8))) (=> (= tmp%1 (uClip 8 (bitor (I (uClip 8 (bitand (I (lib!types.PageInner./PageInner/flags1 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0)))) (I (uClip 8 (bitnot (I 2))))))) (I (uClip 8 (bitshl (I (ite b! 1 0)) (I 1))))))) (=> (= (lib!types.PageInner./PageInner/flags1 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@1))) tmp%1) (=> (and (= (lib!types.PageInner./PageInner/flags0 self!@0) (lib!types.PageInner./PageInner/flags0 self!@1)) (= (lib!types.PageInner./PageInner/capacity self!@0) (lib!types.PageInner./PageInner/capacity self!@1)) (= (lib!types.PageInner./PageInner/reserved self!@0) (lib!types.PageInner./PageInner/reserved self!@1)) (= (lib!types.PageInner./PageInner/flags2 self!@0) (lib!types.PageInner./PageInner/flags2 self!@1)) (= (lib!types.PageInner./PageInner/free self!@0) (lib!types.PageInner./PageInner/free self!@1)) (= (lib!types.PageInner./PageInner/used self!@0) (lib!types.PageInner./PageInner/used self!@1)) (= (lib!types.PageInner./PageInner/xblock_size self!@0) (lib!types.PageInner./PageInner/xblock_size self!@1)) (= (lib!types.PageInner./PageInner/local_free self!@0) (lib!types.PageInner./PageInner/local_free self!@1))) (and (=> %%location_label%%3 (= self!@1 (lib!types.PageInner./PageInner (%I (I (lib!types.PageInner./PageInner/flags0 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0))))) (%I (I (lib!types.PageInner./PageInner/capacity (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0))))) (%I (I (lib!types.PageInner./PageInner/reserved (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0))))) (%I (I (lib!types.PageInner./PageInner/flags1 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@1))))) (%I (I (lib!types.PageInner./PageInner/flags2 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0))))) (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. (lib!types.PageInner./PageInner/free (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0))))) (%I (I (lib!types.PageInner./PageInner/used (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0))))) (%I (I (lib!types.PageInner./PageInner/xblock_size (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0))))) (%Poly%lib!linked_list.LL. (Poly%lib!linked_list.LL. (lib!types.PageInner./PageInner/local_free (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!@0)))))))) (and (=> %%location_label%%4 (= (lib!flags.impl&%0.has_aligned.? (Poly%lib!types.PageInner. self!@1)) b!)) (=> %%location_label%%5 (= (lib!flags.impl&%0.in_full.? (Poly%lib!types.PageInner. self!@1)) (lib!flags.impl&%0.in_full.? (Poly%lib!types.PageInner. self!@0))))))))))))))))))
(check-sat)
(exit)

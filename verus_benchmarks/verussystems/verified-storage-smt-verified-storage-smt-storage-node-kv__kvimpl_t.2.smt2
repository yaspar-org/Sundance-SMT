...
(assert (not (=> (= result! (core!result.Result./Err (Poly%lib!kv.kvimpl_t.KvError. lib!kv.kvimpl_t.KvError./NotImplemented))) (=> %%location_label%%0 (=> ((_ is core!result.Result./Ok) result!) (let ((restored_kv$ (%Poly%lib!kv.kvimpl_t.KvStore. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (let ((restored_state$ (lib!kv.kvimpl_v.impl&%0.recover.? PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E& (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. (lib!pmem.pmemspec_t.impl&%7.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegions.view.? PM&. PM& pmem!))) (I kvstore_id!)))) (and ((_ is core!option.Option./Some) restored_state$) (let ((restored_state$1 (%Poly%lib!kv.kvspec_t.AbstractKvStoreState. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. restored_state$)))))) (= (lib!kv.kvimpl_t.impl&%5.view.? PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E& (Poly%lib!kv.kvimpl_t.KvStore. restored_kv$)) restored_state$1))))))))))
(check-sat)
(exit)

...
(declare-fun %%choose%%1 (Type Dcr Type Poly %%Function%% Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4 %%Function%%) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly)) (! (=> (exists ((x$1 Poly)) (! (and (has_type x$1 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 x$1) (= (%%apply%%0 %%hole%%4 x$1) %%hole%%5))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 %%hole%%8 x$1)) )) (exists ((x$1 Poly)) (! (and (and (has_type x$1 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 x$1) (= (%%apply%%0 %%hole%%4 x$1) %%hole%%5))) (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) x$1)) :pattern ((vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 %%hole%%8 x$1))))) :pattern ((%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8)))))
...
(assert (not (=> (= s1@ (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.union.? A&. A& s1! s2!) (Poly%fun%1. f!))) (=> (= s2@ (vstd!set.impl&%0.union.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s1! (Poly%fun%1. f!)) (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s2! (Poly%fun%1. f!)))) (and (and (=> (has_type y@ B&) (or (and (=> (vstd!set.impl&%0.contains.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s1! (Poly%fun%1. f!)) y@) (=> (= x@ (as_type (%%choose%%1 A& A&. A& s1! f! y@ A&. A& s1!) A&)) (=> (= tmp%1 (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.union.? A&. A& s1! s2!) x@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0))))) (=> (not (vstd!set.impl&%0.contains.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s1! (Poly%fun%1. f!)) y@)) (or (and (=> (vstd!set.impl&%0.contains.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s2! (Poly%fun%1. f!)) y@) (=> (= x$2@ (as_type (%%choose%%1 A& A&. A& s2! f! y@ A&. A& s2!) A&)) (=> (= tmp%2 (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.union.? A&. A& s1! s2!) x$2@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%1))))) (=> (not (vstd!set.impl&%0.contains.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s2! (Poly%fun%1. f!)) y@)) %%switch_label%%1)) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%2 (and (=> (vstd!set.impl&%0.contains.? B&. B& s1@ y@) (vstd!set.impl&%0.contains.? B&. B& s2@ y@)) (=> (vstd!set.impl&%0.contains.? B&. B& s2@ y@) (vstd!set.impl&%0.contains.? B&. B& s1@ y@))))))) (=> (forall ((y$ Poly)) (! (=> (has_type y$ B&) (and (=> (vstd!set.impl&%0.contains.? B&. B& s1@ y$) (vstd!set.impl&%0.contains.? B&. B& s2@ y$)) (=> (vstd!set.impl&%0.contains.? B&. B& s2@ y$) (vstd!set.impl&%0.contains.? B&. B& s1@ y$)))) :pattern ((vstd!set.impl&%0.contains.? B&. B& s1@ y$)) :pattern ((vstd!set.impl&%0.contains.? B&. B& s2@ y$)) )) (=> (= tmp%3 (ext_eq false (TYPE%vstd!set.Set. B&. B&) s1@ s2@)) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 (=> %%location_label%%4 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> %%location_label%%5 (= (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.union.? A&. A& s1! s2!) (Poly%fun%1. f!)) (vstd!set.impl&%0.union.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s1! (Poly%fun%1. f!)) (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s2! (Poly%fun%1. f!)))))))))))
(check-sat)
(exit)

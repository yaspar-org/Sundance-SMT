...
(assert (forall ((ov! core!option.Option.) (res! core!option.Option.)) (! (= (ens%lib!seq_is_unique_v.clone_option_vec_u8. ov! res!) (and (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL))) (ite ((_ is core!option.Option./Some) ov!) (let ((e1$ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. ov!)))))) (and ((_ is core!option.Option./Some) res!) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. e1$)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. res!))))))) ((_ is core!option.Option./None) res!)))) :pattern ((ens%lib!seq_is_unique_v.clone_option_vec_u8. ov! res!)) )))
...
(declare-const seq1@ Poly)
(declare-const set1@ Poly)
(declare-const set2@ Poly)
...
(assert (not (=> (= seq1@ (vstd!seq.Seq.push.? T&. T& (vstd!seq.Seq.empty.? T&. T&) x!)) (=> (= set1@ (vstd!seq_lib.impl&%0.to_set.? T&. T& seq1@)) (=> (= set2@ (vstd!set.impl&%0.insert.? T&. T& (vstd!set.impl&%0.empty.? T&. T&) x!)) (and (=> (has_type y@ T&) (or (and (=> (= y@ x!) (=> (= tmp%1 (= (vstd!seq.Seq.index.? T&. T& seq1@ (I 0)) y@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (vstd!set.impl&%0.contains.? T&. T& set1@ y@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%0))))))) (=> (not (= y@ x!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (= (vstd!set.impl&%0.contains.? T&. T& set1@ y@) (vstd!set.impl&%0.contains.? T&. T& set2@ y@)))))) (=> (forall ((y$ Poly)) (! (=> (has_type y$ T&) (= (vstd!set.impl&%0.contains.? T&. T& set1@ y$) (vstd!set.impl&%0.contains.? T&. T& set2@ y$))) :pattern ((vstd!set.impl&%0.contains.? T&. T& set1@ y$)) :pattern ((vstd!set.impl&%0.contains.? T&. T& set2@ y$)) )) (=> (= s1@ (vstd!seq_lib.impl&%0.to_set.? T&. T& (vstd!seq.Seq.push.? T&. T& (vstd!seq.Seq.empty.? T&. T&) x!))) (=> (= s2@ (vstd!set.impl&%0.insert.? T&. T& (vstd!set.impl&%0.empty.? T&. T&) x!)) (and (and (=> (has_type elem@ T&) (=> %%location_label%%3 (and (=> (vstd!set.impl&%0.contains.? T&. T& s1@ elem@) (vstd!set.impl&%0.contains.? T&. T& s2@ elem@)) (=> (vstd!set.impl&%0.contains.? T&. T& s2@ elem@) (vstd!set.impl&%0.contains.? T&. T& s1@ elem@))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ T&) (and (=> (vstd!set.impl&%0.contains.? T&. T& s1@ elem$) (vstd!set.impl&%0.contains.? T&. T& s2@ elem$)) (=> (vstd!set.impl&%0.contains.? T&. T& s2@ elem$) (vstd!set.impl&%0.contains.? T&. T& s1@ elem$)))) :pattern ((vstd!set.impl&%0.contains.? T&. T& s1@ elem$)) :pattern ((vstd!set.impl&%0.contains.? T&. T& s2@ elem$)) )) (=> (= tmp%3 (ext_eq false (TYPE%vstd!set.Set. T&. T&) s1@ s2@)) (and (=> %%location_label%%4 tmp%3) (=> tmp%3 (=> %%location_label%%5 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> %%location_label%%6 (= (vstd!seq_lib.impl&%0.to_set.? T&. T& (vstd!seq.Seq.push.? T&. T& (vstd!seq.Seq.empty.? T&. T&) x!)) (vstd!set.impl&%0.insert.? T&. T& (vstd!set.impl&%0.empty.? T&. T&) x!))))))))))))))
(check-sat)
(exit)

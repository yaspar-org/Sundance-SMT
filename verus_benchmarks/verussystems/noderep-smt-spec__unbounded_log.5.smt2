...
(assert (lib!spec.unbounded_log.LogRangeNoNodeId.? DT&. DT& log! (I a!) (I b!) (I nodeId!)))
(assert (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) log! (I queueIndex!) (I b!) (I c!) (I nodeId!) updates!))
(declare-const %%switch_label%%0 Bool)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(assert (not (=> (= decrease%init0 (Sub b! a!)) (or (and (=> (not (= a! b!)) (=> (= tmp%1 (nClip (Add a! 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((queue!$0 queue!) (log!$1 log!) (queueIndex!$2 queueIndex!) (a!$3 tmp%1) (b!$4 b!) (c!$5 c!) (nodeId!$6 nodeId!) (updates!$7 updates!)) (Sub b!$4 a!$3)) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!spec.unbounded_log.concat_LogRangeNoNodeId_LogRangeMatchesQueue. DT&. DT& queue! log! queueIndex! tmp%1 b! c! nodeId! updates!)) (=> (ens%lib!spec.unbounded_log.concat_LogRangeNoNodeId_LogRangeMatchesQueue. DT&. DT& queue! log! queueIndex! tmp%1 b! c! nodeId! updates!) %%switch_label%%0))))) (=> (not (not (= a! b!))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (lib!spec.unbounded_log.LogRangeMatchesQueue.? DT&. DT& (Poly%vstd!seq.Seq<nat.>. queue!) log! (I queueIndex!) (I a!) (I c!) (I nodeId!) updates!)))))))
(check-sat)
(exit)

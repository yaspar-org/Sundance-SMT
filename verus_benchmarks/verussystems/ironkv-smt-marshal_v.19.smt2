...
(assert (not (or (and (=> ((_ is core!option.Option./None) (%Poly%core!option.Option. self!)) (=> (= tmp%2 1) %%switch_label%%0)) (=> (not ((_ is core!option.Option./None) (%Poly%core!option.Option. self!))) (=> (= x@ (core!option.Option./Some/0 (%Poly%core!option.Option. self!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. T&. T& x@)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. T&. T& x@ tmp%1) (and (=> %%location_label%%1 (uInv SZ (Add 1 (%I tmp%1)))) (=> (= tmp%2 (uClip SZ (Add 1 (%I tmp%1)))) %%switch_label%%0))))))) (and (not %%switch_label%%0) (=> (= %return! (I tmp%2)) (=> %%location_label%%2 (= (%I %return!) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%core!option.Option. T&. T&) self!)))))))))
(check-sat)
(exit)

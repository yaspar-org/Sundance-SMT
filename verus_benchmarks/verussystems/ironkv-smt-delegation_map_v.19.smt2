...
(assert (not (=> (= s! (lib!keys_t.KeyIterator./KeyIterator (%Poly%core!option.Option. (Poly%core!option.Option. (core!option.Option./Some k!))))) (=> %%location_label%%0 (= (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. s!))) (core!option.Option./Some k!))))))
(check-sat)
(exit)

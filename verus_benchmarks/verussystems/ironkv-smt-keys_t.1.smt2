...
(assert (not (=> (= tmp%1 (= (lib!keys_t.SHTKey./SHTKey (%I (I 0))) (%Poly%lib!keys_t.SHTKey. (lib!keys_t.KeyTrait.zero_spec.? $ TYPE%lib!keys_t.SHTKey.)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= %return! (Poly%lib!keys_t.SHTKey. (lib!keys_t.SHTKey./SHTKey (%I (I 0))))) (=> %%location_label%%1 (= %return! (lib!keys_t.KeyTrait.zero_spec.? $ TYPE%lib!keys_t.SHTKey.)))))))))
(check-sat)
(exit)

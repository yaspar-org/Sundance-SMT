...
(declare-const s! lib!keys_t.KeyIterator.)
(assert fuel_defaults)
(assert (tr_bound%lib!keys_t.KeyTrait. K&. K&))
(assert (tr_bound%lib!verus_extra.clone_v.VerusClone. K&. K&))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= s! (lib!keys_t.KeyIterator./KeyIterator (%Poly%core!option.Option. (Poly%core!option.Option. core!option.Option./None)))) (=> %%location_label%%0 ((_ is core!option.Option./None) (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. s!))))))))
(check-sat)
(exit)

...
(assert (%B (lib!marshal_v.Marshalable.view_equal.? $ (UINT SZ) self! other!)))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (UINT 64) (I (uClip 64 (%I self!))) (I (uClip 64 (%I other!))))) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. $ (UINT 64) (I (uClip 64 (%I self!))) (I (uClip 64 (%I other!)))) (and (=> %%location_label%%1 (= (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT SZ) self!) (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT SZ) other!))) (=> %%location_label%%2 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) other!))))))))
(check-sat)
(exit)

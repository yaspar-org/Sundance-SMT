...
(assert (not (=> (ens%lib!marshal_v.Marshalable.deserialize. T&. T& data! start! tmp%1) (=> (= tmp%%$1@ (%Poly%core!option.Option. tmp%1)) (or (and (=> ((_ is core!option.Option./None) tmp%%$1@) (=> (= %return! (Poly%core!option.Option. core!option.Option./None)) (=> %%location_label%%0 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%Poly%tuple%2. (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%tuple%2. T&. T& U&. U&) (Poly%tuple%2. x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) (Poly%tuple%2. x$$0)))))))))) (=> (not ((_ is core!option.Option./None) tmp%%$1@)) %%switch_label%%1)) (and (not %%switch_label%%1) (=> (= tmp%%@ (let ((x$ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%$1@)))))) x$)) (=> (= t@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))) (=> (= mid@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (ens%lib!marshal_v.Marshalable.deserialize. U&. U& data! (I mid@) tmp%2) (=> (= tmp%%$3@ (%Poly%core!option.Option. tmp%2)) (or (and (=> ((_ is core!option.Option./None) tmp%%$3@) (=> (= %return! (Poly%core!option.Option. core!option.Option./None)) (=> %%location_label%%1 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%Poly%tuple%2. (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%tuple%2. T&. T& U&. U&) (Poly%tuple%2. x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) (Poly%tuple%2. x$$0)))))))))) (=> (not ((_ is core!option.Option./None) tmp%%$3@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= tmp%%$2@ (let ((x$ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%$3@)))))) x$)) (=> (= u@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$2@)))) (=> (= end@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$2@))))) (=> (= p@ (tuple%2./tuple%2 t@ u@)) (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end@)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) (Poly%tuple%2. p@)))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= %return! (Poly%core!option.Option. (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (Poly%tuple%2. p@) (I end@)))))) (=> %%location_label%%3 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%Poly%tuple%2. (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%tuple%2. T&. T& U&. U&) (Poly%tuple%2. x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) (Poly%tuple%2. x$$0)))))))))))))))))))))))))))))
(check-sat)
(exit)

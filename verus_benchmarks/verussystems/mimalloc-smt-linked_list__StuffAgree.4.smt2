...
(assert (forall ((self! lib!linked_list.StuffAgree.Instance.) (b! core!option.Option.) (pre%param_token_x! lib!linked_list.StuffAgree.x.) (pre%param_token_y! lib!linked_list.StuffAgree.y.)) (! (= (req%lib!linked_list.StuffAgree.impl&%6.set. self! b! pre%param_token_x! pre%param_token_y!) (and (=> %%global_location_label%%3 (= (lib!linked_list.StuffAgree.x_token_data./x_token_data/instance (%Poly%lib!linked_list.StuffAgree.x_token_data. (Poly%lib!linked_list.StuffAgree.x_token_data. (lib!linked_list.StuffAgree.impl&%4.view.? (Poly%lib!linked_list.StuffAgree.x. pre%param_token_x!))))) self!)) (=> %%global_location_label%%4 (= (lib!linked_list.StuffAgree.y_token_data./y_token_data/instance (%Poly%lib!linked_list.StuffAgree.y_token_data. (Poly%lib!linked_list.StuffAgree.y_token_data. (lib!linked_list.StuffAgree.impl&%5.view.? (Poly%lib!linked_list.StuffAgree.y. pre%param_token_y!))))) self!)))) :pattern ((req%lib!linked_list.StuffAgree.impl&%6.set. self! b! pre%param_token_x! pre%param_token_y!)) )))

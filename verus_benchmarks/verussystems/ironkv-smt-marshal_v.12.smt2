...
(assert (not (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (ens%lib!marshal_v.Marshalable.deserialize. $ (UINT 64) data! start! tmp%1) (=> (= tmp%%$1@ (%Poly%core!option.Option. tmp%1)) (or (and (=> ((_ is core!option.Option./None) tmp%%$1@) (=> (= %return! (Poly%core!option.Option. core!option.Option./None)) (=> %%location_label%%0 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT SZ) (I x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I x$$0)))))))))) (=> (not ((_ is core!option.Option./None) tmp%%$1@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= tmp%%@ (let ((x$ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%$1@)))))) x$)) (=> (= r@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= end@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= %return! (Poly%core!option.Option. (ite (<= r@ (uClip 64 (- (uHi SZ) 1))) (let ((res$ (uClip SZ r@))) (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 (I res$) (I end@))))) core!option.Option./None))) (=> %%location_label%%1 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT SZ) (I x$$0))) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I x$$0)))))))))))))))))))
(check-sat)
(exit)

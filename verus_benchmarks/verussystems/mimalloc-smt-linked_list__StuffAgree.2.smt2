...
(assert (and (lib!linked_list.StuffAgree.impl&%9.invariant.? (Poly%lib!linked_list.StuffAgree.State. pre!)) (lib!linked_list.StuffAgree.impl&%9.set_strong.? (Poly%lib!linked_list.StuffAgree.State. pre!) (Poly%lib!linked_list.StuffAgree.State. post!) (Poly%core!option.Option. b!))))

...
(assert (not (=> %%location_label%%0 (forall ((x$ Poly)) (! (=> (has_type x$ (TYPE%vstd!set.Set. A&. A&)) (ext_eq false (TYPE%vstd!set.Set. A&. A&) (lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.insert.? $ (TYPE%vstd!set.Set. A&. A&) (vstd!set.impl&%0.empty.? $ (TYPE%vstd!set.Set. A&. A&)) x$)) x$)) :pattern ((lib!verus_extra.set_lib_ext_v.flatten_sets.? A&. A& (vstd!set.impl&%0.insert.? $ (TYPE%vstd!set.Set. A&. A&) (vstd!set.impl&%0.empty.? $ (TYPE%vstd!set.Set. A&. A&)) x$))) )))))
(check-sat)
(exit)

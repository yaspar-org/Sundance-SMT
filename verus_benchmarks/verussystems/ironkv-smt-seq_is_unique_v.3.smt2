...
(declare-const e1! lib!io_t.EndPoint.)
(declare-const e2! lib!io_t.EndPoint.)
(declare-const tmp%1 Bool)
(declare-const tmp%2 alloc!vec.Vec<u8./allocator_global%.>.)
(declare-const tmp%3 alloc!vec.Vec<u8./allocator_global%.>.)
(assert fuel_defaults)
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= tmp%2 (lib!io_t.EndPoint./EndPoint/id (%Poly%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. e1!)))) (=> (= tmp%3 (lib!io_t.EndPoint./EndPoint/id (%Poly%lib!io_t.EndPoint. (Poly%lib!io_t.EndPoint. e2!)))) (=> (ens%lib!seq_is_unique_v.do_vec_u8s_match. tmp%2 tmp%3 tmp%1) (=> (= eq! tmp%1) (=> %%location_label%%0 (= eq! (= (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. e1!)) (lib!io_t.impl&%4.view.? (Poly%lib!io_t.EndPoint. e2!)))))))))))
(check-sat)
(exit)

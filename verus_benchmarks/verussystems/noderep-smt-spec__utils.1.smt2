...
(assert (has_type seq! (TYPE%vstd!seq.Seq. A&. A&)))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? A&. A& seq!)) (=> (>= (vstd!seq.Seq.len.? A&. A& seq!) 0) (or (and (=> (= (vstd!seq.Seq.len.? A&. A& seq!) 0) %%switch_label%%1) (=> (not (= (vstd!seq.Seq.len.? A&. A& seq!) 0)) (=> (= tmp%4 (< (vstd!seq.Seq.len.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? A&. A& seq!)) (vstd!seq.Seq.len.? A&. A& seq!))) (and (=> %%location_label%%0 tmp%4) (=> tmp%4 %%switch_label%%1))))) (and (not %%switch_label%%1) (or (and (=> (= (vstd!seq.Seq.len.? A&. A& seq!) 0) (=> (= tmp%3 (vstd!set.impl&%0.empty.? A&. A&)) %%switch_label%%0)) (=> (not (= (vstd!seq.Seq.len.? A&. A& seq!) 0)) (=> (= tmp%2 (vstd!seq_lib.impl&%0.drop_last.? A&. A& seq!)) (and (=> %%location_label%%1 (check_decrease_int (let ((seq!$0 tmp%2)) (vstd!seq.Seq.len.? A&. A& seq!$0)) decrease%init0 false)) (=> (has_type tmp%1 (TYPE%vstd!set.Set. A&. A&)) (=> (= tmp%1 (lib!spec.utils.seq_to_set_rec.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? A&. A& seq!))) (=> (= tmp%3 (vstd!set.impl&%0.insert.? A&. A& tmp%1 (vstd!seq.Seq.last.? A&. A& seq!))) %%switch_label%%0))))))) (not %%switch_label%%0))))))))
(check-sat)
(exit)

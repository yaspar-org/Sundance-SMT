...
(assert (has_type x! A&))
(declare-fun %%choose%%3 (Type Dcr Type Poly %%Function%% Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4 %%Function%%) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Poly)) (! (=> (exists ((x0$1 Poly)) (! (and (has_type x0$1 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 x0$1) (= %%hole%%5 (%%apply%%0 %%hole%%4 x0$1)))) :pattern ((vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 %%hole%%8 x0$1)) )) (exists ((x0$1 Poly)) (! (and (and (has_type x0$1 %%hole%%0) (and (vstd!set.impl&%0.contains.? %%hole%%1 %%hole%%2 %%hole%%3 x0$1) (= %%hole%%5 (%%apply%%0 %%hole%%4 x0$1)))) (= (%%choose%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8) x0$1)) :pattern ((vstd!set.impl&%0.contains.? %%hole%%6 %%hole%%7 %%hole%%8 x0$1))))) :pattern ((%%choose%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8)))))
...
(assert (not (=> (= s1@ (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& s! x!) (Poly%fun%1. f!))) (=> (= s2@ (vstd!set.impl&%0.insert.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s! (Poly%fun%1. f!)) (%%apply%%0 f! x!))) (and (and (=> (has_type y@ B&) (or (and (=> (= y@ (%%apply%%0 f! x!)) (=> (= tmp%1 (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.insert.? A&. A& s! x!) x!)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (= y@ (%%apply%%0 f! x!))) (or (and (=> (vstd!set.impl&%0.contains.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& s! x!) (Poly%fun%1. f!)) y@) (=> (= x0@ (as_type (%%choose%%3 A& A&. A& s! f! y@ A&. A& s!) A&)) (=> (= tmp%2 (vstd!set.impl&%0.contains.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s! (Poly%fun%1. f!)) y@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%1))))) (=> (not (vstd!set.impl&%0.contains.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& s! x!) (Poly%fun%1. f!)) y@)) (or (and (=> (vstd!set.impl&%0.contains.? B&. B& (vstd!set.impl&%0.insert.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s! (Poly%fun%1. f!)) (%%apply%%0 f! x!)) y@) (=> (= x0$2@ (as_type (%%choose%%3 A& A&. A& s! f! y@ A&. A& s!) A&)) (=> (= tmp%3 (vstd!set.impl&%0.contains.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s! (Poly%fun%1. f!)) y@)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (vstd!set.impl&%0.contains.? A&. A& (vstd!set.impl&%0.insert.? A&. A& s! x!) x0$2@)) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 %%switch_label%%2)))))))) (=> (not (vstd!set.impl&%0.contains.? B&. B& (vstd!set.impl&%0.insert.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s! (Poly%fun%1. f!)) (%%apply%%0 f! x!)) y@)) %%switch_label%%2)) (and (not %%switch_label%%2) %%switch_label%%1)))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%4 (and (=> (vstd!set.impl&%0.contains.? B&. B& s1@ y@) (vstd!set.impl&%0.contains.? B&. B& s2@ y@)) (=> (vstd!set.impl&%0.contains.? B&. B& s2@ y@) (vstd!set.impl&%0.contains.? B&. B& s1@ y@))))))) (=> (forall ((y$ Poly)) (! (=> (has_type y$ B&) (and (=> (vstd!set.impl&%0.contains.? B&. B& s1@ y$) (vstd!set.impl&%0.contains.? B&. B& s2@ y$)) (=> (vstd!set.impl&%0.contains.? B&. B& s2@ y$) (vstd!set.impl&%0.contains.? B&. B& s1@ y$)))) :pattern ((vstd!set.impl&%0.contains.? B&. B& s1@ y$)) :pattern ((vstd!set.impl&%0.contains.? B&. B& s2@ y$)) )) (=> (= tmp%5 (ext_eq false (TYPE%vstd!set.Set. B&. B&) s1@ s2@)) (and (=> %%location_label%%5 tmp%5) (=> tmp%5 (=> %%location_label%%6 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> %%location_label%%7 (= (vstd!set_lib.impl&%0.map.? A&. A& B&. B& (vstd!set.impl&%0.insert.? A&. A& s! x!) (Poly%fun%1. f!)) (vstd!set.impl&%0.insert.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s! (Poly%fun%1. f!)) (%%apply%%0 f! x!))))))))))
(check-sat)
(exit)

...
(assert (forall ((x lib!kv.kvimpl_t.KvStore.)) (! (=> ((_ is lib!kv.kvimpl_t.KvStore./KvStore) x) (height_lt (height (lib!kv.kvimpl_t.KvStore./KvStore/untrusted_kv_impl x)) (height (Poly%lib!kv.kvimpl_t.KvStore. x)))) :pattern ((height (lib!kv.kvimpl_t.KvStore./KvStore/untrusted_kv_impl x))) )))
...
(assert (forall ((x lib!kv.kvspec_t.AbstractKvStoreState.)) (! (=> ((_ is lib!kv.kvspec_t.AbstractKvStoreState./AbstractKvStoreState) x) (height_lt (height (lib!kv.kvspec_t.AbstractKvStoreState./AbstractKvStoreState/contents x)) (height (Poly%lib!kv.kvspec_t.AbstractKvStoreState. x)))) :pattern ((height (lib!kv.kvspec_t.AbstractKvStoreState./AbstractKvStoreState/contents x))) )))
(assert (forall ((x lib!kv.kvspec_t.AbstractKvStoreState.)) (! (=> ((_ is lib!kv.kvspec_t.AbstractKvStoreState./AbstractKvStoreState) x) (height_lt (height (Poly%core!option.Option. (lib!kv.kvspec_t.AbstractKvStoreState./AbstractKvStoreState/_phantom x))) (height (Poly%lib!kv.kvspec_t.AbstractKvStoreState. x)))) :pattern ((height (Poly%core!option.Option. (lib!kv.kvspec_t.AbstractKvStoreState./AbstractKvStoreState/_phantom x)))) )))
...
(assert (forall ((T&. Dcr) (T& Type) (E&. Dcr) (E& Type) (result! Poly)) (! (= (req%vstd!std_specs.result.spec_unwrap. T&. T& E&. E& result!) (=> %%global_location_label%%5 ((_ is core!result.Result./Ok) (%Poly%core!result.Result. result!)))) :pattern ((req%vstd!std_specs.result.spec_unwrap. T&. T& E&. E& result!)) )))
...
(assert (not (=> (ens%lib!kv.kvimpl_v.impl&%0.untrusted_new. PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E& pmem! kvstore_id! max_keys! list_node_size! tmp%1) (=> (ens%core!result.impl&%26.branch. $ (TYPE%lib!kv.kvimpl_v.UntrustedKvStoreImpl. PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E&) $ (TYPE%lib!kv.kvimpl_t.KvError. K&. K& E&. E&) tmp%1 tmp%%@) (or (and (=> ((_ is core!ops.control_flow.ControlFlow./Break) tmp%%@) (=> (= residual@ (%Poly%core!result.Result. (core!ops.control_flow.ControlFlow./Break/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@))))) (=> (ens%core!result.impl&%27.from_residual. $ (TYPE%lib!kv.kvimpl_t.KvStore. PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E&) $ (TYPE%lib!kv.kvimpl_t.KvError. K&. K& E&. E&) $ (TYPE%lib!kv.kvimpl_t.KvError. K&. K& E&. E&) residual@ tmp%2) (=> (= result! tmp%2) (=> %%location_label%%0 (=> ((_ is core!result.Result./Ok) result!) (let ((new_kv$ (%Poly%lib!kv.kvimpl_t.KvStore. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (lib!kv.kvimpl_t.impl&%5.valid.? PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E& (Poly%lib!kv.kvimpl_t.KvStore. new_kv$))))))))) (=> (not ((_ is core!ops.control_flow.ControlFlow./Break) tmp%%@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= result! (core!result.Result./Ok (Poly%lib!kv.kvimpl_t.KvStore. (lib!kv.kvimpl_t.KvStore./KvStore (%I (I kvstore_id!)) (let ((val$ (core!ops.control_flow.ControlFlow./Continue/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@))))) val$))))) (=> %%location_label%%1 (=> ((_ is core!result.Result./Ok) result!) (let ((new_kv$ (%Poly%lib!kv.kvimpl_t.KvStore. (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result. result!)))))) (lib!kv.kvimpl_t.impl&%5.valid.? PM&. PM& K&. K& I&. I& L&. L& D&. D& V&. V& E&. E& (Poly%lib!kv.kvimpl_t.KvStore. new_kv$))))))))))))
(check-sat)
(exit)

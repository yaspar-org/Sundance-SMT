...
(assert (not (=> (= tmp%1 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. self!)))) (=> (= tmp%2 (Poly%lib!keys_t.SHTKey. (lib!hashmap_t.CKeyKV./CKeyKV/k (%Poly%lib!hashmap_t.CKeyKV. other!)))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. $ TYPE%lib!keys_t.SHTKey. tmp%1 tmp%2) (=> (= tmp%3 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. self!)))) (=> (= tmp%4 (Poly%alloc!vec.Vec<u8./allocator_global%.>. (lib!hashmap_t.CKeyKV./CKeyKV/v (%Poly%lib!hashmap_t.CKeyKV. other!)))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) tmp%3 tmp%4) (=> %%location_label%%0 (= (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!hashmap_t.CKeyKV. self! other!) (lib!marshal_v.Marshalable.view_equal.? $ TYPE%lib!hashmap_t.CKeyKV. other! self!)))))))))))
(check-sat)
(exit)

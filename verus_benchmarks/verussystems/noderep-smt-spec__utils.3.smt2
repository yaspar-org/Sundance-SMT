...
(declare-const fuel%lib!spec.utils.seq_to_set_rec. FuelId)
...
(declare-const fuel%lib!spec.utils.range. FuelId)
(declare-const fuel%lib!spec.utils.rangeincl. FuelId)
(assert (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map_lib.impl&%0.contains_key. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.impl&%0.spec_add. fuel%vstd!seq.Seq.last. fuel%vstd!seq_lib.impl&%0.add_empty_left. fuel%vstd!seq_lib.impl&%0.add_empty_right. fuel%vstd!seq_lib.impl&%0.push_distributes_over_add. fuel%vstd!seq_lib.impl&%0.contains. fuel%vstd!seq_lib.impl&%0.drop_last. fuel%vstd!seq_lib.impl&%0.to_set. fuel%vstd!set.impl&%0.choose. fuel%lib!spec.utils.seq_unique. fuel%lib!spec.utils.seq_disjoint. fuel%lib!spec.utils.seq_to_set_rec. fuel%lib!spec.utils.seq_to_set. fuel%lib!spec.utils.map_new_rec. fuel%lib!spec.utils.map_contains_value. fuel%lib!spec.utils.range. fuel%lib!spec.utils.rangeincl.))
...
(declare-fun lib!spec.utils.seq_to_set_rec.? (Dcr Type Poly) Poly)
(declare-fun lib!spec.utils.rec%seq_to_set_rec.? (Dcr Type Poly Fuel) Poly)
...
(declare-fun lib!spec.utils.range.? (Poly Poly Poly) Bool)
...
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (req%vstd!seq_lib.impl&%0.drop_last. A&. A& self!) (=> %%global_location_label%%27 (>= (vstd!seq.Seq.len.? A&. A& self!) 1))) :pattern ((req%vstd!seq_lib.impl&%0.drop_last. A&. A& self!)) )))
...
(assert (forall ((A&. Dcr) (A& Type) (self! Poly)) (! (= (req%vstd!seq.Seq.last. A&. A& self!) (=> %%global_location_label%%28 (< 0 (vstd!seq.Seq.len.? A&. A& self!)))) :pattern ((req%vstd!seq.Seq.last. A&. A& self!)) )))
...
(declare-fun req%lib!spec.utils.seq_to_set_rec. (Dcr Type Poly) Bool)
(declare-const %%global_location_label%%46 Bool)
(assert (forall ((A&. Dcr) (A& Type) (seq! Poly)) (! (= (req%lib!spec.utils.seq_to_set_rec. A&. A& seq!) (=> %%global_location_label%%46 (>= (vstd!seq.Seq.len.? A&. A& seq!) 0))) :pattern ((req%lib!spec.utils.seq_to_set_rec. A&. A& seq!)) )))
(assert (fuel_bool_default fuel%lib!spec.utils.seq_to_set_rec.))
(declare-const fuel_nat%lib!spec.utils.seq_to_set_rec. Fuel)
(assert (forall ((A&. Dcr) (A& Type) (seq! Poly) (fuel% Fuel)) (! (= (lib!spec.utils.rec%seq_to_set_rec.? A&. A& seq! fuel%) (lib!spec.utils.rec%seq_to_set_rec.? A&. A& seq! zero)) :pattern ((lib!spec.utils.rec%seq_to_set_rec.? A&. A& seq! fuel%)) )))
(assert (forall ((A&. Dcr) (A& Type) (seq! Poly) (fuel% Fuel)) (! (=> (and (has_type seq! (TYPE%vstd!seq.Seq. A&. A&)) (>= (vstd!seq.Seq.len.? A&. A& seq!) 0)) (= (lib!spec.utils.rec%seq_to_set_rec.? A&. A& seq! (succ fuel%)) (ite (= (vstd!seq.Seq.len.? A&. A& seq!) 0) (vstd!set.impl&%0.empty.? A&. A&) (vstd!set.impl&%0.insert.? A&. A& (lib!spec.utils.rec%seq_to_set_rec.? A&. A& (vstd!seq_lib.impl&%0.drop_last.? A&. A& seq!) fuel%) (vstd!seq.Seq.last.? A&. A& seq!))))) :pattern ((lib!spec.utils.rec%seq_to_set_rec.? A&. A& seq! (succ fuel%))) )))
(assert (=> (fuel_bool fuel%lib!spec.utils.seq_to_set_rec.) (forall ((A&. Dcr) (A& Type) (seq! Poly)) (! (=> (and (has_type seq! (TYPE%vstd!seq.Seq. A&. A&)) (>= (vstd!seq.Seq.len.? A&. A& seq!) 0)) (= (lib!spec.utils.seq_to_set_rec.? A&. A& seq!) (lib!spec.utils.rec%seq_to_set_rec.? A&. A& seq! (succ fuel_nat%lib!spec.utils.seq_to_set_rec.)))) :pattern ((lib!spec.utils.seq_to_set_rec.? A&. A& seq!)) ))))
(assert (forall ((A&. Dcr) (A& Type) (seq! Poly)) (! (=> (has_type seq! (TYPE%vstd!seq.Seq. A&. A&)) (has_type (lib!spec.utils.seq_to_set_rec.? A&. A& seq!) (TYPE%vstd!set.Set. A&. A&))) :pattern ((lib!spec.utils.seq_to_set_rec.? A&. A& seq!)) )))
...
(assert (forall ((V&. Dcr) (V& Type) (dom! Poly) (val! Poly)) (! (= (req%lib!spec.utils.map_new_rec. V&. V& dom! val!) (=> %%global_location_label%%47 (>= (%I dom!) 0))) :pattern ((req%lib!spec.utils.map_new_rec. V&. V& dom! val!)) )))
...
(assert (fuel_bool_default fuel%lib!spec.utils.range.))
(assert (=> (fuel_bool fuel%lib!spec.utils.range.) (forall ((low! Poly) (mid! Poly) (high! Poly)) (! (= (lib!spec.utils.range.? low! mid! high!) (and (<= (%I low!) (%I mid!)) (< (%I mid!) (%I high!)))) :pattern ((lib!spec.utils.range.? low! mid! high!)) ))))
...
(declare-const dom! Int)
(declare-const val! Poly)
(declare-const sub_dom@ Int)
(declare-const sub_map@ Poly)
(declare-const decrease%init0 Int)
(assert fuel_defaults)
(assert (<= 0 dom!))
(assert (has_type val! V&))
...
(assert (not (=> (= decrease%init0 dom!) (or (and (=> (= dom! 0) %%switch_label%%0) (=> (not (= dom! 0)) (=> (= sub_dom@ (nClip (Sub dom! 1))) (=> (= sub_map@ (lib!spec.utils.map_new_rec.? V&. V& (I sub_dom@) val!)) (and (and (=> %%location_label%%0 (check_decrease_int (let ((dom!$0 sub_dom@) (val!$1 val!)) dom!$0) decrease%init0 false)) (=> (ens%lib!spec.utils.map_new_rec_dom_finite. V&. V& sub_dom@ val!) (=> %%location_label%%1 (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@))))) (=> (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@)) (and (and (=> %%location_label%%2 (check_decrease_int (let ((dom!$0 sub_dom@) (val!$1 val!)) dom!$0) decrease%init0 false)) (=> (ens%lib!spec.utils.map_new_rec_dom_finite. V&. V& sub_dom@ val!) (=> %%location_label%%3 (forall ((n$ Poly)) (! (=> (has_type n$ NAT) (= (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@) n$) (and (<= 0 (%I n$)) (<= (%I n$) sub_dom@)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@) n$)) ))))) (=> (forall ((n$ Poly)) (! (=> (has_type n$ NAT) (= (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@) n$) (and (<= 0 (%I n$)) (<= (%I n$) sub_dom@)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@) n$)) )) (and (and (=> %%location_label%%4 (check_decrease_int (let ((dom!$0 sub_dom@) (val!$1 val!)) dom!$0) decrease%init0 false)) (=> (ens%lib!spec.utils.map_new_rec_dom_finite. V&. V& sub_dom@ val!) (=> %%location_label%%5 (forall ((n$ Poly)) (! (=> (has_type n$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@) n$) (= (vstd!map.impl&%0.index.? $ NAT V&. V& sub_map@ n$) val!))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@) n$)) ))))) (=> (forall ((n$ Poly)) (! (=> (has_type n$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@) n$) (= (vstd!map.impl&%0.index.? $ NAT V&. V& sub_map@ n$) val!))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& sub_map@) n$)) )) %%switch_label%%0)))))))))) (and (not %%switch_label%%0) (and (=> %%location_label%%6 (vstd!set.impl&%0.finite.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& (lib!spec.utils.map_new_rec.? V&. V& (I dom!) val!)))) (and (=> %%location_label%%7 (forall ((n$ Poly)) (! (=> (has_type n$ NAT) (= (and (<= 0 (%I n$)) (<= (%I n$) dom!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& (lib!spec.utils.map_new_rec.? V&. V& (I dom!) val!)) n$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& (lib!spec.utils.map_new_rec.? V&. V& (I dom!) val!)) n$)) ))) (=> %%location_label%%8 (forall ((n$ Poly)) (! (=> (has_type n$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& (lib!spec.utils.map_new_rec.? V&. V& (I dom!) val!)) n$) (= (vstd!map.impl&%0.index.? $ NAT V&. V& (lib!spec.utils.map_new_rec.? V&. V& (I dom!) val!) n$) val!))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT V&. V& (lib!spec.utils.map_new_rec.? V&. V& (I dom!) val!)) n$)) ))))))))))
(check-sat)
(exit)

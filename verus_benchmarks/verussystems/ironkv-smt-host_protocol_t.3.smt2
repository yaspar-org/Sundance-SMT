...
(assert (=> (fuel_bool fuel%lib!host_protocol_t.valid_optional_value.) (forall ((ov! Poly)) (! (= (lib!host_protocol_t.valid_optional_value.? ov!) (=> (not ((_ is core!option.Option./None) (%Poly%core!option.Option. ov!))) (let ((value$ (%Poly%vstd!seq.Seq<u8.>. (core!option.Option./Some/0 (%Poly%core!option.Option. ov!))))) (lib!app_interface_t.valid_value.? (Poly%vstd!seq.Seq<u8.>. value$))))) :pattern ((lib!host_protocol_t.valid_optional_value.? ov!)) ))))
...
(declare-const seqno! Poly)
(declare-const k! Poly)
(declare-const sm! Poly)
(declare-const m! Poly)
(declare-const out! Poly)
(declare-const should_send! Poly)
(declare-const tmp%1 Poly)
(declare-const owner@ lib!abstract_end_point_t.AbstractEndPoint.)
...
(assert (has_type seqno! NAT))
(assert (has_type k! TYPE%lib!keys_t.SHTKey.))
(assert (has_type sm! (TYPE%lib!single_message_t.SingleMessage. $ TYPE%lib!message_t.Message.)))
(assert (has_type m! TYPE%lib!message_t.Message.))
(assert (has_type out! (TYPE%vstd!set.Set. $ TYPE%lib!network_t.Packet.)))
(assert (has_type should_send! BOOL))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (lib!delegation_map_t.impl&%0.is_complete.? (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (=> (= tmp%1 (Poly%lib!delegation_map_t.AbstractDelegationMap. (lib!host_protocol_t.AbstractHostState./AbstractHostState/delegation_map (%Poly%lib!host_protocol_t.AbstractHostState. pre!)))) (=> %%location_label%%0 (req%lib!delegation_map_t.impl&%0.spec_index. tmp%1 k!))))))
(check-sat)
(exit)

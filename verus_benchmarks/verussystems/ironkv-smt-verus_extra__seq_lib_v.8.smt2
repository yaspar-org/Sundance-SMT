...
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4 Poly) (%%hole%%5 Poly) (s$ Poly)) (! (= (%%apply%%0 (%%lambda%%7 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) s$) (vstd!seq_lib.impl&%0.fold_left.? %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 s$ %%hole%%4 %%hole%%5)) :pattern ((%%apply%%0 (%%lambda%%7 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) s$)))))
...
(assert (not (=> (= decrease%init0 (nClip (Add (vstd!seq.Seq.len.? A&. A& s1!) (vstd!seq.Seq.len.? A&. A& s2!)))) (=> (= e@ (vstd!seq.Seq.empty.? B&. B&)) (=> (= af@ (mk_fun (%%lambda%%5 f! B&. B&))) (=> (= fl@ (mk_fun (%%lambda%%7 A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) e@ (Poly%fun%2. af@)))) (or (and (=> (= (vstd!seq.Seq.len.? A&. A& s2!) 0) (=> (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq.Seq.add.? A&. A& s1! s2!) s1!)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. B&. B&) (%%apply%%0 fl@ s1!) (vstd!seq.Seq.add.? B&. B& (%%apply%%0 fl@ s1!) e@))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%0))))))) (=> (not (= (vstd!seq.Seq.len.? A&. A& s2!) 0)) (=> (= tmp%3 (vstd!seq_lib.impl&%0.drop_last.? A&. A& s2!)) (and (=> %%location_label%%2 (check_decrease_int (let ((s1!$0 s1!) (s2!$1 tmp%3) (f!$2 f!)) (nClip (Add (vstd!seq.Seq.len.? A&. A& s1!$0) (vstd!seq.Seq.len.? A&. A& s2!$1)))) decrease%init0 false)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_fold_left_append_merge. A&. A& B&. B& s1! tmp%3 f!) (=> (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq_lib.impl&%0.drop_last.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!)) (vstd!seq.Seq.add.? A&. A& s1! (vstd!seq_lib.impl&%0.drop_last.? A&. A& s2!)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. B&. B&) (vstd!seq.Seq.add.? B&. B& (vstd!seq.Seq.add.? B&. B& (%%apply%%0 fl@ s1!) (%%apply%%0 fl@ (vstd!seq_lib.impl&%0.drop_last.? A&. A& s2!))) (%%apply%%0 f! (vstd!seq.Seq.last.? A&. A& s2!))) (vstd!seq.Seq.add.? B&. B& (%%apply%%0 fl@ s1!) (vstd!seq.Seq.add.? B&. B& (%%apply%%0 fl@ (vstd!seq_lib.impl&%0.drop_last.? A&. A& s2!)) (%%apply%%0 f! (vstd!seq.Seq.last.? A&. A& s2!)))))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 %%switch_label%%0))))))))))) (and (not %%switch_label%%0) (=> %%location_label%%5 (= (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) (vstd!seq.Seq.add.? A&. A& s1! s2!) (vstd!seq.Seq.empty.? B&. B&) (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))) (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s1! (vstd!seq.Seq.empty.? B&. B&) (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))) (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s2! (vstd!seq.Seq.empty.? B&. B&) (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&)))))))))))))))
(check-sat)
(exit)

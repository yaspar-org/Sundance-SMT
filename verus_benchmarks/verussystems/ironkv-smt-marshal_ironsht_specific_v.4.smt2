...
(assert (not (=> (= tmp%2 (I (lib!keys_t.SHTKey./SHTKey/ukey (%Poly%lib!keys_t.SHTKey. self!)))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) tmp%2)) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT 64) tmp%2 tmp%1) (=> (= %return! tmp%1) (=> %%location_label%%1 (= (%I %return!) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ TYPE%lib!keys_t.SHTKey. self!))))))))))
(check-sat)
(exit)

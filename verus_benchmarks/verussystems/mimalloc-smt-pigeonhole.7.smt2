...
(assert (<= 0 len!))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (= (and (<= 0 (%I i$)) (< (%I i$) (nClip (Add len! 1)))) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)) )))
(assert (forall ((i$ Poly)) (! (=> (has_type i$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$) (let ((tmp%%$ (%I (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) i$)))) (and (<= 0 tmp%%$) (< tmp%%$ len!))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) i$)) )))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%2 (nClip (Add len! 1))) (and (=> %%location_label%%0 (req%lib!pigeonhole.pigeonhole_missing_idx_implies_double. m! len! tmp%2)) (=> (ens%lib!pigeonhole.pigeonhole_missing_idx_implies_double. m! len! tmp%2 tmp%1) (=> (= r! tmp%1) (=> %%location_label%%1 (let ((i$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r!)))))) (let ((j$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r!)))))) (and (and (and (not (= i$ j$)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I i$))) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I j$))) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I i$)) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I j$)))))))))))))
(check-sat)
(exit)

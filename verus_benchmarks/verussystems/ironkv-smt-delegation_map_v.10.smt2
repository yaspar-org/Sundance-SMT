...
(declare-const v! lib!delegation_map_v.StrictlyOrderedVec.)
...
(assert (not (=> (ens%alloc!vec.impl&%0.new. K&. K& tmp%1) (=> (= v! (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec tmp%1)) (and (=> %%location_label%%0 (= (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. v!)) (vstd!seq.Seq.empty.? K&. K&))) (=> %%location_label%%1 (lib!delegation_map_v.impl&%1.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. v!))))))))
(check-sat)
(exit)

...
(assert (<= (Add (%I addr!) (%I num_bytes!)) (lib!pmem.pmemspec_t.impl&%6.len.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))))
(assert (lib!pmem.pmemspec_t.impl&%6.no_outstanding_writes_in_range.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!) addr! (I (Add (%I addr!) (%I num_bytes!)))))
(declare-const %%switch_label%%0 Bool)
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(assert (not (and (=> %%location_label%%0 (req%lib!pmem.linux_pmemfile_t.impl&%7.get_slice_at_offset. (%Poly%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!) (%I addr!) (%I num_bytes!))) (=> (ens%lib!pmem.linux_pmemfile_t.impl&%7.get_slice_at_offset. (%Poly%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!) (%I addr!) (%I num_bytes!) tmp%1) (=> (ens%core!result.impl&%26.branch. (REF $) (SLICE $ (UINT 8)) $ TYPE%lib!pmem.pmemspec_t.PmemError. tmp%1 tmp%%@) (or (and (=> ((_ is core!ops.control_flow.ControlFlow./Break) tmp%%@) (=> (= residual@ (%Poly%core!result.Result. (core!ops.control_flow.ControlFlow./Break/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@))))) (=> (ens%core!result.impl&%27.from_residual. $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) $ TYPE%lib!pmem.pmemspec_t.PmemError. $ TYPE%lib!pmem.pmemspec_t.PmemError. residual@ tmp%2) (=> (= %return! (Poly%core!result.Result. tmp%2)) (=> %%location_label%%1 (and ((_ is core!result.Result./Ok) (%Poly%core!result.Result. %return!)) (let ((bytes$$0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!result.Result./Ok/0 (%Poly%core!result.Result. %return!))))) (let ((t_bytes$$0 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) addr! (I (Add (%I addr!) (%I num_bytes!))))))) (let ((addrs$$0 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) num_bytes! (Poly%fun%1. (mk_fun (%%lambda%%2 (%I addr!)))))))) (ite (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) (= (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes$$0))) t_bytes$$0) (lib!pmem.pmemspec_t.maybe_corrupted.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes$$0)) (Poly%vstd!seq.Seq<u8.>. t_bytes$$0) (Poly%vstd!seq.Seq<int.>. addrs$$0)))))))))))) (=> (not ((_ is core!ops.control_flow.ControlFlow./Break) tmp%%@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= pm_slice@ (let ((val$ (%Poly%slice%<u8.>. (core!ops.control_flow.ControlFlow./Continue/0 (%Poly%core!ops.control_flow.ControlFlow. (Poly%core!ops.control_flow.ControlFlow. tmp%%@)))))) val$)) (=> (ens%lib!pmem.pmemspec_t.copy_from_slice. pm_slice@ unaligned_buffer@) (=> (= %return! (Poly%core!result.Result. (core!result.Result./Ok (Poly%alloc!vec.Vec<u8./allocator_global%.>. unaligned_buffer@)))) (=> %%location_label%%2 (and ((_ is core!result.Result./Ok) (%Poly%core!result.Result. %return!)) (let ((bytes$$0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!result.Result./Ok/0 (%Poly%core!result.Result. %return!))))) (let ((t_bytes$$0 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (lib!pmem.pmemspec_t.impl&%6.committed.? (lib!pmem.pmemspec_t.PersistentMemoryRegion.view.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) addr! (I (Add (%I addr!) (%I num_bytes!))))))) (let ((addrs$$0 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT) num_bytes! (Poly%fun%1. (mk_fun (%%lambda%%2 (%I addr!)))))))) (ite (lib!pmem.pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption (%Poly%lib!pmem.pmemspec_t.PersistentMemoryConstants. (lib!pmem.pmemspec_t.PersistentMemoryRegion.constants.? $ TYPE%lib!pmem.linux_pmemfile_t.FileBackedPersistentMemoryRegion. self!))) (= (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes$$0))) t_bytes$$0) (lib!pmem.pmemspec_t.maybe_corrupted.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes$$0)) (Poly%vstd!seq.Seq<u8.>. t_bytes$$0) (Poly%vstd!seq.Seq<int.>. addrs$$0))))))))))))))))))
(check-sat)
(exit)

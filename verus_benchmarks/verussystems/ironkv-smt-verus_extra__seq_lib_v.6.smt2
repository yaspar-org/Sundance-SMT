...
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? A&. A& s!)) (=> (= tmp%1 (mk_fun (%%lambda%%5 f! B&. B&))) (=> (ens%vstd!seq_lib.impl&%0.lemma_fold_left_alt. A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s! prefix! tmp%1) (=> (= tmp%2 (vstd!seq.Seq.len.? B&. B& prefix!)) (=> (= tmp%3 (mk_fun (%%lambda%%3 f! B&. B&))) (=> (ens%vstd!seq_lib.impl&%0.lemma_fold_left_alt. A&. A& $ INT s! (I tmp%2) tmp%3) (or (and (=> (not (= (vstd!seq.Seq.len.? A&. A& s!) 0)) (=> (= tmp%4 (vstd!seq.Seq.subrange.? A&. A& s! (I 1) (I (vstd!seq.Seq.len.? A&. A& s!)))) (=> (= tmp%5 (vstd!seq.Seq.add.? B&. B& prefix! (%%apply%%0 f! (vstd!seq.Seq.index.? A&. A& s! (I 0))))) (and (=> %%location_label%%0 (check_decrease_int (let ((s!$0 tmp%4) (prefix!$1 tmp%5) (f!$2 f!)) (vstd!seq.Seq.len.? A&. A& s!$0)) decrease%init0 false)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_fold_left_append_len_int. A&. A& B&. B& tmp%4 tmp%5 f!) (=> (= tmp%6 (vstd!seq.Seq.subrange.? A&. A& s! (I 1) (I (vstd!seq.Seq.len.? A&. A& s!)))) (=> (= tmp%7 (vstd!seq.Seq.add.? B&. B& prefix! (%%apply%%0 f! (vstd!seq.Seq.index.? A&. A& s! (I 0))))) (=> (= tmp%8 (mk_fun (%%lambda%%5 f! B&. B&))) (=> (ens%vstd!seq_lib.impl&%0.lemma_fold_left_alt. A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) tmp%6 tmp%7 tmp%8) (=> (= tmp%9 (vstd!seq.Seq.subrange.? A&. A& s! (I 1) (I (vstd!seq.Seq.len.? A&. A& s!)))) (=> (= tmp%10 (Add (vstd!seq.Seq.len.? B&. B& prefix!) (vstd!seq.Seq.len.? B&. B& (%%apply%%0 f! (vstd!seq.Seq.index.? A&. A& s! (I 0)))))) (=> (= tmp%11 (mk_fun (%%lambda%%3 f! B&. B&))) (=> (ens%vstd!seq_lib.impl&%0.lemma_fold_left_alt. A&. A& $ INT tmp%9 (I tmp%10) tmp%11) %%switch_label%%0))))))))))))) (=> (not (not (= (vstd!seq.Seq.len.? A&. A& s!) 0))) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%1 (= (vstd!seq.Seq.len.? B&. B& (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ (TYPE%vstd!seq.Seq. B&. B&) s! prefix! (Poly%fun%2. (mk_fun (%%lambda%%5 f! B&. B&))))) (%I (vstd!seq_lib.impl&%0.fold_left.? A&. A& $ INT s! (I (vstd!seq.Seq.len.? B&. B& prefix!)) (Poly%fun%2. (mk_fun (%%lambda%%3 f! B&. B&)))))))))))))))))
(check-sat)
(exit)

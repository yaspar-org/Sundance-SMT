...
(assert (not (=> (ens%lib!marshal_v.Marshalable.deserialize. $ (UINT SZ) data! start! tmp%1) (=> (= tmp%%$1@ (%Poly%core!option.Option. tmp%1)) (or (and (=> ((_ is core!option.Option./None) tmp%%$1@) (=> (= %return! (Poly%core!option.Option. core!option.Option./None)) (=> %%location_label%%0 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!)))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) x$$0)) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) x$$0))))))))) (=> (not ((_ is core!option.Option./None) tmp%%$1@)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> (= tmp%%@ (let ((x$ (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%$1@)))))) x$)) (=> (= len@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= mid@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))))) (=> (= len$1@ (uClip SZ len@)) (=> (ens%alloc!vec.impl&%0.with_capacity. T&. T& len$1@ res@0) (=> (= i@0 0) (=> (= end@0 mid@) (=> (= emp@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.empty.? $ (UINT 8)))) (=> (= accf@ (mk_fun (%%lambda%%1 T&. T& $ (UINT 8)))) (=> (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) (I mid@) (I end@0)) (Poly%vstd!seq.Seq<u8.>. emp@))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (and (=> %%location_label%%2 (and (<= 0 i@0) (<= i@0 len$1@))) (and (=> %%location_label%%3 (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0))) (and (=> %%location_label%%4 (and (and (<= (%I start!) mid@) (<= mid@ end@0)) (<= end@0 (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))))) (and (=> %%location_label%%5 (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) (I mid@) (I end@0)) (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0) (Poly%vstd!seq.Seq<u8.>. emp@) (Poly%fun%2. accf@)))) (and (=> %%location_label%%6 (= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0)) i@0)) (and (=> %%location_label%%7 (= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I len$1@))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@0) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (Sub end@0 (%I start!)))) (and (=> %%location_label%%8 (= accf@ (mk_fun (%%lambda%%1 T&. T& $ (UINT 8))))) (=> (has_type res@1 (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL)) (=> (uInv SZ i@1) (=> (uInv SZ end@1) (=> (and (<= 0 i@1) (<= i@1 len$1@)) (=> (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)) (=> (and (and (<= (%I start!) mid@) (<= mid@ end@1)) (<= end@1 (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!)))) (=> (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) (I mid@) (I end@1)) (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (Poly%vstd!seq.Seq<u8.>. emp@) (Poly%fun%2. accf@))) (=> (= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)) i@1) (=> (= (Add (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I len$1@))) (%I (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1) (I 0) (Poly%fun%2. (mk_fun (%%lambda%%0 T&. T& $ (UINT 8))))))) (Sub end@1 (%I start!))) (=> (= accf@ (mk_fun (%%lambda%%1 T&. T& $ (UINT 8)))) (=> (not (< i@1 len$1@)) (and (=> (= tmp%11 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!))) (and (=> %%location_label%%9 (req%lib!verus_extra.seq_lib_v.lemma_seq_add_subrange. $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. tmp%11) (%I start!) mid@ end@1)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_seq_add_subrange. $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. tmp%11) (%I start!) mid@ end@1) (=> %%location_label%%10 (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end@1)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)))))) (=> (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end@1)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) res@1)) (=> (= %return! (Poly%core!option.Option. (core!option.Option./Some (Poly%tuple%2. (tuple%2./tuple%2 res@1 (I end@1)))))) (=> %%location_label%%11 (=> (and ((_ is core!option.Option./Some) (%Poly%core!option.Option. %return!)) ((_ is tuple%2./tuple%2) (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))) (let ((x$$0 (tuple%2./tuple%2/0 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!)))))) (let ((end$$0 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (core!option.Option./Some/0 (%Poly%core!option.Option. %return!))))))) (and (and (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) x$$0)) (and (<= (%I start!) end$$0) (<= end$$0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL data!)))) (= (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) data!) start! (I end$$0)) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) x$$0)))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)

...
(assert (has_type zero! B&))
(assert (has_type f! (TYPE%fun%2. B&. B& A&. A& B&. B&)))
(declare-const %%switch_label%%0 Bool)
(declare-const %%switch_label%%1 Bool)
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? A&. A& s!)) (or (and (=> (vstd!set.impl&%0.finite.? A&. A& s!) (or (and (=> (= (vstd!set.impl&%0.len.? A&. A& s!) 0) (=> (= tmp%3 zero!) %%switch_label%%1)) (=> (not (= (vstd!set.impl&%0.len.? A&. A& s!) 0)) (=> (= a@ (vstd!set.impl&%0.choose.? A&. A& s!)) (=> (= tmp%2 (vstd!set.impl&%0.remove.? A&. A& s! a@)) (and (=> %%location_label%%0 (check_decrease_int (let ((s!$0 tmp%2) (zero!$1 zero!) (f!$2 (%Poly%fun%2. f!))) (vstd!set.impl&%0.len.? A&. A& s!$0)) decrease%init0 false)) (=> (has_type tmp%1 B&) (=> (= tmp%1 (lib!verus_extra.set_lib_ext_v.set_fold.? A&. A& B&. B& (vstd!set.impl&%0.remove.? A&. A& s! a@) zero! f!)) (=> (= tmp%3 (%%apply%%1 (%Poly%fun%2. f!) (lib!verus_extra.set_lib_ext_v.set_fold.? A&. A& B&. B& (vstd!set.impl&%0.remove.? A&. A& s! a@) zero! f!) a@)) %%switch_label%%1)))))))) (and (not %%switch_label%%1) (=> (= tmp%4 tmp%3) %%switch_label%%0)))) (=> (not (vstd!set.impl&%0.finite.? A&. A& s!)) (=> (= tmp%4 zero!) %%switch_label%%0))) (not %%switch_label%%0)))))
(check-sat)
(exit)

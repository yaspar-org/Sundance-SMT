...
(declare-const prev_vals! vstd!set.Set<nat.>.)
(declare-const k! Int)
...
(declare-const tmp%7 vstd!set.Set<nat.>.)
(declare-const tmp%8 vstd!set.Set<nat.>.)
(declare-const new_prev_vals@ vstd!set.Set<nat.>.)
...
(assert (and (<= 0 k!) (< k! len!)))
(assert (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!)))
(assert (= (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!)) k!))
(assert (forall ((elt$ Poly)) (! (=> (has_type elt$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt$) (exists ((j$ Poly)) (! (and (has_type j$ NAT) (and (and (<= 0 (%I j$)) (< (%I j$) k!)) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) j$) elt$))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) j$)) )))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt$)) )))
(declare-fun %%choose%%1 (Type Int Int Dcr Type Dcr Type Poly Poly Dcr Type Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Dcr) (%%hole%%6 Type) (%%hole%%7 Poly) (%%hole%%8 Poly) (%%hole%%9 Dcr) (%%hole%%10 Type) (%%hole%%11 Dcr) (%%hole%%12 Type) (%%hole%%13 Poly)) (! (=> (exists ((j$ Poly)) (! (and (has_type j$ %%hole%%0) (and (and (<= %%hole%%1 (%I j$)) (< (%I j$) %%hole%%2)) (= (vstd!map.impl&%0.index.? %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 j$) %%hole%%8))) :pattern ((vstd!map.impl&%0.index.? %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 j$)) )) (exists ((j$ Poly)) (! (and (and (has_type j$ %%hole%%0) (and (and (<= %%hole%%1 (%I j$)) (< (%I j$) %%hole%%2)) (= (vstd!map.impl&%0.index.? %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 j$) %%hole%%8))) (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13) j$)) :pattern ((vstd!map.impl&%0.index.? %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13 j$))))) :pattern ((%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12 %%hole%%13)))))
...
(assert (not (=> (= decrease%init0 (Sub len! k!)) (or (and (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I k!))) (=> (= tmp%10 (let ((dup1$ (%I (as_type (%%choose%%1 NAT 0 k! $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I k!)) $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) NAT)))) dup1$)) %%switch_label%%0)) (=> (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I k!)))) (or (and (=> (< k! (Sub len! 1)) (=> (= tmp%2 (%Poly%vstd!set.Set<nat.>. (vstd!set.impl&%0.insert.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I k!))))) (=> (= tmp%3 (nClip (Add k! 1))) (and (=> %%location_label%%0 (check_decrease_int (let ((m!$0 m!) (missing!$1 missing!) (len!$2 len!) (prev_vals!$3 tmp%2) (k!$4 tmp%3)) (Sub len!$2 k!$4)) decrease%init0 false)) (and (=> %%location_label%%1 (req%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. m! missing! len! tmp%2 tmp%3)) (=> (ens%lib!pigeonhole.pigeonhole_missing_idx_implies_double_helper. m! missing! len! tmp%2 tmp%3 tmp%1) (=> (= tmp%9 tmp%1) %%switch_label%%1))))))) (=> (not (< k! (Sub len! 1))) (and (=> (has_type elt@ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt@) (=> (= j@ (%I (as_type (%%choose%%1 NAT 0 k! $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) elt@ $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) NAT))) (=> (= tmp%4 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I j@))) (and (=> %%location_label%%2 tmp%4) (=> tmp%4 (=> %%location_label%%3 (and (and (<= 0 (%I elt@)) (< (%I elt@) len!)) (not (= (%I elt@) missing!)))))))))) (=> (forall ((elt$ Poly)) (! (=> (has_type elt$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt$) (and (and (<= 0 (%I elt$)) (< (%I elt$) len!)) (not (= (%I elt$) missing!))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt$)) )) (=> (= new_prev_vals@ (%Poly%vstd!set.Set<nat.>. (vstd!set.impl&%0.insert.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I k!))))) (and (=> (has_type elt$1@ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. new_prev_vals@) elt$1@) (or (and (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt$1@) %%switch_label%%2) (=> (not (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. prev_vals!) elt$1@)) (=> (= tmp%5 (= elt$1@ (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I k!)))) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= tmp%6 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I k!))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 %%switch_label%%2)))))))) (and (not %%switch_label%%2) (=> %%location_label%%6 (and (and (<= 0 (%I elt$1@)) (< (%I elt$1@) len!)) (not (= (%I elt$1@) missing!)))))))) (=> (forall ((elt$ Poly)) (! (=> (has_type elt$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. new_prev_vals@) elt$) (and (and (<= 0 (%I elt$)) (< (%I elt$) len!)) (not (= (%I elt$) missing!))))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. new_prev_vals@) elt$)) )) (=> (= tmp%7 (%Poly%vstd!set.Set<nat.>. (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)))) (and (=> %%location_label%%7 (req%lib!pigeonhole.nat_set_size. tmp%7 len!)) (=> (ens%lib!pigeonhole.nat_set_size. tmp%7 len!) (=> (= tmp%8 (%Poly%vstd!set.Set<nat.>. (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)))) (and (=> %%location_label%%8 (req%lib!pigeonhole.set_mismatch. tmp%8 new_prev_vals@ missing!)) (=> (ens%lib!pigeonhole.set_mismatch. tmp%8 new_prev_vals@ missing!) (=> (= tmp%9 1) %%switch_label%%1)))))))))))))) (and (not %%switch_label%%1) (=> (= tmp%10 tmp%9) %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= dup2! tmp%10) (and (=> %%location_label%%9 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) (I dup2!))) (=> %%location_label%%10 (exists ((dup1$ Poly)) (! (and (has_type dup1$ NAT) (and (and (and (not (= (%I dup1$) dup2!)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!)) dup1$)) (and (<= 0 (%I dup1$)) (< (%I dup1$) len!))) (= (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) dup1$) (vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) (I dup2!))))) :pattern ((vstd!map.impl&%0.index.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. m!) dup1$)) ))))))))))
(check-sat)
(exit)

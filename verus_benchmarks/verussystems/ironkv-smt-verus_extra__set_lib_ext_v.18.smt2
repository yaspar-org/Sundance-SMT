...
(assert (not (and (=> %%location_label%%0 (req%lib!verus_extra.set_lib_ext_v.map_fold_ok. A&. A& B&. B& s! f!)) (=> (ens%lib!verus_extra.set_lib_ext_v.map_fold_ok. A&. A& B&. B& s! f!) (and (=> %%location_label%%1 (req%lib!verus_extra.set_lib_ext_v.map_fold_finite. A&. A& B&. B& s! f!)) (=> (ens%lib!verus_extra.set_lib_ext_v.map_fold_finite. A&. A& B&. B& s! f!) (=> %%location_label%%2 (vstd!set.impl&%0.finite.? B&. B& (vstd!set_lib.impl&%0.map.? A&. A& B&. B& s! (Poly%fun%1. f!))))))))))
(check-sat)
(exit)

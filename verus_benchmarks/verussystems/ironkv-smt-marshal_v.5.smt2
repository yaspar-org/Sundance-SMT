...
(assert (not (=> (= tmp%1 (%B (lib!marshal_v.Marshalable.is_marshalable.? $ (UINT SZ) (I (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL self!))))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (ens%alloc!vec.impl&%1.len. $ (UINT 8) $ ALLOCATOR_GLOBAL self! tmp%2) (and (=> %%location_label%%1 (req%lib!marshal_v.Marshalable.serialized_size. $ (UINT SZ) (I tmp%2))) (=> (ens%lib!marshal_v.Marshalable.serialized_size. $ (UINT SZ) (I tmp%2) tmp%3) (=> (ens%alloc!vec.impl&%1.len. $ (UINT 8) $ ALLOCATOR_GLOBAL self! tmp%4) (and (=> %%location_label%%2 (uInv SZ (Add (%I tmp%3) tmp%4))) (=> (= %return! (I (uClip SZ (Add (%I tmp%3) tmp%4)))) (=> %%location_label%%3 (= (%I %return!) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) self!)))))))))))))))
(check-sat)
(exit)

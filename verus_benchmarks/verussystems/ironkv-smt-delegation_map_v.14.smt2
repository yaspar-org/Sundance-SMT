...
(assert (< i! (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)))))
(declare-fun %%choose%%0 (Type Int Int Dcr Type Poly Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((n$1 Poly)) (! (and (has_type n$1 %%hole%%0) (and (and (<= %%hole%%1 (%I n$1)) (< (%I n$1) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 n$1) %%hole%%6))) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 n$1)) )) (exists ((n$1 Poly)) (! (and (and (has_type n$1 %%hole%%0) (and (and (<= %%hole%%1 (%I n$1)) (< (%I n$1) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 n$1) %%hole%%6))) (= (%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) n$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 n$1))))) :pattern ((%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
...
(assert (not (and (=> %%location_label%%0 (req%alloc!vec.impl&%1.remove. K&. K& $ ALLOCATOR_GLOBAL (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) i!)) (=> (has_type (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1) (TYPE%lib!delegation_map_v.StrictlyOrderedVec. K&. K&)) (=> (ens%alloc!vec.impl&%1.remove. K&. K& $ ALLOCATOR_GLOBAL (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) i! k@) (=> (= old_s@ (vstd!set.impl&%0.remove.? K&. K& (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) k@)) (=> (= new_s@ (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)))) (and (=> (has_type e@ K&) (=> (vstd!set.impl&%0.contains.? K&. K& old_s@ e@) (=> (= tmp%1 (vstd!set.impl&%0.contains.? K&. K& (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) e@)) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= n@ (%I (as_type (%%choose%%0 INT 0 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) e@ K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) INT))) (or (and (=> (< n@ i!) (=> (= tmp%2 (= (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) (I n@)) e@)) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 %%switch_label%%0)))) (=> (not (< n@ i!)) (=> (= tmp%3 (= (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) (I (Sub n@ 1))) e@)) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%4 (vstd!set.impl&%0.contains.? K&. K& new_s@ e@)))))))))) (=> (forall ((e$ Poly)) (! (=> (has_type e$ K&) (=> (vstd!set.impl&%0.contains.? K&. K& old_s@ e$) (vstd!set.impl&%0.contains.? K&. K& new_s@ e$))) :pattern ((vstd!set.impl&%0.contains.? K&. K& old_s@ e$)) :pattern ((vstd!set.impl&%0.contains.? K&. K& new_s@ e$)) )) (=> (= s1@ (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)))) (=> (= s2@ (vstd!set.impl&%0.remove.? K&. K& (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) k@)) (and (and (=> (has_type elem@ K&) (=> %%location_label%%5 (and (=> (vstd!set.impl&%0.contains.? K&. K& s1@ elem@) (vstd!set.impl&%0.contains.? K&. K& s2@ elem@)) (=> (vstd!set.impl&%0.contains.? K&. K& s2@ elem@) (vstd!set.impl&%0.contains.? K&. K& s1@ elem@))))) (=> (forall ((elem$ Poly)) (! (=> (has_type elem$ K&) (and (=> (vstd!set.impl&%0.contains.? K&. K& s1@ elem$) (vstd!set.impl&%0.contains.? K&. K& s2@ elem$)) (=> (vstd!set.impl&%0.contains.? K&. K& s2@ elem$) (vstd!set.impl&%0.contains.? K&. K& s1@ elem$)))) :pattern ((vstd!set.impl&%0.contains.? K&. K& s1@ elem$)) :pattern ((vstd!set.impl&%0.contains.? K&. K& s2@ elem$)) )) (=> (= tmp%4 (ext_eq false (TYPE%vstd!set.Set. K&. K&) s1@ s2@)) (and (=> %%location_label%%6 tmp%4) (=> tmp%4 (=> %%location_label%%7 (= s1@ s2@))))))) (=> (= s1@ s2@) (=> (= k! k@) (and (=> %%location_label%%8 (lib!delegation_map_v.impl&%1.valid.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) (and (=> %%location_label%%9 (= k! (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) (I i!)))) (and (=> %%location_label%%10 (= (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) (vstd!seq_lib.impl&%0.remove.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0)) (I i!)))) (=> %%location_label%%11 (= (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))) (vstd!set.impl&%0.remove.? K&. K& (vstd!seq_lib.impl&%0.to_set.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@0))) k!))))))))))))))))))))
(check-sat)
(exit)

...
(assert (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%tuple%2. T&. T& U&. U&) self! other!)))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(declare-const %%location_label%%2 Bool)
(declare-const %%location_label%%3 Bool)
(assert (not (=> (= tmp%1 (tuple%2./tuple%2/0 (%Poly%tuple%2. self!))) (=> (= tmp%2 (tuple%2./tuple%2/0 (%Poly%tuple%2. other!))) (and (=> %%location_label%%0 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%1 tmp%2)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%1 tmp%2) (=> (= tmp%3 (tuple%2./tuple%2/1 (%Poly%tuple%2. self!))) (=> (= tmp%4 (tuple%2./tuple%2/1 (%Poly%tuple%2. other!))) (and (=> %%location_label%%1 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. U&. U& tmp%3 tmp%4)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. U&. U& tmp%3 tmp%4) (and (=> %%location_label%%2 (= (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%tuple%2. T&. T& U&. U&) self!) (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%tuple%2. T&. T& U&. U&) other!))) (=> %%location_label%%3 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%tuple%2. T&. T& U&. U&) other!))))))))))))))
(check-sat)
(exit)

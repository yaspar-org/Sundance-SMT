...
(assert (has_type k! K&))
(assert (uInv SZ index@0))
(assert (uInv SZ tmp%1))
(assert (has_type tmp%2 (TYPE%alloc!vec.Vec. K&. K& $ ALLOCATOR_GLOBAL)))
...
(assert (not (=> (has_type (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1) (TYPE%lib!delegation_map_v.StrictlyOrderedVec. K&. K&)) (=> (and (<= 0 index@0) (<= index@0 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) index@0)) (lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) i$) k!)))) :pattern ((lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) i$) k!)) )) (=> (= tmp%2 (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)))) (=> (ens%alloc!vec.impl&%1.len. K&. K& $ ALLOCATOR_GLOBAL tmp%2 tmp%1) (or (and (=> (< index@0 tmp%1) (=> (= tmp%4 (lib!delegation_map_v.StrictlyOrderedVec./StrictlyOrderedVec/v (%Poly%lib!delegation_map_v.StrictlyOrderedVec. (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)))) (and (=> %%location_label%%0 (req%vstd!std_specs.vec.vec_index. K&. K& $ ALLOCATOR_GLOBAL tmp%4 index@0)) (=> (ens%vstd!std_specs.vec.vec_index. K&. K& $ ALLOCATOR_GLOBAL tmp%4 index@0 tmp%3) (and (=> %%location_label%%1 (req%lib!keys_t.KeyTrait.cmp. K&. K& tmp%3 k!)) (=> (ens%lib!keys_t.KeyTrait.cmp. K&. K& tmp%3 k! tmp%5) (=> (ens%lib!delegation_map_v.impl&%0.is_lt. (%Poly%lib!keys_t.Ordering. tmp%5) tmp%6) (=> (= tmp%7 tmp%6) %%switch_label%%0)))))))) (=> (not (< index@0 tmp%1)) (=> (= tmp%7 false) %%switch_label%%0))) (and (not %%switch_label%%0) (=> tmp%7 (and (=> %%location_label%%2 (uInv SZ (Add index@0 1))) (=> (= index@1 (uClip SZ (Add index@0 1))) (and (=> %%location_label%%3 (and (<= 0 index@1) (<= index@1 (vstd!seq.Seq.len.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)))))) (=> %%location_label%%4 (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) index@1)) (lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) i$) k!)))) :pattern ((lib!keys_t.KeyTrait.cmp_spec.? K&. K& (vstd!seq.Seq.index.? K&. K& (lib!delegation_map_v.impl&%1.view.? K&. K& (Poly%lib!delegation_map_v.StrictlyOrderedVec. self!@1)) i$) k!)) ))))))))))))))))
(check-sat)
(exit)

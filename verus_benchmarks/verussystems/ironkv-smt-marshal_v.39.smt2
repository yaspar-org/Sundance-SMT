...
(declare-const a1$1@ Poly)
(declare-const a2$1@ Poly)
(declare-const tmp%13 Poly)
(declare-const tmp%14 Poly)
(declare-const tmp%15 vstd!seq.Seq<u8.>.)
(declare-const f$1@ %%Function%%)
(declare-const veq@ %%Function%%)
...
(assert (%B (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self! other!)))
(declare-fun %%lambda%%17 (Dcr Type) %%Function%%)
(assert (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (x$ Poly) (y$ Poly)) (! (= (%%apply%%1 (%%lambda%%17 %%hole%%0 %%hole%%1) x$ y$) (lib!marshal_v.Marshalable.view_equal.? %%hole%%0 %%hole%%1 x$ y$)) :pattern ((%%apply%%1 (%%lambda%%17 %%hole%%0 %%hole%%1) x$ y$)))))
(declare-fun %%choose%%2 (Type Int Int Dcr Type Poly Poly Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((i$2 Poly)) (! (and (has_type i$2 %%hole%%0) (and (and (<= %%hole%%1 (%I i$2)) (< (%I i$2) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$2) %%hole%%6))) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 i$2)) )) (exists ((i$2 Poly)) (! (and (and (has_type i$2 %%hole%%0) (and (and (<= %%hole%%1 (%I i$2)) (< (%I i$2) %%hole%%2)) (= (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$2) %%hole%%6))) (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) i$2)) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 i$2))))) :pattern ((%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
(declare-fun %%choose%%3 (Type Int Int Dcr Type Poly Dcr Type Dcr Type Poly Dcr Type) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Dcr) (%%hole%%4 Type) (%%hole%%5 Poly) (%%hole%%6 Dcr) (%%hole%%7 Type) (%%hole%%8 Dcr) (%%hole%%9 Type) (%%hole%%10 Poly) (%%hole%%11 Dcr) (%%hole%%12 Type)) (! (=> (exists ((i$4 Poly)) (! (and (has_type i$4 %%hole%%0) (and (and (<= %%hole%%1 (%I i$4)) (< (%I i$4) %%hole%%2)) (not (%B (lib!marshal_v.Marshalable.is_marshalable.? %%hole%%6 %%hole%%7 (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$4)))))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? %%hole%%11 %%hole%%12 (vstd!seq.Seq.index.? %%hole%%8 %%hole%%9 %%hole%%10 i$4))) )) (exists ((i$4 Poly)) (! (and (and (has_type i$4 %%hole%%0) (and (and (<= %%hole%%1 (%I i$4)) (< (%I i$4) %%hole%%2)) (not (%B (lib!marshal_v.Marshalable.is_marshalable.? %%hole%%6 %%hole%%7 (vstd!seq.Seq.index.? %%hole%%3 %%hole%%4 %%hole%%5 i$4)))))) (= (%%choose%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12) i$4)) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? %%hole%%11 %%hole%%12 (vstd!seq.Seq.index.? %%hole%%8 %%hole%%9 %%hole%%10 i$4)))))) :pattern ((%%choose%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9 %%hole%%10 %%hole%%11 %%hole%%12)))))
...
(assert (not (=> (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0) (=> (= tmp%1 (= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (and (=> (has_type i@ INT) (=> (and (<= 0 (%I i@)) (< (%I i@) (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (=> (= tmp%2 (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) i@)) (=> (= tmp%3 (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) i@)) (and (=> %%location_label%%1 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%2 tmp%3)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%2 tmp%3) (=> %%location_label%%2 (and (= (lib!marshal_v.Marshalable.is_marshalable.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) i@)) (lib!marshal_v.Marshalable.is_marshalable.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) i@))) (= (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) i@)) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) i@))))))))))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (=> (and (<= 0 (%I i$)) (< (%I i$) (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))) (and (= (lib!marshal_v.Marshalable.is_marshalable.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) i$)) (lib!marshal_v.Marshalable.is_marshalable.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) i$))) (= (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) i$)) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) i$)))))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) i$)) (lib!marshal_v.Marshalable.ghost_serialize.? T&. T& (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) i$))) )) (=> (= veq@ (mk_fun (%%lambda%%17 T&. T&))) (and (=> (= tmp%4 (= (<= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (- (uHi SZ) 1)) (<= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)) (- (uHi SZ) 1)))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (or (and (=> (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) )) (and (=> (has_type y@ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) y@) (=> (= i$1@ (%I (as_type (%%choose%%2 INT 0 (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)) T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) y@ T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)) INT))) (=> (= tmp%5 (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I i$1@))) (=> (= tmp%6 (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) (I i$1@))) (and (=> %%location_label%%4 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%5 tmp%6)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%5 tmp%6) (=> %%location_label%%5 (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& y@)))))))))) (=> (forall ((y$ Poly)) (! (=> (has_type y$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) y$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& y$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& y$)) )) %%switch_label%%0))) (=> (not (forall ((x$ Poly)) (! (=> (has_type x$ T&) (=> (vstd!seq_lib.impl&%0.contains.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) x$) (%B (lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)))) :pattern ((lib!marshal_v.Marshalable.is_marshalable.? T&. T& x$)) ))) (=> (= i$3@ (%I (as_type (%%choose%%3 INT 0 (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) T&. T& T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) T&. T&) INT))) (=> (= tmp%7 (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I i$3@))) (=> (= tmp%8 (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) (I i$3@))) (and (=> %%location_label%%6 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%7 tmp%8)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& tmp%7 tmp%8) %%switch_label%%0))))))) (and (not %%switch_label%%0) (=> (= tmp%9 (= (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)))))) (vstd!seq.Seq.len.? $ (UINT 8) (lib!marshal_v.Marshalable.ghost_serialize.? $ (UINT SZ) (I (uClip SZ (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)))))))) (and (=> %%location_label%%7 tmp%9) (=> tmp%9 (=> (= f@ (mk_fun (%%lambda%%0 T&. T& $ (UINT 8)))) (and (=> (has_type b@ INT) (=> (has_type a1@ T&) (=> (has_type a2@ T&) (=> (%B (%%apply%%1 veq@ a1@ a2@)) (and (=> %%location_label%%8 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& a1@ a2@)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& a1@ a2@) (=> %%location_label%%9 (= (%%apply%%1 f@ b@ a1@) (%%apply%%1 f@ b@ a2@))))))))) (=> (forall ((b$ Poly) (a1$ Poly) (a2$ Poly)) (! (=> (and (has_type b$ INT) (has_type a1$ T&) (has_type a2$ T&)) (=> (%B (%%apply%%1 veq@ a1$ a2$)) (= (%%apply%%1 f@ b$ a1$) (%%apply%%1 f@ b$ a2$)))) :pattern ((%%apply%%1 veq@ a1$ a2$) (%%apply%%1 f@ b$ a1$)) )) (=> (= tmp%10 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (=> (= tmp%11 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)) (and (=> %%location_label%%10 (req%lib!verus_extra.seq_lib_v.lemma_fold_left_on_equiv_seqs. T&. T& $ INT tmp%10 tmp%11 veq@ (I 0) f@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_fold_left_on_equiv_seqs. T&. T& $ INT tmp%10 tmp%11 veq@ (I 0) f@) (=> (= tmp%12 (= (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (I 0) (Poly%fun%2. f@)) (vstd!seq_lib.impl&%0.fold_left.? T&. T& $ INT (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!) (I 0) (Poly%fun%2. f@)))) (and (=> %%location_label%%11 tmp%12) (=> tmp%12 (=> %%location_label%%12 (= (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!))))))))))))))))))))) (=> (= (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)) (and (=> (= f$1@ (mk_fun (%%lambda%%1 T&. T& $ (UINT 8)))) (and (=> (has_type b$1@ (TYPE%vstd!seq.Seq. $ (UINT 8))) (=> (has_type a1$1@ T&) (=> (has_type a2$1@ T&) (=> (%B (%%apply%%1 veq@ a1$1@ a2$1@)) (and (=> %%location_label%%13 (req%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& a1$1@ a2$1@)) (=> (ens%lib!marshal_v.Marshalable.lemma_same_views_serialize_the_same. T&. T& a1$1@ a2$1@) (=> %%location_label%%14 (= (%%apply%%1 f$1@ b$1@ a1$1@) (%%apply%%1 f$1@ b$1@ a2$1@))))))))) (=> (forall ((b$ Poly) (a1$ Poly) (a2$ Poly)) (! (=> (and (has_type b$ (TYPE%vstd!seq.Seq. $ (UINT 8))) (has_type a1$ T&) (has_type a2$ T&)) (=> (%B (%%apply%%1 veq@ a1$ a2$)) (= (%%apply%%1 f$1@ b$ a1$) (%%apply%%1 f$1@ b$ a2$)))) :pattern ((%%apply%%1 veq@ a1$ a2$) (%%apply%%1 f$1@ b$ a1$)) )) (=> (= tmp%13 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)) (=> (= tmp%14 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)) (=> (= tmp%15 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.empty.? $ (UINT 8)))) (and (=> %%location_label%%15 (req%lib!verus_extra.seq_lib_v.lemma_fold_left_on_equiv_seqs. T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) tmp%13 tmp%14 veq@ (Poly%vstd!seq.Seq<u8.>. tmp%15) f$1@)) (=> (ens%lib!verus_extra.seq_lib_v.lemma_fold_left_on_equiv_seqs. T&. T& $ (TYPE%vstd!seq.Seq. $ (UINT 8)) tmp%13 tmp%14 veq@ (Poly%vstd!seq.Seq<u8.>. tmp%15) f$1@) (=> %%location_label%%16 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!))))))))))) (=> (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)) (and (=> %%location_label%%17 (= (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (lib!marshal_v.Marshalable.is_marshalable.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!))) (=> %%location_label%%18 (= (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!) (lib!marshal_v.Marshalable.ghost_serialize.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) other!)))))))))))))))))
(check-sat)
(exit)

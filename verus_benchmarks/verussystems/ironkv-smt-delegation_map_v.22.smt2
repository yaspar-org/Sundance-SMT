...
(assert (not (=> (ens%lib!delegation_map_v.impl&%2.is_end. K&. K& self! tmp%1) (or (and (=> tmp%1 (=> (= tmp%8 true) %%switch_label%%0)) (=> (not tmp%1) (=> (= tmp%3 (lib!keys_t.KeyIterator./KeyIterator/k (%Poly%lib!keys_t.KeyIterator. (Poly%lib!keys_t.KeyIterator. self!)))) (=> (ens%core!option.impl&%0.as_ref. K&. K& tmp%3 tmp%2) (and (=> %%location_label%%0 (req%core!option.impl&%0.unwrap. (REF K&.) K& tmp%2)) (=> (ens%core!option.impl&%0.unwrap. (REF K&.) K& tmp%2 tmp%4) (=> (ens%lib!verus_extra.clone_v.VerusClone.clone. K&. K& tmp%4 tmp%5) (and (=> %%location_label%%1 (req%lib!keys_t.KeyTrait.cmp. K&. K& k! tmp%5)) (=> (ens%lib!keys_t.KeyTrait.cmp. K&. K& k! tmp%5 tmp%6) (=> (ens%lib!delegation_map_v.impl&%0.is_lt. (%Poly%lib!keys_t.Ordering. tmp%6) tmp%7) (=> (= tmp%8 tmp%7) %%switch_label%%0))))))))))) (and (not %%switch_label%%0) (=> (= b! tmp%8) (=> %%location_label%%2 (= b! (lib!delegation_map_v.impl&%2.above_spec.? K&. K& (Poly%lib!keys_t.KeyIterator. self!) k!)))))))))
(check-sat)
(exit)

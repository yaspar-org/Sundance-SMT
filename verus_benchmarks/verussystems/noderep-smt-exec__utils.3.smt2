...
(assert (not (=> (= decrease%init0 (Sub bools_end! bools_start!)) (=> (= bools_new@ (%Poly%vstd!seq.Seq<core!option.Option<nat.>.>. (vstd!seq.Seq.push.? $ (TYPE%core!option.Option. $ NAT) (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (Poly%core!option.Option. core!option.Option./None)))) (or (and (=> (= bools_end! bools_start!) (=> (= tmp%1 (lib!exec.utils.rids_match.? (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools_new@) (Poly%vstd!seq.Seq<nat.>. rids!) (I bools_start!) (I bools_end!) (I rids_start!) (I rids_end!))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (= bools_end! bools_start!)) (or (and (=> (%B (B ((_ is core!option.Option./Some) (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ NAT) (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (I (Sub bools_end! 1))))))) (=> (= tmp%2 (nClip (Sub bools_end! 1))) (=> (= tmp%3 (nClip (Sub rids_end! 1))) (and (=> %%location_label%%1 (check_decrease_int (let ((bools!$0 bools!) (rids!$1 rids!) (bools_start!$2 bools_start!) (bools_end!$3 tmp%2) (rids_start!$4 rids_start!) (rids_end!$5 tmp%3)) (Sub bools_end!$3 bools_start!$2)) decrease%init0 false)) (and (=> %%location_label%%2 (req%lib!exec.utils.rids_match_add_none. bools! rids! bools_start! tmp%2 rids_start! tmp%3)) (=> (ens%lib!exec.utils.rids_match_add_none. bools! rids! bools_start! tmp%2 rids_start! tmp%3) %%switch_label%%1)))))) (=> (not (%B (B ((_ is core!option.Option./Some) (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ NAT) (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (I (Sub bools_end! 1)))))))) (=> (= tmp%4 (nClip (Sub bools_end! 1))) (and (=> %%location_label%%3 (check_decrease_int (let ((bools!$0 bools!) (rids!$1 rids!) (bools_start!$2 bools_start!) (bools_end!$3 tmp%4) (rids_start!$4 rids_start!) (rids_end!$5 rids_end!)) (Sub bools_end!$3 bools_start!$2)) decrease%init0 false)) (and (=> %%location_label%%4 (req%lib!exec.utils.rids_match_add_none. bools! rids! bools_start! tmp%4 rids_start! rids_end!)) (=> (ens%lib!exec.utils.rids_match_add_none. bools! rids! bools_start! tmp%4 rids_start! rids_end!) %%switch_label%%1)))))) (and (not %%switch_label%%1) %%switch_label%%0)))) (and (not %%switch_label%%0) (=> %%location_label%%5 (lib!exec.utils.rids_match.? (vstd!seq.Seq.push.? $ (TYPE%core!option.Option. $ NAT) (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (Poly%core!option.Option. core!option.Option./None)) (Poly%vstd!seq.Seq<nat.>. rids!) (I bools_start!) (I bools_end!) (I rids_start!) (I rids_end!)))))))))
(check-sat)
(exit)

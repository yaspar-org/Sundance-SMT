...
(assert (not (and (=> (has_type s1@ (TYPE%vstd!seq.Seq. A&. A&)) (=> (has_type s2@ (TYPE%vstd!seq.Seq. A&. A&)) (=> (has_type f@ (TYPE%fun%1. A&. A& B&. B&)) (=> (ens%lib!verus_extra.set_lib_ext_v.seq_map_values_concat. A&. A& B&. B& s1@ s2@ (%Poly%fun%1. f@)) (=> %%location_label%%0 (= (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.add.? A&. A& s1@ s2@) f@) (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s1@ f@) (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s2@ f@)))))))) (=> (forall ((s1$ Poly) (s2$ Poly) (f$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!seq.Seq. A&. A&)) (has_type s2$ (TYPE%vstd!seq.Seq. A&. A&)) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (= (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.add.? A&. A& s1$ s2$) f$) (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s1$ f$) (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s2$ f$)))) :pattern ((vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.add.? A&. A& s1$ s2$) f$)) )) (=> %%location_label%%1 (forall ((s1$ Poly) (s2$ Poly) (f$ Poly)) (! (=> (and (has_type s1$ (TYPE%vstd!seq.Seq. A&. A&)) (has_type s2$ (TYPE%vstd!seq.Seq. A&. A&)) (has_type f$ (TYPE%fun%1. A&. A& B&. B&))) (= (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.add.? A&. A& s1$ s2$) f$) (vstd!seq.Seq.add.? B&. B& (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s1$ f$) (vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& s2$ f$)))) :pattern ((vstd!seq_lib.impl&%0.map_values.? A&. A& B&. B& (vstd!seq.Seq.add.? A&. A& s1$ s2$) f$)) )))))))
(check-sat)
(exit)

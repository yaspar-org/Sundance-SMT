...
(assert (not (=> (= tmp%1 (forall ((k$ Poly)) (! (=> (has_type k$ TYPE%lib!keys_t.SHTKey.) (=> (not (= k$ (lib!keys_t.KeyTrait.zero_spec.? $ TYPE%lib!keys_t.SHTKey.))) (lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? $ TYPE%lib!keys_t.SHTKey. (lib!keys_t.KeyTrait.zero_spec.? $ TYPE%lib!keys_t.SHTKey.) k$)))) :pattern ((lib!keys_t.KeyTrait.cmp_spec.? $ TYPE%lib!keys_t.SHTKey. (lib!keys_t.KeyTrait.zero_spec.? $ TYPE%lib!keys_t.SHTKey.) k$)) ))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (forall ((k$$0 Poly)) (! (=> (has_type k$$0 TYPE%lib!keys_t.SHTKey.) (=> (not (= k$$0 (lib!keys_t.KeyTrait.zero_spec.? $ TYPE%lib!keys_t.SHTKey.))) (lib!delegation_map_v.impl&%0.lt.? (lib!keys_t.KeyTrait.cmp_spec.? $ TYPE%lib!keys_t.SHTKey. (lib!keys_t.KeyTrait.zero_spec.? $ TYPE%lib!keys_t.SHTKey.) k$$0)))) :pattern ((lib!keys_t.KeyTrait.cmp_spec.? $ TYPE%lib!keys_t.SHTKey. (lib!keys_t.KeyTrait.zero_spec.? $ TYPE%lib!keys_t.SHTKey.) k$$0)) ))))))))
(check-sat)
(exit)

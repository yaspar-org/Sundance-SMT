...
(assert (not (and (=> %%location_label%%0 (and (<= 0 1) (< 1 8))) (=> (= x@ (uClip 8 (bitshr (I (lib!types.PageInner./PageInner/flags2 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!)))) (I 1)))) (=> (= tmp%1 (= x@ (uClip 8 (bitshr (I (lib!types.PageInner./PageInner/flags2 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!)))) (I 1))))) (and (=> %%location_label%%1 tmp%1) (=> tmp%1 (=> (= y@ (lib!types.PageInner./PageInner/flags2 (%Poly%lib!types.PageInner. (Poly%lib!types.PageInner. self!)))) (and (=> %%location_label%%2 true) (=> (<= (uClip 8 (bitshr (I y@) (I 1))) 127) (=> (= u! x@) (and (=> %%location_label%%3 (= u! (lib!flags.impl&%0.retire_expire.? (Poly%lib!types.PageInner. self!)))) (=> %%location_label%%4 (<= u! 127))))))))))))))
(check-sat)
(exit)

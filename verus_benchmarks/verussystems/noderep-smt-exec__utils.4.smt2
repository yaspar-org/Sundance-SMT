...
(assert (forall ((bools! vstd!seq.Seq<core!option.Option<nat.>.>.) (rids! vstd!seq.Seq<nat.>.) (bools_start! Int) (bools_end! Int) (rids_start! Int) (rids_end! Int)) (! (= (ens%lib!exec.utils.rids_match_pop. bools! rids! bools_start! bools_end! rids_start! rids_end!) (and (=> (= bools_end! bools_start!) (lib!exec.utils.rids_match.? (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (Poly%vstd!seq.Seq<nat.>. rids!) (I bools_start!) (I bools_end!) (I rids_start!) (I rids_end!))) (=> (> bools_end! bools_start!) (and (=> (%B (B ((_ is core!option.Option./Some) (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ NAT) (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (I bools_start!)))))) (and (and (< rids_start! rids_end!) (= (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. rids!) (I rids_start!)) (core!option.Option./Some/0 (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ NAT) (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (I bools_start!)))))) (lib!exec.utils.rids_match.? (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (Poly%vstd!seq.Seq<nat.>. rids!) (I (nClip (Add bools_start! 1))) (I bools_end!) (I (nClip (Add rids_start! 1))) (I rids_end!)))) (=> (%B (B ((_ is core!option.Option./None) (%Poly%core!option.Option. (vstd!seq.Seq.index.? $ (TYPE%core!option.Option. $ NAT) (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (I bools_start!)))))) (lib!exec.utils.rids_match.? (Poly%vstd!seq.Seq<core!option.Option<nat.>.>. bools!) (Poly%vstd!seq.Seq<nat.>. rids!) (I (nClip (Add bools_start! 1))) (I bools_end!) (I rids_start!) (I rids_end!))))))) :pattern ((ens%lib!exec.utils.rids_match_pop. bools! rids! bools_start! bools_end! rids_start! rids_end!)) )))

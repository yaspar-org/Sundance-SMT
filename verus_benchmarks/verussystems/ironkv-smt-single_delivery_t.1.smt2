...
(declare-const %return! lib!single_delivery_t.AckState.)
(declare-const src! Poly)
(declare-const send_state! Poly)
(declare-const tmp%1 Poly)
(declare-const tmp%2 Poly)
(assert fuel_defaults)
(assert (has_type src! TYPE%lib!abstract_end_point_t.AbstractEndPoint.))
(assert (has_type send_state! (TYPE%vstd!map.Map. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. MT&. MT&))))
(declare-const %%switch_label%%0 Bool)
(declare-const %%location_label%%0 Bool)
(assert (not (or (and (=> (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. MT&. MT&) send_state!) src!) (and (=> %%location_label%%0 (req%vstd!map.impl&%0.spec_index. $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. MT&. MT&) send_state! src!)) (=> (= tmp%1 (vstd!map.impl&%0.index.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. MT&. MT&) send_state! src!)) (=> (= tmp%2 tmp%1) %%switch_label%%0)))) (=> (not (vstd!set.impl&%0.contains.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. (vstd!map.impl&%0.dom.? $ TYPE%lib!abstract_end_point_t.AbstractEndPoint. $ (TYPE%lib!single_delivery_t.AckState. MT&. MT&) send_state!) src!)) (=> (= tmp%2 (Poly%lib!single_delivery_t.AckState. (lib!single_delivery_t.AckState./AckState (%I (I 0)) (vstd!seq.Seq.empty.? $ (TYPE%lib!single_message_t.SingleMessage. MT&. MT&))))) %%switch_label%%0))) (not %%switch_label%%0))))
(check-sat)
(exit)

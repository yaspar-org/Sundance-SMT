...
(assert (not (=> (= tmp%1 (tuple%2./tuple%2/0 (%Poly%tuple%2. self!))) (=> (= tmp%2 (tuple%2./tuple%2/0 (%Poly%tuple%2. other!))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. T&. T& tmp%1 tmp%2) (=> (= tmp%3 (tuple%2./tuple%2/1 (%Poly%tuple%2. self!))) (=> (= tmp%4 (tuple%2./tuple%2/1 (%Poly%tuple%2. other!))) (=> (ens%lib!marshal_v.Marshalable.lemma_view_equal_symmetric. U&. U& tmp%3 tmp%4) (=> %%location_label%%0 (= (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%tuple%2. T&. T& U&. U&) self! other!) (lib!marshal_v.Marshalable.view_equal.? $ (TYPE%tuple%2. T&. T& U&. U&) other! self!)))))))))))
(check-sat)
(exit)

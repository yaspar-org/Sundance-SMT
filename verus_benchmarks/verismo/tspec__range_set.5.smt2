...
(assert (not (=> (= s1@ (verismo!tspec.range_set.range_to_set.? (I f1!) (I n2!))) (=> (= s2@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.union.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I f1!) (I n1!))) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I (Add f1! n1!)) (I (nClip (Sub n2! n1!)))))))) (and (=> (has_type i@ INT) (=> %%location_label%%0 (= (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. s1@) i@) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. s2@) i@)))) (=> (forall ((i$ Poly)) (! (=> (has_type i$ INT) (= (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. s1@) i$) (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. s2@) i$))) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. s1@) i$)) :pattern ((vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. s2@) i$)) )) (and (=> %%location_label%%1 (ext_eq true (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I f1!) (I n2!))) (vstd!set.impl&%0.union.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I f1!) (I n1!))) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I (Add f1! n1!)) (I (nClip (Sub n2! n1!)))))))) (=> %%location_label%%2 (ext_eq true (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I f1!) (I n1!))) (vstd!set.impl&%0.difference.? $ INT (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I f1!) (I n2!))) (Poly%vstd!set.Set<int.>. (verismo!tspec.range_set.range_to_set.? (I (Add f1! n1!)) (I (nClip (Sub n2! n1!)))))))))))))))
(check-sat)
(exit)

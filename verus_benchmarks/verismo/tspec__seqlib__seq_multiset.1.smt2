...
(assert (not (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. T&. T& s1!) (and (and (=> (has_type a@ T&) (=> (= tmp%1 (= (vstd!seq_lib.impl&%0.contains.? T&. T& s1! a@) (> (vstd!multiset.impl&%0.count.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& s1!) a@) 0))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> %%location_label%%1 (= (vstd!seq_lib.impl&%0.contains.? T&. T& s1! a@) (vstd!set.impl&%0.contains.? T&. T& (vstd!multiset.impl&%0.dom.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& s1!)) a@))))))) (=> (forall ((a$ Poly)) (! (=> (has_type a$ T&) (= (vstd!seq_lib.impl&%0.contains.? T&. T& s1! a$) (vstd!set.impl&%0.contains.? T&. T& (vstd!multiset.impl&%0.dom.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& s1!)) a$))) :pattern ((vstd!seq_lib.impl&%0.contains.? T&. T& s1! a$)) )) (=> %%location_label%%2 (ext_eq true (TYPE%vstd!set.Set. T&. T&) (vstd!seq_lib.impl&%0.to_set.? T&. T& s1!) (vstd!multiset.impl&%0.dom.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& s1!)))))) (=> (ext_eq true (TYPE%vstd!set.Set. T&. T&) (vstd!seq_lib.impl&%0.to_set.? T&. T& s1!) (vstd!multiset.impl&%0.dom.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& s1!))) (=> %%location_label%%3 (= (vstd!seq_lib.impl&%0.to_set.? T&. T& s1!) (vstd!multiset.impl&%0.dom.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& s1!)))))))))
(check-sat)
(exit)

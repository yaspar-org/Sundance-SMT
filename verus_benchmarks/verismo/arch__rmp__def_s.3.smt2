...
(assert (forall ((x verismo!arch.entities.params.PageID.)) (! (=> ((_ is verismo!arch.entities.params.PageID./PageID) x) (height_lt (height (Poly%verismo!arch.addr_s.def_s.SpecPage. (verismo!arch.entities.params.PageID./PageID/page x))) (height (Poly%verismo!arch.entities.params.PageID. x)))) :pattern ((height (Poly%verismo!arch.addr_s.def_s.SpecPage. (verismo!arch.entities.params.PageID./PageID/page x)))) )))
...
(assert (forall ((x verismo!arch.rmp.def_s.RmpOp.)) (! (=> ((_ is verismo!arch.rmp.def_s.RmpOp./RmpAdjust) x) (height_lt (height (Poly%verismo!arch.entities.params.PageID. (verismo!arch.rmp.def_s.RmpOp./RmpAdjust/0 x))) (height (Poly%verismo!arch.rmp.def_s.RmpOp. x)))) :pattern ((height (Poly%verismo!arch.entities.params.PageID. (verismo!arch.rmp.def_s.RmpOp./RmpAdjust/0 x)))) )))
...
(assert (forall ((x verismo!arch.rmp.def_s.RmpOp.)) (! (=> ((_ is verismo!arch.rmp.def_s.RmpOp./Pvalidate) x) (height_lt (height (Poly%verismo!arch.entities.params.PageID. (verismo!arch.rmp.def_s.RmpOp./Pvalidate/0 x))) (height (Poly%verismo!arch.rmp.def_s.RmpOp. x)))) :pattern ((height (Poly%verismo!arch.entities.params.PageID. (verismo!arch.rmp.def_s.RmpOp./Pvalidate/0 x)))) )))
...
(assert (forall ((x verismo!arch.rmp.def_s.RmpOp.)) (! (=> ((_ is verismo!arch.rmp.def_s.RmpOp./RmpUpdate) x) (height_lt (height (Poly%verismo!arch.entities.params.PageID. (verismo!arch.rmp.def_s.RmpOp./RmpUpdate/0 x))) (height (Poly%verismo!arch.rmp.def_s.RmpOp. x)))) :pattern ((height (Poly%verismo!arch.entities.params.PageID. (verismo!arch.rmp.def_s.RmpOp./RmpUpdate/0 x)))) )))
...
(assert (=> (fuel_bool fuel%verismo!arch.rmp.def_s.impl&%7.is_Pvalidate.) (forall ((AddrT&. Dcr) (AddrT& Type) (self! Poly)) (! (= (verismo!arch.rmp.def_s.impl&%7.is_Pvalidate.? AddrT&. AddrT& self!) ((_ is verismo!arch.rmp.def_s.RmpOp./Pvalidate) (%Poly%verismo!arch.rmp.def_s.RmpOp. self!))) :pattern ((verismo!arch.rmp.def_s.impl&%7.is_Pvalidate.? AddrT&. AddrT& self!)) ))))

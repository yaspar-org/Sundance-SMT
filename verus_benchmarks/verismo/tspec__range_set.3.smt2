...
(assert (has_type (Poly%tuple%2. r1!) (TYPE%tuple%2. $ INT $ NAT)))
(assert (has_type (Poly%tuple%2. r2!) (TYPE%tuple%2. $ INT $ NAT)))
(declare-const %%location_label%%0 Bool)
(declare-const %%location_label%%1 Bool)
(assert (not (=> (= tmp%2 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r1!))))) (=> (= tmp%3 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r1!))))) (=> (= tmp%4 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!))))) (=> (= tmp%5 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!))))) (=> (ens%verismo!tspec.range_set.lemma_range_set_disjoint. tmp%2 tmp%3 tmp%4 tmp%5 tmp%1) (=> (= ret! tmp%1) (and (=> %%location_label%%0 (= ret! (verismo!tspec.range_set.range_disjoint_.? (Poly%tuple%2. r1!) (Poly%tuple%2. r2!)))) (=> %%location_label%%1 (= ret! (vstd!set.impl&%0.disjoint.? $ INT (Poly%vstd!set.Set<int.>. (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r1!)))) (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r1!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r1!))))))))))) (Poly%vstd!set.Set<int.>. (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1. $ INT $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!)))))))))))))))))))))))
(check-sat)
(exit)

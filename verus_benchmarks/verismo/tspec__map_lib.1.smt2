...
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Int) (j$ Poly)) (! (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) j$) (I (ite (< (%I j$) %%hole%%0) (%I j$) (ite (= (%I j$) %%hole%%1) %%hole%%3 (nClip (Sub (%I j$) %%hole%%2)))))) :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) j$)))))
(declare-fun %%lambda%%1 (Int Int) %%Function%%)
(assert (forall ((%%hole%%0 Int) (%%hole%%1 Int) (j$ Poly)) (! (= (%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1) j$) (B (and (<= %%hole%%0 (%I j$)) (< (%I j$) %%hole%%1)))) :pattern ((%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1) j$)))))
(declare-fun %%lambda%%2 (%%Function%%) %%Function%%)
(assert (forall ((%%hole%%0 %%Function%%) (j$ Poly)) (! (= (%%apply%%0 (%%lambda%%2 %%hole%%0) j$) (%%apply%%0 %%hole%%0 j$)) :pattern ((%%apply%%0 (%%lambda%%2 %%hole%%0) j$)))))
...
(assert (not (=> (= oldm@ m!@0) (=> (has_type m!@1 (TYPE%vstd!map.Map. $ NAT T&. T&)) (=> (ens%vstd!map.impl&%0.tracked_insert. $ NAT T&. T& m!@0 m!@1 (I n!) v!) (=> (= convert@ (mk_fun (%%lambda%%0 i! i! 1 n!))) (=> (= key_map@ (%Poly%vstd!map.Map<nat./nat.>. (vstd!map.impl&%0.new.? $ NAT $ NAT $ (TYPE%fun%1. $ NAT $ BOOL) $ (TYPE%fun%1. $ NAT $ NAT) (Poly%fun%1. (mk_fun (%%lambda%%1 0 (nClip (Add n! 1))))) (Poly%fun%1. (mk_fun (%%lambda%%2 convert@)))))) (and (=> (has_type j@ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. key_map@)) j@) (or (and (=> (< (%I j@) i!) (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT T&. T& oldm@) j@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%1)))) (=> (not (< (%I j@) i!)) %%switch_label%%1)) (and (not %%switch_label%%1) (or (and (=> (> (%I j@) i!) (=> (= tmp%2 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT T&. T& oldm@) (I (nClip (Sub (%I j@) 1))))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 %%switch_label%%0)))) (=> (not (> (%I j@) i!)) %%switch_label%%0)) (and (not %%switch_label%%0) (=> %%location_label%%2 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT T&. T& m!@1) (%%apply%%0 convert@ j@))))))))) (=> (forall ((j$ Poly)) (! (=> (has_type j$ NAT) (=> (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. key_map@)) j$) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT T&. T& m!@1) (%%apply%%0 convert@ j$)))) :pattern ((vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT $ NAT (Poly%vstd!map.Map<nat./nat.>. key_map@)) j$)) )) (and (=> %%location_label%%3 (req%vstd!map.impl&%1.tracked_map_keys_in_place. $ NAT T&. T& m!@1 (Poly%vstd!map.Map<nat./nat.>. key_map@))) (=> (has_type m!@2 (TYPE%vstd!map.Map. $ NAT T&. T&)) (=> (ens%vstd!map.impl&%1.tracked_map_keys_in_place. $ NAT T&. T& m!@1 m!@2 (Poly%vstd!map.Map<nat./nat.>. key_map@)) (and (=> %%location_label%%4 (= (vstd!map.impl&%0.index.? $ NAT T&. T& m!@2 (I i!)) v!)) (and (=> %%location_label%%5 (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT T&. T& m!@2) (I i!))) (and (=> %%location_label%%6 (forall ((k$ Poly)) (! (=> (has_type k$ NAT) (=> (< (%I k$) i!) (and (= (vstd!map.impl&%0.index.? $ NAT T&. T& m!@2 k$) (vstd!map.impl&%0.index.? $ NAT T&. T& m!@0 k$)) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT T&. T& m!@2) k$)))) :pattern ((vstd!map.impl&%0.index.? $ NAT T&. T& m!@2 k$)) :pattern ((vstd!map.impl&%0.index.? $ NAT T&. T& m!@0 k$)) ))) (=> %%location_label%%7 (forall ((k$ Poly)) (! (=> (has_type k$ NAT) (=> (and (<= (nClip (Add i! 1)) (%I k$)) (< (%I k$) (nClip (Add n! 1)))) (and (= (vstd!map.impl&%0.index.? $ NAT T&. T& m!@2 k$) (vstd!map.impl&%0.index.? $ NAT T&. T& m!@0 (I (nClip (Sub (%I k$) 1))))) (vstd!set.impl&%0.contains.? $ NAT (vstd!map.impl&%0.dom.? $ NAT T&. T& m!@2) k$)))) :pattern ((vstd!map.impl&%0.index.? $ NAT T&. T& m!@2 k$)) ))))))))))))))))))
(check-sat)
(exit)

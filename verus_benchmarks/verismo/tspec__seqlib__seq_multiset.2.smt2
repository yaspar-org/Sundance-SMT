...
(declare-const middle@ Poly)
(declare-const left2@ Poly)
(declare-const right@ Poly)
(assert fuel_defaults)
(assert (has_type s1! (TYPE%vstd!seq.Seq. A&. A&)))
(assert (has_type v! A&))
(assert (and (<= 0 i!) (<= i! (vstd!seq.Seq.len.? A&. A& s1!))))
...
(assert (not (=> (= s2@ (vstd!seq_lib.impl&%0.insert.? A&. A& s1! (I i!) v!)) (=> (= left@ (vstd!seq.Seq.subrange.? A&. A& s1! (I 0) (I i!))) (=> (= middle@ (vstd!seq.Seq.push.? A&. A& (vstd!seq.Seq.empty.? A&. A&) v!)) (=> (= left2@ (vstd!seq.Seq.add.? A&. A& left@ middle@)) (=> (= right@ (vstd!seq.Seq.subrange.? A&. A& s1! (I i!) (I (vstd!seq.Seq.len.? A&. A& s1!)))) (=> (= tmp%1 (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s1! (vstd!seq.Seq.add.? A&. A& left@ right@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s2@ (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.add.? A&. A& left@ middle@) right@))) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s2@ (vstd!seq.Seq.add.? A&. A& left2@ right@))) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (or (and (=> (< i! (vstd!seq.Seq.len.? A&. A& s1!)) (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. A&. A& left@) (=> (ens%vstd!seq_lib.lemma_multiset_commutative. A&. A& left@ middle@) (=> (ens%vstd!seq_lib.lemma_multiset_commutative. A&. A& left2@ right@) (=> (ens%vstd!seq_lib.lemma_seq_union_to_multiset_commutative. A&. A& left2@ right@) (=> (ens%vstd!seq_lib.lemma_seq_union_to_multiset_commutative. A&. A& left@ right@) (=> (= tmp%4 (vstd!seq.Seq.add.? A&. A& left@ right@)) (=> (ens%vstd!seq_lib.lemma_multiset_commutative. A&. A& tmp%4 middle@) (=> (ens%vstd!seq_lib.lemma_multiset_commutative. A&. A& left@ right@) (=> (= tmp%5 (vstd!seq.Seq.add.? A&. A& left@ right@)) (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. A&. A& tmp%5) (=> (= tmp%6 (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq.Seq.add.? A&. A& left@ right@) s1!)) (and (=> %%location_label%%3 tmp%6) (=> tmp%6 (=> (= tmp%7 (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) (vstd!seq.Seq.add.? A&. A& s1! middle@) (vstd!seq.Seq.push.? A&. A& s1! v!))) (and (=> %%location_label%%4 tmp%7) (=> tmp%7 (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. A&. A& s1!) (=> (= tmp%8 (ext_eq false (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s2@) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& (vstd!seq.Seq.add.? A&. A& left2@ right@)))) (and (=> %%location_label%%5 tmp%8) (=> tmp%8 (=> (= tmp%9 (ext_eq false (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& (vstd!seq.Seq.add.? A&. A& left2@ right@)) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& (vstd!seq.Seq.add.? A&. A& right@ left2@)))) (and (=> %%location_label%%6 tmp%9) (=> tmp%9 (=> (= tmp%10 (ext_eq false (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& left2@) (vstd!multiset.impl&%0.add.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& left@) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& middle@)))) (and (=> %%location_label%%7 tmp%10) (=> tmp%10 (=> (= tmp%11 (ext_eq true (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& (vstd!seq.Seq.add.? A&. A& right@ left2@)) (vstd!multiset.impl&%0.add.? A&. A& (vstd!multiset.impl&%0.add.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& right@) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& left@)) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& middle@)))) (and (=> %%location_label%%8 tmp%11) (=> tmp%11 (=> (= tmp%12 (ext_eq true (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!multiset.impl&%0.add.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s1!) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& middle@)) (vstd!multiset.impl&%0.add.? A&. A& (vstd!multiset.impl&%0.add.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& right@) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& left@)) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& middle@)))) (and (=> %%location_label%%9 tmp%12) (=> tmp%12 (=> (= tmp%13 (ext_eq false (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s2@) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& (vstd!seq.Seq.add.? A&. A& (vstd!seq.Seq.add.? A&. A& left@ right@) middle@)))) (and (=> %%location_label%%10 tmp%13) (=> tmp%13 %%switch_label%%0)))))))))))))))))))))))))))))))))))) (=> (not (< i! (vstd!seq.Seq.len.? A&. A& s1!))) (=> (= tmp%14 (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s2@ (vstd!seq.Seq.push.? A&. A& s1! v!))) (and (=> %%location_label%%11 tmp%14) (=> tmp%14 (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. A&. A& s1!) (=> (= tmp%15 (ext_eq false (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& (vstd!seq_lib.impl&%0.insert.? A&. A& s1! (I i!) v!)) (vstd!multiset.impl&%0.insert.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s1!) v!))) (and (=> %%location_label%%12 tmp%15) (=> tmp%15 %%switch_label%%0))))))))) (and (not %%switch_label%%0) (=> %%location_label%%13 (= (vstd!seq_lib.impl&%0.to_multiset.? A&. A& (vstd!seq_lib.impl&%0.insert.? A&. A& s1! (I i!) v!)) (vstd!multiset.impl&%0.insert.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s1!) v!)))))))))))))))))))))
(check-sat)
(exit)

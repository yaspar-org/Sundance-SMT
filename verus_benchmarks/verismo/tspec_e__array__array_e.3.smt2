...
(assert (not (=> (ens%verismo!tspec_e.array.array_t.impl&%4.trusted_len. T&. T& N&. N& tmp%1) (=> (= ret! tmp%1) (=> %%location_label%%0 (= ret! (verismo!tspec_e.array.array_t.impl&%4.spec_len.? T&. T& N&. N&)))))))
(check-sat)
(exit)

...
(declare-fun ens%verismo!arch.entities.impl&%6.from_u64. (Int core!option.Option.) Bool)
(assert (forall ((val! Int) (ret! core!option.Option.)) (! (= (ens%verismo!arch.entities.impl&%6.from_u64. val! ret!) (and (has_type (Poly%core!option.Option. ret!) (TYPE%core!option.Option. $ TYPE%verismo!arch.entities.VMPL.)) (= ret! (verismo!arch.entities.impl&%6.spec_from_int.? (I val!))))) :pattern ((ens%verismo!arch.entities.impl&%6.from_u64. val! ret!)) )))
(declare-const ret! core!option.Option.)
(declare-const val! Int)
(assert fuel_defaults)
(assert (uInv 64 val!))
(declare-const %%location_label%%0 Bool)
(assert (not (=> (= ret! (ite (= val! 0) (core!option.Option./Some (Poly%verismo!arch.entities.VMPL. verismo!arch.entities.VMPL./VMPL0)) (ite (= val! 1) (core!option.Option./Some (Poly%verismo!arch.entities.VMPL. verismo!arch.entities.VMPL./VMPL1)) (ite (= val! 2) (core!option.Option./Some (Poly%verismo!arch.entities.VMPL. verismo!arch.entities.VMPL./VMPL2)) (ite (= val! 3) (core!option.Option./Some (Poly%verismo!arch.entities.VMPL. verismo!arch.entities.VMPL./VMPL3)) core!option.Option./None))))) (=> %%location_label%%0 (= ret! (verismo!arch.entities.impl&%6.spec_from_int.? (I val!)))))))
(check-sat)
(exit)

...
(assert (and (and (and (<= 0 start!) (<= start! j!)) (< j! end!)) (<= end! (vstd!seq.Seq.len.? T&. T& input!))))
...
(assert (not (=> (= v@ (vstd!seq.Seq.index.? T&. T& input! (I i!))) (=> (= u@ (vstd!seq.Seq.index.? T&. T& input! (I j!))) (=> (= tmp%1 (= (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& input! (I start!) (I end!)) (I (Sub i! start!))) v@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (= tmp%2 (= (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& input! (I start!) (I end!)) (I (Sub j! start!))) u@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (vstd!seq.Seq.index.? T&. T& input! (I i!))) (and (=> %%location_label%%2 (req%verismo!tspec_e.array.sort.proof_seq_update_in_subrange. T&. T& input! start! end! i! tmp%3)) (=> (ens%verismo!tspec_e.array.sort.proof_seq_update_in_subrange. T&. T& input! start! end! i! tmp%3) (=> (= tmp%4 (ext_eq true (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) v@) (I start!) (I end!)) (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.subrange.? T&. T& input! (I start!) (I end!)) (I (Sub i! start!)) v@))) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (vstd!seq.Seq.update.? T&. T& input! (I i!) v@)) (and (=> %%location_label%%4 (req%verismo!tspec_e.array.sort.proof_seq_update_in_subrange. T&. T& tmp%5 start! end! j! u@)) (=> (ens%verismo!tspec_e.array.sort.proof_seq_update_in_subrange. T&. T& tmp%5 start! end! j! u@) (=> (= tmp%6 (ext_eq true (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) v@) (I j!) u@) (I start!) (I end!)) (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) v@) (I start!) (I end!)) (I (Sub j! start!)) u@))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> (= tmp%7 (ext_eq true (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) v@) (I start!) (I end!)) (I (Sub j! start!)) u@) (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.subrange.? T&. T& input! (I start!) (I end!)) (I (Sub i! start!)) v@) (I (Sub j! start!)) u@))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> %%location_label%%7 (ext_eq true (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) (vstd!seq.Seq.index.? T&. T& input! (I j!))) (I j!) (vstd!seq.Seq.index.? T&. T& input! (I i!))) (I start!) (I end!)) (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.update.? T&. T& (vstd!seq.Seq.subrange.? T&. T& input! (I start!) (I end!)) (I (Sub i! start!)) (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& input! (I start!) (I end!)) (I (Sub j! start!)))) (I (Sub j! start!)) (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.? T&. T& input! (I start!) (I end!)) (I (Sub i! start!)))))))))))))))))))))))))))))))
(check-sat)
(exit)

...
(assert (has_type (Poly%fun%1. op!) (TYPE%fun%1. A&. A& B&. B&)))
(assert (= (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s1!) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s2!)))
(assert (= (vstd!seq.Seq.len.? A&. A& s1!) (vstd!seq.Seq.len.? A&. A& s2!)))
(declare-fun %%choose%%2 (Type Dcr Type Poly Poly Int Int Dcr Type Poly) Poly)
(assert (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4 Poly) (%%hole%%5 Int) (%%hole%%6 Int) (%%hole%%7 Dcr) (%%hole%%8 Type) (%%hole%%9 Poly)) (! (=> (exists ((i$1 Poly)) (! (and (has_type i$1 %%hole%%0) (and (= (vstd!seq.Seq.index.? %%hole%%1 %%hole%%2 %%hole%%3 i$1) %%hole%%4) (and (<= %%hole%%5 (%I i$1)) (< (%I i$1) %%hole%%6)))) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 i$1)) )) (exists ((i$1 Poly)) (! (and (and (has_type i$1 %%hole%%0) (and (= (vstd!seq.Seq.index.? %%hole%%1 %%hole%%2 %%hole%%3 i$1) %%hole%%4) (and (<= %%hole%%5 (%I i$1)) (< (%I i$1) %%hole%%6)))) (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9) i$1)) :pattern ((vstd!seq.Seq.index.? %%hole%%7 %%hole%%8 %%hole%%9 i$1))))) :pattern ((%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5 %%hole%%6 %%hole%%7 %%hole%%8 %%hole%%9)))))
...
(assert (not (=> (= decrease%init0 (vstd!seq.Seq.len.? A&. A& s1!)) (or (and (=> (> (vstd!seq.Seq.len.? A&. A& s1!) 0) (=> (= v@ (vstd!seq.Seq.last.? A&. A& s1!)) (=> (= ss1@ (vstd!seq_lib.impl&%0.drop_last.? A&. A& s1!)) (=> (= tmp%1 (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s1! (vstd!seq.Seq.push.? A&. A& ss1@ v@))) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. A&. A& s1!) (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. A&. A& s2!) (=> (= tmp%2 (= (vstd!seq.Seq.index.? A&. A& s1! (I (Sub (vstd!seq.Seq.len.? A&. A& s1!) 1))) v@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (vstd!seq_lib.impl&%0.contains.? A&. A& s1! v@)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 (=> (= tmp%4 (> (vstd!multiset.impl&%0.count.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s1!) v@) 0)) (and (=> %%location_label%%3 tmp%4) (=> tmp%4 (=> (= tmp%5 (vstd!seq_lib.impl&%0.contains.? A&. A& s2! v@)) (and (=> %%location_label%%4 tmp%5) (=> tmp%5 (=> (= i@ (%I (as_type (%%choose%%2 INT A&. A& s2! v@ 0 (vstd!seq.Seq.len.? A&. A& s2!) A&. A& s2!) INT))) (=> (= ss2@ (vstd!seq_lib.impl&%0.remove.? A&. A& s2! (I i@))) (=> (= tmp%6 (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s2! (vstd!seq_lib.impl&%0.insert.? A&. A& ss2@ (I i@) v@))) (and (=> %%location_label%%5 tmp%6) (=> tmp%6 (=> (= tmp%7 (ext_eq true (TYPE%vstd!seq.Seq. B&. B&) (verismo!tspec.seqlib.seq_multiset.seq_uop.? A&. A& B&. B& s2! (Poly%fun%1. op!)) (vstd!seq_lib.impl&%0.insert.? B&. B& (verismo!tspec.seqlib.seq_multiset.seq_uop.? A&. A& B&. B& ss2@ (Poly%fun%1. op!)) (I i@) (%%apply%%0 op! v@)))) (and (=> %%location_label%%6 tmp%7) (=> tmp%7 (=> (= tmp%8 (verismo!tspec.seqlib.seq_multiset.seq_uop.? A&. A& B&. B& ss2@ (Poly%fun%1. op!))) (=> (= tmp%9 (%%apply%%0 op! v@)) (and (=> %%location_label%%7 (req%verismo!tspec.seqlib.seq_multiset.proof_seq_to_multiset_insert. B&. B& tmp%8 i@ tmp%9)) (=> (ens%verismo!tspec.seqlib.seq_multiset.proof_seq_to_multiset_insert. B&. B& tmp%8 i@ tmp%9) (=> (= tmp%10 (ext_eq true (TYPE%vstd!seq.Seq. B&. B&) (vstd!seq.Seq.push.? B&. B& (verismo!tspec.seqlib.seq_multiset.seq_uop.? A&. A& B&. B& ss1@ (Poly%fun%1. op!)) (%%apply%%0 op! v@)) (verismo!tspec.seqlib.seq_multiset.seq_uop.? A&. A& B&. B& s1! (Poly%fun%1. op!)))) (and (=> %%location_label%%8 tmp%10) (=> tmp%10 (=> (= tmp%11 (verismo!tspec.seqlib.seq_multiset.seq_uop.? A&. A& B&. B& ss1@ (Poly%fun%1. op!))) (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. B&. B& tmp%11) (and (=> %%location_label%%9 (req%verismo!tspec.seqlib.seq_multiset.proof_seq_to_multiset_insert. A&. A& ss2@ i@ v@)) (=> (ens%verismo!tspec.seqlib.seq_multiset.proof_seq_to_multiset_insert. A&. A& ss2@ i@ v@) (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. A&. A& ss1@) (=> (= tmp%12 (ext_eq true (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!multiset.impl&%0.insert.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& ss2@) v@) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s2!))) (and (=> %%location_label%%10 tmp%12) (=> tmp%12 (=> (= tmp%13 (ext_eq true (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!multiset.impl&%0.insert.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& ss1@) v@) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s1!))) (and (=> %%location_label%%11 tmp%13) (=> tmp%13 (=> (= tmp%14 (ext_eq true (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& ss2@) (vstd!multiset.impl&%0.remove.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s2!) v@))) (and (=> %%location_label%%12 tmp%14) (=> tmp%14 (=> (= tmp%15 (ext_eq true (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& ss1@) (vstd!multiset.impl&%0.remove.? A&. A& (vstd!seq_lib.impl&%0.to_multiset.? A&. A& s1!) v@))) (and (=> %%location_label%%13 tmp%15) (=> tmp%15 (=> (= tmp%16 (ext_eq true (TYPE%vstd!multiset.Multiset. A&. A&) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& ss1@) (vstd!seq_lib.impl&%0.to_multiset.? A&. A& ss2@))) (and (=> %%location_label%%14 tmp%16) (=> tmp%16 (and (=> %%location_label%%15 (check_decrease_int (let ((s1!$0 ss1@) (s2!$1 ss2@) (op!$2 op!)) (vstd!seq.Seq.len.? A&. A& s1!$0)) decrease%init0 false)) (and (=> %%location_label%%16 (req%verismo!tspec.seqlib.seq_multiset.proof_seq_to_seq_eq_multiset. A&. A& B&. B& ss1@ ss2@ op!)) (=> (ens%verismo!tspec.seqlib.seq_multiset.proof_seq_to_seq_eq_multiset. A&. A& B&. B& ss1@ ss2@ op!) %%switch_label%%0)))))))))))))))))))))))))))))))))))))))))))))))))))))))))) (=> (not (> (vstd!seq.Seq.len.? A&. A& s1!) 0)) (=> (= tmp%17 (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s1! s2!)) (and (=> %%location_label%%17 tmp%17) (=> tmp%17 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> %%location_label%%18 (= (vstd!seq_lib.impl&%0.to_multiset.? B&. B& (verismo!tspec.seqlib.seq_multiset.seq_uop.? A&. A& B&. B& s1! (Poly%fun%1. op!))) (vstd!seq_lib.impl&%0.to_multiset.? B&. B& (verismo!tspec.seqlib.seq_multiset.seq_uop.? A&. A& B&. B& s2! (Poly%fun%1. op!))))))))))
(check-sat)
(exit)

...
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (req%vstd!seq_lib.impl&%0.add_empty_right. A&. A& a! b!) (=> %%global_location_label%%70 (= (vstd!seq.Seq.len.? A&. A& b!) 0))) :pattern ((req%vstd!seq_lib.impl&%0.add_empty_right. A&. A& a! b!)) )))
...
(assert (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (! (= (req%vstd!seq_lib.impl&%0.add_empty_left. A&. A& a! b!) (=> %%global_location_label%%71 (= (vstd!seq.Seq.len.? A&. A& a!) 0))) :pattern ((req%vstd!seq_lib.impl&%0.add_empty_left. A&. A& a! b!)) )))
...
(declare-fun req%verismo!tspec_e.array.sort.proof_seq_to_multiset_update. (Dcr Type Poly Int Poly) Bool)
(declare-const %%global_location_label%%72 Bool)
(assert (forall ((T&. Dcr) (T& Type) (input! Poly) (i! Int) (v! Poly)) (! (= (req%verismo!tspec_e.array.sort.proof_seq_to_multiset_update. T&. T& input! i! v!) (=> %%global_location_label%%72 (and (<= 0 i!) (< i! (vstd!seq.Seq.len.? T&. T& input!))))) :pattern ((req%verismo!tspec_e.array.sort.proof_seq_to_multiset_update. T&. T& input! i! v!)) )))
(declare-fun ens%verismo!tspec_e.array.sort.proof_seq_to_multiset_update. (Dcr Type Poly Int Poly) Bool)
(assert (forall ((T&. Dcr) (T& Type) (input! Poly) (i! Int) (v! Poly)) (! (= (ens%verismo!tspec_e.array.sort.proof_seq_to_multiset_update. T&. T& input! i! v!) (and (vstd!multiset.impl&%0.contains.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& input!) (vstd!seq.Seq.index.? T&. T& input! (I i!))) (ext_eq true (TYPE%vstd!multiset.Multiset. T&. T&) (vstd!seq_lib.impl&%0.to_multiset.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) v!)) (vstd!multiset.impl&%0.insert.? T&. T& (vstd!multiset.impl&%0.remove.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& input!) (vstd!seq.Seq.index.? T&. T& input! (I i!))) v!)))) :pattern ((ens%verismo!tspec_e.array.sort.proof_seq_to_multiset_update. T&. T& input! i! v!)) )))
(declare-const T&. Dcr)
...
(assert (not (and (=> %%location_label%%0 (req%verismo!tspec_e.array.sort.lemma_seq_to_multiset_update. T&. T& input! i! v!)) (=> (ens%verismo!tspec_e.array.sort.lemma_seq_to_multiset_update. T&. T& input! i! v!) (=> (ens%vstd!seq_lib.impl&%0.to_multiset_ensures. T&. T& input!) (and (=> %%location_label%%1 (vstd!multiset.impl&%0.contains.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& input!) (vstd!seq.Seq.index.? T&. T& input! (I i!)))) (=> %%location_label%%2 (ext_eq true (TYPE%vstd!multiset.Multiset. T&. T&) (vstd!seq_lib.impl&%0.to_multiset.? T&. T& (vstd!seq.Seq.update.? T&. T& input! (I i!) v!)) (vstd!multiset.impl&%0.insert.? T&. T& (vstd!multiset.impl&%0.remove.? T&. T& (vstd!seq_lib.impl&%0.to_multiset.? T&. T& input!) (vstd!seq.Seq.index.? T&. T& input! (I i!))) v!)))))))))
(check-sat)
(exit)

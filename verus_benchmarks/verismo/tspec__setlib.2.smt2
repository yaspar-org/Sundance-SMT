...
(assert (has_type (Poly%fun%1. op_fn!) (TYPE%fun%1. T1&. T1& T2&. T2&)))
...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? T1&. T1& s1!)) (=> (= ret@ (vstd!set.impl&%0.new.? T2&. T2& $ (TYPE%fun%1. T2&. T2& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T1&. T1& s1! T1& T1&. T1& s1! (%Poly%fun%1. (Poly%fun%1. op_fn!))))))) (or (and (=> (not (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!)) (=> (= v1@ (vstd!set.impl&%0.choose.? T1&. T1& s1!)) (=> (= tmp%1 (vstd!set.impl&%0.remove.? T1&. T1& s1! v1@)) (and (=> %%location_label%%0 (check_decrease_int (let ((s1!$0 tmp%1) (op_fn!$1 op_fn!)) (vstd!set.impl&%0.len.? T1&. T1& s1!$0)) decrease%init0 false)) (and (=> %%location_label%%1 (req%verismo!tspec.setlib.lemma_set_uop_len. T1&. T1& T2&. T2& tmp%1 op_fn!)) (=> (ens%verismo!tspec.setlib.lemma_set_uop_len. T1&. T1& T2&. T2& tmp%1 op_fn! prev@) (=> (= tmp%2 (ext_eq true (TYPE%vstd!set.Set. T2&. T2&) ret@ (vstd!set.impl&%0.insert.? T2&. T2& prev@ (%%apply%%0 op_fn! v1@)))) (and (=> %%location_label%%2 tmp%2) (=> tmp%2 (=> (= tmp%3 (not (vstd!set_lib.impl&%0.is_empty.? T2&. T2& ret@))) (and (=> %%location_label%%3 tmp%3) (=> tmp%3 %%switch_label%%0)))))))))))) (=> (not (not (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!))) (=> (= tmp%4 (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!)) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 (and (=> (has_type v@ T2&) (=> %%location_label%%5 (not (vstd!set.impl&%0.contains.? T2&. T2& ret@ v@)))) (=> (forall ((v$ Poly)) (! (=> (has_type v$ T2&) (not (vstd!set.impl&%0.contains.? T2&. T2& ret@ v$))) :pattern ((vstd!set.impl&%0.contains.? T2&. T2& ret@ v$)) )) (=> (= tmp%5 (ext_eq true (TYPE%vstd!set.Set. T2&. T2&) ret@ (vstd!set.impl&%0.empty.? T2&. T2&))) (and (=> %%location_label%%6 tmp%5) (=> tmp%5 (=> (= tmp%6 (vstd!set_lib.impl&%0.is_empty.? T2&. T2& ret@)) (and (=> %%location_label%%7 tmp%6) (=> tmp%6 %%switch_label%%0))))))))))))) (and (not %%switch_label%%0) (=> (= ret! ret@) (and (=> %%location_label%%8 (ext_eq true (TYPE%vstd!set.Set. T2&. T2&) ret! (vstd!set.impl&%0.new.? T2&. T2& $ (TYPE%fun%1. T2&. T2& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T1&. T1& s1! T1& T1&. T1& s1! (%Poly%fun%1. (Poly%fun%1. op_fn!)))))))) (and (=> %%location_label%%9 (= (= (vstd!set.impl&%0.len.? T2&. T2& ret!) 0) (= (vstd!set.impl&%0.len.? T1&. T1& s1!) 0))) (and (=> %%location_label%%10 (<= (vstd!set.impl&%0.len.? T2&. T2& ret!) (vstd!set.impl&%0.len.? T1&. T1& s1!))) (=> %%location_label%%11 (vstd!set.impl&%0.finite.? T2&. T2& ret!))))))))))))
(check-sat)
(exit)

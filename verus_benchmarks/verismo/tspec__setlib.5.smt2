...
(assert (not (=> (= decrease%init0 (vstd!set.impl&%0.len.? T1&. T1& s1!)) (=> (= ret@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!))))))) (or (and (=> (not (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!)) (=> (= tmp%1 (vstd!set.impl&%0.remove.? T1&. T1& s1! (vstd!set.impl&%0.choose.? T1&. T1& s1!))) (and (=> %%location_label%%0 (check_decrease_int (let ((s1!$0 tmp%1) (s2!$1 s2!) (op_fn!$2 op_fn!)) (vstd!set.impl&%0.len.? T1&. T1& s1!$0)) decrease%init0 false)) (and (=> %%location_label%%1 (req%verismo!tspec.setlib.lemma_setop_eq_recursive. T1&. T1& T2&. T2& T3&. T3& tmp%1 s2! op_fn!)) (=> (ens%verismo!tspec.setlib.lemma_setop_eq_recursive. T1&. T1& T2&. T2& T3&. T3& tmp%1 s2! op_fn! prev@) (and (=> (= tmp%3 (vstd!set.impl&%0.choose.? T1&. T1& s1!)) (and (=> %%location_label%%2 (req%verismo!tspec.setlib.lemma_setop_3_union. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! tmp%3)) (=> (ens%verismo!tspec.setlib.lemma_setop_3_union. T1&. T1& T2&. T2& T3&. T3& s1! s2! op_fn! tmp%3 tmp%2) (=> %%location_label%%3 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret@ (vstd!set.impl&%0.union.? T3&. T3& prev@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) (vstd!set.impl&%0.choose.? T1&. T1& s1!))))))))))))))) (=> (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret@ (vstd!set.impl&%0.union.? T3&. T3& prev@ (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%3 T2&. T2& s2! T2& T2&. T2& s2! (%Poly%fun%1. (Poly%fun%1. (mk_fun (%%lambda%%4 (%Poly%fun%2. (Poly%fun%2. op_fn!)) (vstd!set.impl&%0.choose.? T1&. T1& s1!))))))))))) %%switch_label%%0))))))) (=> (not (not (vstd!set_lib.impl&%0.is_empty.? T1&. T1& s1!))) (=> (= tmp%4 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret@ (vstd!set.impl&%0.empty.? T3&. T3&))) (and (=> %%location_label%%4 tmp%4) (=> tmp%4 %%switch_label%%0))))) (and (not %%switch_label%%0) (=> (= ret! ret@) (and (=> %%location_label%%5 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (vstd!set.impl&%0.new.? T3&. T3& $ (TYPE%fun%1. T3&. T3& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 T1&. T1& s1! T2&. T2& s2! T1& T2& T1&. T1& s1! T2&. T2& s2! (%Poly%fun%2. (Poly%fun%2. op_fn!)))))))) (=> %%location_label%%6 (ext_eq true (TYPE%vstd!set.Set. T3&. T3&) ret! (verismo!tspec.setlib.set_bop_recursive.? T1&. T1& T2&. T2& T3&. T3& s1! s2! (Poly%fun%2. op_fn!))))))))))))
(check-sat)
(exit)

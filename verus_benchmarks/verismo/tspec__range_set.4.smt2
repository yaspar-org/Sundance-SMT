...
(declare-const range! tuple%2.)
(declare-const rs! vstd!set.Set<tuple%2<int./nat.>.>.)
...
(declare-const rs2@ vstd!set.Set<tuple%2<int./nat.>.>.)
(assert fuel_defaults)
(assert (has_type (Poly%tuple%2. r2!) (TYPE%tuple%2. $ INT $ NAT)))
(assert (has_type (Poly%tuple%2. range!) (TYPE%tuple%2. $ INT $ NAT)))
(assert (verismo!tspec.range_set.range_disjoint_.? (Poly%tuple%2. r2!) (Poly%tuple%2. range!)))
...
(assert (not (=> (= rs2@ (%Poly%vstd!set.Set<tuple%2<int./nat.>.>. (vstd!set.impl&%0.insert.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) (Poly%tuple%2. range!)))) (and (=> (has_type r@ (TYPE%tuple%2. $ INT $ NAT)) (=> (and (and (and (let ((tmp%%$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. r@))))) (and (<= (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) tmp%%$$0) (< tmp%%$$0 (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!)))))))) (<= (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. r@))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. r@)))) (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!))))))) (not (= (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. r@))) 0))) (verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) r@)) (and (=> (has_type v@ (TYPE%tuple%2. $ INT $ NAT)) (=> (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs2@) v@) (or (and (=> (not (= (%Poly%tuple%2. v@) range!)) (=> (= tmp%1 (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) v@)) (and (=> %%location_label%%0 tmp%1) (=> tmp%1 %%switch_label%%0)))) (=> (not (not (= (%Poly%tuple%2. v@) range!))) (=> (= tmp%2 (verismo!tspec.range_set.range_disjoint_.? (Poly%tuple%2. r2!) v@)) (and (=> %%location_label%%1 tmp%2) (=> tmp%2 (=> (= tmp%3 (verismo!tspec.range_set.range_disjoint_.? v@ r@)) (and (=> %%location_label%%2 tmp%3) (=> tmp%3 %%switch_label%%0)))))))) (and (not %%switch_label%%0) (=> %%location_label%%3 (verismo!tspec.range_set.range_disjoint_.? v@ r@)))))) (=> (forall ((v$ Poly)) (! (=> (has_type v$ (TYPE%tuple%2. $ INT $ NAT)) (=> (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs2@) v$) (verismo!tspec.range_set.range_disjoint_.? v$ r@))) :pattern ((vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs2@) v$)) :pattern ((verismo!tspec.range_set.range_disjoint_.? v$ r@)) )) (=> %%location_label%%4 (verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs2@) r@)))))) (=> (forall ((r$ Poly)) (! (=> (has_type r$ (TYPE%tuple%2. $ INT $ NAT)) (=> (and (and (and (let ((tmp%%$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. r$))))) (and (<= (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) tmp%%$$0) (< tmp%%$$0 (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!)))))))) (<= (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. r$))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. r$)))) (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!))))))) (not (= (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. r$))) 0))) (verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) r$)) (verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs2@) r$))) :pattern ((verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) r$)) :pattern ((verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs2@) r$)) )) (and (=> (has_type r$1@ (TYPE%tuple%2. $ INT $ NAT)) (=> (and (and (and (let ((tmp%%$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. r$1@))))) (and (<= (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) tmp%%$$0) (< tmp%%$$0 (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!)))))))) (<= (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. r$1@))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. r$1@)))) (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!))))))) (not (= (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. r$1@))) 0))) (verismo!tspec.range_set.ranges_disjoint.? (vstd!set.impl&%0.insert.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) (Poly%tuple%2. range!)) r$1@)) (and (=> (has_type v$1@ (TYPE%tuple%2. $ INT $ NAT)) (=> (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) v$1@) (=> (= tmp%4 (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs2@) v$1@)) (and (=> %%location_label%%5 tmp%4) (=> tmp%4 (=> %%location_label%%6 (verismo!tspec.range_set.range_disjoint_.? v$1@ r$1@))))))) (=> (forall ((v$ Poly)) (! (=> (has_type v$ (TYPE%tuple%2. $ INT $ NAT)) (=> (vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) v$) (verismo!tspec.range_set.range_disjoint_.? v$ r$1@))) :pattern ((vstd!set.impl&%0.contains.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) v$)) :pattern ((verismo!tspec.range_set.range_disjoint_.? v$ r$1@)) )) (=> %%location_label%%7 (verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) r$1@)))))) (=> (forall ((r$ Poly)) (! (=> (has_type r$ (TYPE%tuple%2. $ INT $ NAT)) (=> (and (and (and (let ((tmp%%$$0 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. r$))))) (and (<= (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) tmp%%$$0) (< tmp%%$$0 (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!)))))))) (<= (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. r$))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. r$)))) (Add (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. r2!)))) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. r2!))))))) (not (= (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. r$))) 0))) (verismo!tspec.range_set.ranges_disjoint.? (vstd!set.impl&%0.insert.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) (Poly%tuple%2. range!)) r$)) (verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) r$))) :pattern ((verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) r$)) )) (=> %%location_label%%8 (= (verismo!tspec.range_set.ranges_disjoint.? (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) (Poly%tuple%2. r2!)) (verismo!tspec.range_set.ranges_disjoint.? (vstd!set.impl&%0.insert.? $ (TYPE%tuple%2. $ INT $ NAT) (Poly%vstd!set.Set<tuple%2<int./nat.>.>. rs!) (Poly%tuple%2. range!)) (Poly%tuple%2. r2!)))))))))))
(check-sat)
(exit)
